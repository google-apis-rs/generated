...
pub mod organizations {
    ...
    pub struct BatchGetAssetsHistoryRequestBuilder<'a, A> {
        ...
        content_type: Option<crate::organizations::params::BatchGetAssetsHistoryContentType>,
    ...
    impl<'a, A: yup_oauth2::GetToken> BatchGetAssetsHistoryRequestBuilder<'a, A> {
        ...
        pub fn content_type(
            &mut self,
            value: crate::organizations::params::BatchGetAssetsHistoryContentType,
        ) -> &mut Self {
...
pub mod projects {
    ...
    pub struct BatchGetAssetsHistoryRequestBuilder<'a, A> {
        ...
        parent: String,
        asset_names: Option<String>,
        content_type: Option<crate::projects::params::BatchGetAssetsHistoryContentType>,
        read_time_window_end_time: Option<String>,
        read_time_window_start_time: Option<String>,
        access_token: Option<String>,
        alt: Option<crate::params::Alt>,
    ...
    impl<'a, A: yup_oauth2::GetToken> BatchGetAssetsHistoryRequestBuilder<'a, A> {
        ...
        pub fn content_type(
            &mut self,
            value: crate::projects::params::BatchGetAssetsHistoryContentType,
        ) -> &mut Self {
            self.content_type = Some(value);
            self
        }
