...
pub mod projects {
    ...
    impl<'a, A: yup_oauth2::GetToken> ProjectsActions<'a, A> {
        ...
        pub fn releases(&self) -> releases::ReleasesActions<A> {
            releases::ReleasesActions
        }
        #[doc = "Actions that can be performed on the rulesets resource"]
        pub fn rulesets(&self) -> rulesets::RulesetsActions<A> {
    ...
    pub mod releases {
        ...
        impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
            ...
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                ...
                let mut auth = self.auth.lock().unwrap();
                let req = req.bearer_auth(
                    auth.token::<_, &str>(&["https://www.googleapis.com/auth/firebase.readonly"])
                        .unwrap()
                        .access_token,
                );
                req
        ...
        pub struct GetExecutableRequestBuilder<'a, A> {
            ...
            pub(crate) auth: &'a ::std::sync::Mutex<A>,
            name: String,
            executable_version: Option<crate::releases::params::GetExecutableExecutableVersion>,
            access_token: Option<String>,
            alt: Option<crate::params::Alt>,
            callback: Option<String>,
            fields: Option<String>,
        ...
        impl<'a, A: yup_oauth2::GetToken> GetExecutableRequestBuilder<'a, A> {
            ...
            pub fn executable_version(
                &mut self,
                value: crate::releases::params::GetExecutableExecutableVersion,
            ) -> &mut Self {
            ...
            pub fn execute_debug(
                self,
            ) -> Result<crate::schemas::GetReleaseExecutableResponse, Box<dyn ::std::error::Error>>
            {
                self.execute()
            }
            fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
