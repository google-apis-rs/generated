...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn violating_sites(&self) -> crate::violating_sites::ViolatingSitesActions<A> {
        crate::violating_sites::ViolatingSitesActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
...
pub mod sites {
    ...
    impl<'a, A: yup_oauth2::GetToken> SitesActions<'a, A> {
        #[doc = "Gets a summary of the ad experience rating of a site."]
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::SiteSummaryResponse, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        ...
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            ...
            let req = req.bearer_auth(
                auth.token::<_, &str>(&["https://www.googleapis.com/auth/xapi.zoo"])
                    .unwrap()
                    .access_token,
            );
            req
...
pub mod violating_sites {
    pub mod params {}
    pub struct ViolatingSitesActions<'a, A> {
        pub(super) reqwest: &'a reqwest::Client,
        pub(super) auth: &'a std::sync::Mutex<A>,
    }
    impl<'a, A: yup_oauth2::GetToken> ViolatingSitesActions<'a, A> {
        #[doc = "Lists sites with Ad Experience Report statuses of \"Failing\" or \"Warning\"."]
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::ViolatingSitesResponse, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
