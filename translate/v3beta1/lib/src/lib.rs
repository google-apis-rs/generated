pub mod schemas {
    ...
    pub struct BatchTranslateTextRequest {
        ...
        pub input_configs: Option<Vec<crate::schemas::InputConfig>>,
    ...
    impl ::field_selector::FieldSelector for BatchTranslateTextRequest {
    ...
    pub struct DetectLanguageResponse {
        ...
        pub languages: Option<Vec<crate::schemas::DetectedLanguage>>,
    }
    impl ::field_selector::FieldSelector for DetectLanguageResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct Glossary {
        ...
        pub input_config: Option<crate::schemas::GlossaryInputConfig>,
        #[doc = "Used with equivalent term set glossaries."]
        #[serde(rename = "languageCodesSet", default)]
        pub language_codes_set: Option<crate::schemas::LanguageCodesSet>,
        #[doc = "Used with unidirectional glossaries."]
        #[serde(rename = "languagePair", default)]
        pub language_pair: Option<crate::schemas::LanguageCodePair>,
    ...
    impl ::field_selector::FieldSelector for Glossary {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GlossaryInputConfig {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for LanguageCodePair {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for LanguageCodesSet {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListGlossariesResponse {
        ...
        #[serde(rename = "glossaries", default)]
        pub glossaries: Option<Vec<crate::schemas::Glossary>>,
        #[doc = "A token to retrieve a page of results. Pass this value in the\n[ListGlossariesRequest.page_token] field in the subsequent call to\n`ListGlossaries` method to retrieve the next page of results."]
        #[serde(rename = "nextPageToken", default)]
        pub next_page_token: Option<String>,
    }
    impl ::field_selector::FieldSelector for ListGlossariesResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for SupportedLanguage {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct SupportedLanguages {
        ...
        #[serde(rename = "languages", default)]
        pub languages: Option<Vec<crate::schemas::SupportedLanguage>>,
    }
    impl ::field_selector::FieldSelector for SupportedLanguages {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for TranslateTextGlossaryConfig {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct TranslateTextRequest {
        ...
        pub glossary_config: Option<crate::schemas::TranslateTextGlossaryConfig>,
        #[doc = "Optional. The format of the source text, for example, \"text/html\",\n \"text/plain\". If left blank, the MIME type defaults to \"text/html\"."]
        #[serde(rename = "mimeType", default)]
        pub mime_type: Option<String>,
    ...
    pub struct TranslateTextResponse {
        ...
        pub glossary_translations: Option<Vec<crate::schemas::Translation>>,
        #[doc = "Text translation responses with no glossary applied.\nThis field has the same length as\n`contents`."]
        #[serde(rename = "translations", default)]
        pub translations: Option<Vec<crate::schemas::Translation>>,
    }
    impl ::field_selector::FieldSelector for TranslateTextResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for Translation {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for WaitOperationRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
...
pub mod projects {
    ...
    impl<'a, A: yup_oauth2::GetToken> ProjectsActions<'a, A> {
        ...
        ) -> DetectLanguageRequestBuilder<A> {
        ...
        pub fn get_supported_languages(
            &self,
            parent: impl Into<String>,
        ) -> GetSupportedLanguagesRequestBuilder<A> {
    ...
    #[derive(Debug, Clone)]
    pub struct DetectLanguageRequestBuilder<'a, A> {
    ...
    impl<'a, A: yup_oauth2::GetToken> DetectLanguageRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::DetectLanguageResponse, Box<dyn ::std::error::Error>> {
            self.execute()
        }
    ...
    #[derive(Debug, Clone)]
    pub struct GetSupportedLanguagesRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        parent: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> GetSupportedLanguagesRequestBuilder<'a, A> {
        #[doc = "Optional. The language to use to return localized, human readable names\nof supported languages. If missing, then display names are not returned\nin a response."]
        pub fn display_language_code(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::SupportedLanguages, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    #[derive(Debug, Clone)]
    pub struct TranslateTextRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        request: crate::schemas::TranslateTextRequest,
        parent: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> TranslateTextRequestBuilder<'a, A> {
        #[doc = "OAuth access token."]
        pub fn access_token(&mut self, value: impl Into<String>) -> &mut Self {
            self.access_token = Some(value.into());
            self
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::TranslateTextResponse, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    pub mod locations {
        ...
        impl<'a, A: yup_oauth2::GetToken> LocationsActions<'a, A> {
            ...
            pub fn batch_translate_text(
                ...
                parent: impl Into<String>,
            ) -> BatchTranslateTextRequestBuilder<A> {
            ...
            pub fn glossaries(&self) -> glossaries::GlossariesActions<A> {
                glossaries::GlossariesActions
            }
        ...
        #[derive(Debug, Clone)]
        pub struct BatchTranslateTextRequestBuilder<'a, A> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a ::std::sync::Mutex<A>,
            request: crate::schemas::BatchTranslateTextRequest,
            parent: String,
        ...
        impl<'a, A: yup_oauth2::GetToken> BatchTranslateTextRequestBuilder<'a, A> {
            #[doc = "OAuth access token."]
            pub fn access_token(&mut self, value: impl Into<String>) -> &mut Self {
                self.access_token = Some(value.into());
                self
        ...
        pub mod glossaries {
            pub mod params {}
            pub struct GlossariesActions<'a, A> {
                pub(super) reqwest: &'a reqwest::Client,
                pub(super) auth: &'a std::sync::Mutex<A>,
            }
            impl<'a, A: yup_oauth2::GetToken> GlossariesActions<'a, A> {
            ...
            impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
                ...
                pub fn execute_debug(
                    self,
                ) -> Result<crate::schemas::Glossary, Box<dyn ::std::error::Error>>
                {
                    self.execute()
                }
                fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                pub fn execute_debug(
                    self,
                ) -> Result<crate::schemas::ListGlossariesResponse, Box<dyn ::std::error::Error>>
                {
                    self.execute()
                }
                fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        ...
        pub mod operations {
            ...
            #[derive(Debug, Clone)]
            pub struct WaitRequestBuilder<'a, A> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a ::std::sync::Mutex<A>,
                request: crate::schemas::WaitOperationRequest,
                name: String,
            ...
            impl<'a, A: yup_oauth2::GetToken> WaitRequestBuilder<'a, A> {
                #[doc = "OAuth access token."]
                pub fn access_token(&mut self, value: impl Into<String>) -> &mut Self {
                    self.access_token = Some(value.into());
                    self
