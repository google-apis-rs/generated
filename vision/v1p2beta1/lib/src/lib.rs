pub mod schemas {
    ...
    pub struct GoogleCloudVisionV1P2Beta1AnnotateFileRequest {
        ...
        pub features: Option<Vec<crate::schemas::GoogleCloudVisionV1P2Beta1Feature>>,
        #[doc = "Additional context that may accompany the image(s) in the file."]
        #[serde(rename = "imageContext", default)]
        pub image_context: Option<crate::schemas::GoogleCloudVisionV1P2Beta1ImageContext>,
    ...
    impl ::field_selector::FieldSelector for GoogleCloudVisionV1P2Beta1AnnotateFileRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GoogleCloudVisionV1P2Beta1AnnotateImageRequest {
        ...
        #[serde(rename = "image", default)]
        pub image: Option<crate::schemas::GoogleCloudVisionV1P2Beta1Image>,
        #[doc = "Additional context that may accompany the image."]
        #[serde(rename = "imageContext", default)]
        pub image_context: Option<crate::schemas::GoogleCloudVisionV1P2Beta1ImageContext>,
    }
    impl ::field_selector::FieldSelector for GoogleCloudVisionV1P2Beta1AnnotateImageRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleCloudVisionV1P2Beta1AsyncAnnotateFileRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GoogleCloudVisionV1P2Beta1AsyncBatchAnnotateFilesRequest {
        ...
        pub requests:
            Option<Vec<crate::schemas::GoogleCloudVisionV1P2Beta1AsyncAnnotateFileRequest>>,
    }
    impl ::field_selector::FieldSelector for GoogleCloudVisionV1P2Beta1AsyncBatchAnnotateFilesRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GoogleCloudVisionV1P2Beta1AsyncBatchAnnotateImagesRequest {
        ...
        #[serde(rename = "requests", default)]
        pub requests: Option<Vec<crate::schemas::GoogleCloudVisionV1P2Beta1AnnotateImageRequest>>,
    }
    impl ::field_selector::FieldSelector for GoogleCloudVisionV1P2Beta1AsyncBatchAnnotateImagesRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GoogleCloudVisionV1P2Beta1BatchAnnotateFilesRequest {
        ...
        #[serde(rename = "requests", default)]
        pub requests: Option<Vec<crate::schemas::GoogleCloudVisionV1P2Beta1AnnotateFileRequest>>,
    }
    impl ::field_selector::FieldSelector for GoogleCloudVisionV1P2Beta1BatchAnnotateFilesRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GoogleCloudVisionV1P2Beta1BatchAnnotateFilesResponse {
        #[doc = "The list of file annotation responses, each response corresponding to each\nAnnotateFileRequest in BatchAnnotateFilesRequest."]
        #[serde(rename = "responses", default)]
        pub responses: Option<Vec<crate::schemas::GoogleCloudVisionV1P2Beta1AnnotateFileResponse>>,
    }
    impl ::field_selector::FieldSelector for GoogleCloudVisionV1P2Beta1BatchAnnotateFilesResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleCloudVisionV1P2Beta1BatchAnnotateImagesRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleCloudVisionV1P2Beta1BatchAnnotateImagesResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleCloudVisionV1P2Beta1CropHintsParams {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum GoogleCloudVisionV1P2Beta1FeatureType {
    ...
    impl GoogleCloudVisionV1P2Beta1FeatureType {
        pub fn as_str(self) -> &'static str {
            match self {
                GoogleCloudVisionV1P2Beta1FeatureType::TypeUnspecified => "TYPE_UNSPECIFIED",
                GoogleCloudVisionV1P2Beta1FeatureType::FaceDetection => "FACE_DETECTION",
                GoogleCloudVisionV1P2Beta1FeatureType::LandmarkDetection => "LANDMARK_DETECTION",
                GoogleCloudVisionV1P2Beta1FeatureType::LogoDetection => "LOGO_DETECTION",
                GoogleCloudVisionV1P2Beta1FeatureType::LabelDetection => "LABEL_DETECTION",
                GoogleCloudVisionV1P2Beta1FeatureType::TextDetection => "TEXT_DETECTION",
                ...
                GoogleCloudVisionV1P2Beta1FeatureType::ImageProperties => "IMAGE_PROPERTIES",
                GoogleCloudVisionV1P2Beta1FeatureType::CropHints => "CROP_HINTS",
                GoogleCloudVisionV1P2Beta1FeatureType::WebDetection => "WEB_DETECTION",
                GoogleCloudVisionV1P2Beta1FeatureType::ProductSearch => "PRODUCT_SEARCH",
                GoogleCloudVisionV1P2Beta1FeatureType::ObjectLocalization => "OBJECT_LOCALIZATION",
            }
        }
    }
    ...
    impl ::serde::Serialize for GoogleCloudVisionV1P2Beta1FeatureType {
        fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl<'de> ::serde::Deserialize<'de> for GoogleCloudVisionV1P2Beta1FeatureType {
        fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
        where
            D: ::serde::de::Deserializer<'de>,
        {
    ...
    pub struct GoogleCloudVisionV1P2Beta1Feature {
        ...
        #[serde(rename = "type", default)]
        pub r#type: Option<crate::schemas::GoogleCloudVisionV1P2Beta1FeatureType>,
    }
    ...
    pub struct GoogleCloudVisionV1P2Beta1Image {
        ...
        pub source: Option<crate::schemas::GoogleCloudVisionV1P2Beta1ImageSource>,
    }
    impl ::field_selector::FieldSelector for GoogleCloudVisionV1P2Beta1Image {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GoogleCloudVisionV1P2Beta1ImageContext {
        ...
        pub crop_hints_params: Option<crate::schemas::GoogleCloudVisionV1P2Beta1CropHintsParams>,
        ...
        pub lat_long_rect: Option<crate::schemas::GoogleCloudVisionV1P2Beta1LatLongRect>,
        #[doc = "Parameters for product search."]
        #[serde(rename = "productSearchParams", default)]
        pub product_search_params:
            Option<crate::schemas::GoogleCloudVisionV1P2Beta1ProductSearchParams>,
        #[doc = "Parameters for web detection."]
        #[serde(rename = "webDetectionParams", default)]
        pub web_detection_params:
            Option<crate::schemas::GoogleCloudVisionV1P2Beta1WebDetectionParams>,
    }
    impl ::field_selector::FieldSelector for GoogleCloudVisionV1P2Beta1ImageContext {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleCloudVisionV1P2Beta1ImageSource {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleCloudVisionV1P2Beta1LatLongRect {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleCloudVisionV1P2Beta1ProductSearchParams {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleCloudVisionV1P2Beta1WebDetectionParams {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
