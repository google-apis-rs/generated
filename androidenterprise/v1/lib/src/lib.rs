pub mod schemas {
    ...
    pub struct AdministratorWebToken {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#administratorWebToken\"."]
    ...
    impl ::field_selector::FieldSelector for AdministratorWebToken {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct AdministratorWebTokenSpec {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#administratorWebTokenSpec\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        #[doc = "Options for displaying the Managed Configuration page."]
        #[serde(rename = "managedConfigurations", default)]
        pub managed_configurations:
            Option<crate::schemas::AdministratorWebTokenSpecManagedConfigurations>,
        ...
        #[serde(rename = "playSearch", default)]
        pub play_search: Option<crate::schemas::AdministratorWebTokenSpecPlaySearch>,
        #[doc = "Options for displaying the Private Apps page."]
        #[serde(rename = "privateApps", default)]
        pub private_apps: Option<crate::schemas::AdministratorWebTokenSpecPrivateApps>,
        #[doc = "Options for displaying the Organize apps page."]
        #[serde(rename = "storeBuilder", default)]
        pub store_builder: Option<crate::schemas::AdministratorWebTokenSpecStoreBuilder>,
        #[doc = "Options for displaying the Web Apps page."]
        #[serde(rename = "webApps", default)]
        pub web_apps: Option<crate::schemas::AdministratorWebTokenSpecWebApps>,
    }
    impl ::field_selector::FieldSelector for AdministratorWebTokenSpec {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for AdministratorWebTokenSpecManagedConfigurations {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct AdministratorWebTokenSpecPlaySearch {
        ...
        #[serde(rename = "approveApps", default)]
        pub approve_apps: Option<bool>,
        #[doc = "Whether the managed Play Search apps page is displayed. Default is true."]
        #[serde(rename = "enabled", default)]
        pub enabled: Option<bool>,
    }
    impl ::field_selector::FieldSelector for AdministratorWebTokenSpecPlaySearch {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for AdministratorWebTokenSpecPrivateApps {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for AdministratorWebTokenSpecStoreBuilder {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for AdministratorWebTokenSpecWebApps {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct AppRestrictionsSchema {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#appRestrictionsSchema\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        #[doc = "The set of restrictions that make up this schema."]
        #[serde(rename = "restrictions", default)]
        pub restrictions: Option<Vec<crate::schemas::AppRestrictionsSchemaRestriction>>,
    }
    impl ::field_selector::FieldSelector for AppRestrictionsSchema {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for AppRestrictionsSchemaChangeEvent {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct AppRestrictionsSchemaRestriction {
        ...
        pub default_value: Option<crate::schemas::AppRestrictionsSchemaRestrictionRestrictionValue>,
        ...
        #[serde(rename = "entryValue", default)]
        ...
        #[serde(rename = "nestedRestriction", default)]
        pub nested_restriction: Option<Vec<crate::schemas::AppRestrictionsSchemaRestriction>>,
        #[doc = "The type of the restriction."]
        #[serde(rename = "restrictionType", default)]
        pub restriction_type: Option<String>,
        #[doc = "The name of the restriction."]
        #[serde(rename = "title", default)]
        pub title: Option<String>,
    }
    impl ::field_selector::FieldSelector for AppRestrictionsSchemaRestriction {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct AppRestrictionsSchemaRestrictionRestrictionValue {
        ...
        #[serde(rename = "valueBool", default)]
        ...
        #[serde(rename = "valueMultiselect", default)]
    ...
    impl ::field_selector::FieldSelector for AppRestrictionsSchemaRestrictionRestrictionValue {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct AppState {
        ...
        #[serde(rename = "keyedAppState", default)]
        pub keyed_app_state: Option<Vec<crate::schemas::KeyedAppState>>,
        #[doc = "The package name of the app. This field will always be present."]
        #[serde(rename = "packageName", default)]
        pub package_name: Option<String>,
    }
    impl ::field_selector::FieldSelector for AppState {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for AppUpdateEvent {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for AppVersion {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ApprovalUrlInfo {
        ...
        #[serde(rename = "approvalUrl", default)]
        pub approval_url: Option<String>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#approvalUrlInfo\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    }
    impl ::field_selector::FieldSelector for ApprovalUrlInfo {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct AuthenticationToken {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#authenticationToken\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    ...
    impl ::field_selector::FieldSelector for AuthenticationToken {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct AutoInstallConstraint {
        ...
        #[serde(rename = "chargingStateConstraint", default)]
        pub charging_state_constraint: Option<String>,
        #[doc = "Device idle state constraint."]
        #[serde(rename = "deviceIdleStateConstraint", default)]
        pub device_idle_state_constraint: Option<String>,
        #[doc = "Network type constraint."]
        #[serde(rename = "networkTypeConstraint", default)]
        pub network_type_constraint: Option<String>,
    }
    impl ::field_selector::FieldSelector for AutoInstallConstraint {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct AutoInstallPolicy {
        ...
        #[serde(rename = "autoInstallConstraint", default)]
        pub auto_install_constraint: Option<Vec<crate::schemas::AutoInstallConstraint>>,
        #[doc = "The auto-install mode. If unset defaults to \"doNotAutoInstall\"."]
        #[serde(rename = "autoInstallMode", default)]
        ...
        #[serde(rename = "autoInstallPriority", default)]
        pub auto_install_priority: Option<i32>,
        #[doc = "The minimum version of the app. If a lower version of the app is installed, then the app will be auto-updated according to the auto-install constraints, instead of waiting for the regular auto-update."]
        #[serde(rename = "minimumVersionCode", default)]
        pub minimum_version_code: Option<i32>,
    }
    impl ::field_selector::FieldSelector for AutoInstallPolicy {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ConfigurationVariables {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#configurationVariables\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        #[doc = "The ID of the managed configurations settings."]
        #[serde(rename = "mcmId", default)]
        pub mcm_id: Option<String>,
        #[doc = "The variable set that is attributed to the user."]
        #[serde(rename = "variableSet", default)]
        pub variable_set: Option<Vec<crate::schemas::VariableSet>>,
    }
    impl ::field_selector::FieldSelector for ConfigurationVariables {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct Device {
        ...
        #[serde(rename = "androidId", default)]
        ...
        pub report: Option<crate::schemas::DeviceReport>,
    }
    ...
    pub struct DeviceReport {
        ...
        pub app_state: Option<Vec<crate::schemas::AppState>>,
    ...
    impl ::field_selector::FieldSelector for DeviceReport {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for DeviceReportUpdateEvent {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct DeviceState {
        ...
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#deviceState\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    }
    impl ::field_selector::FieldSelector for DeviceState {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct DevicesListResponse {
        ...
        pub device: Option<Vec<crate::schemas::Device>>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#devicesListResponse\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    }
    impl ::field_selector::FieldSelector for DevicesListResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct Enterprise {
        ...
        pub administrator: Option<Vec<crate::schemas::Administrator>>,
        #[doc = "The unique ID for the enterprise."]
        #[serde(rename = "id", default)]
        pub id: Option<String>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#enterprise\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        ...
        #[serde(rename = "primaryDomain", default)]
    ...
    pub struct EnterpriseAccount {
        ...
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#enterpriseAccount\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    }
    impl ::field_selector::FieldSelector for EnterpriseAccount {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct EnterprisesListResponse {
        ...
        pub enterprise: Option<Vec<crate::schemas::Enterprise>>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#enterprisesListResponse\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    }
    impl ::field_selector::FieldSelector for EnterprisesListResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for EnterprisesSendTestPushNotificationResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct Entitlement {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#entitlement\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    ...
    impl ::field_selector::FieldSelector for Entitlement {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct EntitlementsListResponse {
        ...
        pub entitlement: Option<Vec<crate::schemas::Entitlement>>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#entitlementsListResponse\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    }
    impl ::field_selector::FieldSelector for EntitlementsListResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GroupLicense {
        ...
        #[serde(rename = "acquisitionKind", default)]
        ...
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#groupLicense\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        ...
        #[serde(rename = "numProvisioned", default)]
    ...
    impl ::field_selector::FieldSelector for GroupLicense {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GroupLicenseUsersListResponse {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#groupLicenseUsersListResponse\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        #[doc = "A user of an enterprise."]
        #[serde(rename = "user", default)]
        pub user: Option<Vec<crate::schemas::User>>,
    }
    impl ::field_selector::FieldSelector for GroupLicenseUsersListResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GroupLicensesListResponse {
        ...
        #[serde(rename = "groupLicense", default)]
        pub group_license: Option<Vec<crate::schemas::GroupLicense>>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#groupLicensesListResponse\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    }
    impl ::field_selector::FieldSelector for GroupLicensesListResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct Install {
        ...
        #[serde(rename = "installState", default)]
        pub install_state: Option<String>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#install\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    ...
    impl ::field_selector::FieldSelector for Install {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for InstallFailureEvent {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct InstallsListResponse {
        ...
        pub install: Option<Vec<crate::schemas::Install>>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#installsListResponse\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    }
    impl ::field_selector::FieldSelector for InstallsListResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct KeyedAppState {
        ...
        #[serde(rename = "stateTimestampMillis", default)]
        #[serde(with = "crate::parsed_string")]
    ...
    pub struct MaintenanceWindow {
        ...
        #[serde(rename = "startTimeAfterMidnightMs", default)]
        #[serde(with = "crate::parsed_string")]
    ...
    pub struct ManagedConfiguration {
        ...
        pub configuration_variables: Option<crate::schemas::ConfigurationVariables>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#managedConfiguration\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        #[doc = "The set of managed properties for this configuration."]
        #[serde(rename = "managedProperty", default)]
        pub managed_property: Option<Vec<crate::schemas::ManagedProperty>>,
        #[doc = "The ID of the product that the managed configuration is for, e.g. \"app:com.google.android.gm\"."]
        #[serde(rename = "productId", default)]
        pub product_id: Option<String>,
    }
    impl ::field_selector::FieldSelector for ManagedConfiguration {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ManagedConfigurationsForDeviceListResponse {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#managedConfigurationsForDeviceListResponse\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        #[doc = "A managed configuration for an app on a specific device."]
        #[serde(rename = "managedConfigurationForDevice", default)]
        pub managed_configuration_for_device: Option<Vec<crate::schemas::ManagedConfiguration>>,
    }
    impl ::field_selector::FieldSelector for ManagedConfigurationsForDeviceListResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ManagedConfigurationsForUserListResponse {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#managedConfigurationsForUserListResponse\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        #[doc = "A managed configuration for an app for a specific user."]
        #[serde(rename = "managedConfigurationForUser", default)]
        pub managed_configuration_for_user: Option<Vec<crate::schemas::ManagedConfiguration>>,
    }
    impl ::field_selector::FieldSelector for ManagedConfigurationsForUserListResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ManagedConfigurationsSettings {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#managedConfigurationsSettings\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    ...
    impl ::field_selector::FieldSelector for ManagedConfigurationsSettings {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ManagedConfigurationsSettingsListResponse {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#managedConfigurationsSettingsListResponse\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        #[doc = "A managed configurations settings for an app that may be assigned to a group of users in an enterprise."]
        #[serde(rename = "managedConfigurationsSettings", default)]
        pub managed_configurations_settings:
            Option<Vec<crate::schemas::ManagedConfigurationsSettings>>,
    }
    impl ::field_selector::FieldSelector for ManagedConfigurationsSettingsListResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ManagedProperty {
        ...
        #[serde(rename = "valueBundle", default)]
        pub value_bundle: Option<crate::schemas::ManagedPropertyBundle>,
        #[doc = "The list of bundles of properties - this will only be present if type of the property is bundle_array."]
        #[serde(rename = "valueBundleArray", default)]
        pub value_bundle_array: Option<Vec<crate::schemas::ManagedPropertyBundle>>,
        ...
        #[serde(rename = "valueStringArray", default)]
    ...
    impl ::field_selector::FieldSelector for ManagedPropertyBundle {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for NewDeviceEvent {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct NewPermissionsEvent {
        ...
        #[serde(rename = "approvedPermissions", default)]
    ...
    impl ::field_selector::FieldSelector for NewPermissionsEvent {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct Notification {
        ...
        #[serde(rename = "appRestrictionsSchemaChangeEvent", default)]
        pub app_restrictions_schema_change_event:
            Option<crate::schemas::AppRestrictionsSchemaChangeEvent>,
        #[doc = "Notifications about app updates."]
        #[serde(rename = "appUpdateEvent", default)]
        pub app_update_event: Option<crate::schemas::AppUpdateEvent>,
        #[doc = "Notifications about device report updates."]
        #[serde(rename = "deviceReportUpdateEvent", default)]
        pub device_report_update_event: Option<crate::schemas::DeviceReportUpdateEvent>,
        ...
        #[serde(rename = "installFailureEvent", default)]
        pub install_failure_event: Option<crate::schemas::InstallFailureEvent>,
        #[doc = "Notifications about new devices."]
        #[serde(rename = "newDeviceEvent", default)]
        pub new_device_event: Option<crate::schemas::NewDeviceEvent>,
        #[doc = "Notifications about new app permissions."]
        #[serde(rename = "newPermissionsEvent", default)]
        pub new_permissions_event: Option<crate::schemas::NewPermissionsEvent>,
        ...
        #[serde(rename = "productApprovalEvent", default)]
        pub product_approval_event: Option<crate::schemas::ProductApprovalEvent>,
        #[doc = "Notifications about product availability changes."]
        #[serde(rename = "productAvailabilityChangeEvent", default)]
        pub product_availability_change_event:
            Option<crate::schemas::ProductAvailabilityChangeEvent>,
    ...
    pub struct NotificationSet {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#notificationSet\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        #[doc = "The notifications received, or empty if no notifications are present."]
        #[serde(rename = "notification", default)]
        pub notification: Option<Vec<crate::schemas::Notification>>,
        ...
        #[serde(rename = "notificationSetId", default)]
        pub notification_set_id: Option<String>,
    }
    impl ::field_selector::FieldSelector for NotificationSet {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct Permission {
        ...
        #[serde(rename = "description", default)]
        pub description: Option<String>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#permission\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    ...
    pub struct Policy {
        ...
        #[serde(rename = "autoUpdatePolicy", default)]
        ...
        #[serde(rename = "deviceReportPolicy", default)]
        ...
        #[serde(rename = "productAvailabilityPolicy", default)]
        pub product_availability_policy: Option<String>,
        #[doc = "The list of product policies."]
        #[serde(rename = "productPolicy", default)]
        pub product_policy: Option<Vec<crate::schemas::ProductPolicy>>,
    }
    ...
    pub struct Product {
        ...
        #[serde(rename = "appTracks", default)]
        pub app_tracks: Option<Vec<crate::schemas::TrackInfo>>,
        #[doc = "App versions currently available for this product."]
        #[serde(rename = "appVersion", default)]
        pub app_version: Option<Vec<crate::schemas::AppVersion>>,
        ...
        #[serde(rename = "distributionChannel", default)]
        ...
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#product\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        ...
        #[serde(rename = "minAndroidSdkVersion", default)]
        pub min_android_sdk_version: Option<i32>,
        #[doc = "A list of permissions required by the app."]
        #[serde(rename = "permissions", default)]
        pub permissions: Option<Vec<crate::schemas::ProductPermission>>,
        ...
        #[serde(rename = "productPricing", default)]
        ...
        #[doc = "Deprecated."]
        #[serde(rename = "requiresContainerApp", default)]
        ...
        #[serde(rename = "signingCertificate", default)]
        pub signing_certificate: Option<crate::schemas::ProductSigningCertificate>,
        ...
        #[serde(rename = "smallIconUrl", default)]
        ...
        #[serde(rename = "workDetailsUrl", default)]
    ...
    impl ::field_selector::FieldSelector for ProductApprovalEvent {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for ProductAvailabilityChangeEvent {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for ProductPermission {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ProductPermissions {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#productPermissions\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        #[doc = "The permissions required by the app."]
        #[serde(rename = "permission", default)]
        pub permission: Option<Vec<crate::schemas::ProductPermission>>,
        #[doc = "The ID of the app that the permissions relate to, e.g. \"app:com.google.android.gm\"."]
        #[serde(rename = "productId", default)]
        pub product_id: Option<String>,
    }
    impl ::field_selector::FieldSelector for ProductPermissions {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ProductPolicy {
        ...
        #[serde(rename = "autoInstallPolicy", default)]
        pub auto_install_policy: Option<crate::schemas::AutoInstallPolicy>,
        #[doc = "The managed configuration for the product."]
        #[serde(rename = "managedConfiguration", default)]
        pub managed_configuration: Option<crate::schemas::ManagedConfiguration>,
    ...
    impl ::field_selector::FieldSelector for ProductPolicy {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ProductSet {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#productSet\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        ...
        #[serde(rename = "productSetBehavior", default)]
        ...
        #[serde(rename = "productVisibility", default)]
        pub product_visibility: Option<Vec<crate::schemas::ProductVisibility>>,
    }
    impl ::field_selector::FieldSelector for ProductSet {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ProductSigningCertificate {
        ...
        pub certificate_hash_sha_1: Option<String>,
        #[doc = "The base64 urlsafe encoded SHA2-256 hash of the certificate."]
        #[serde(rename = "certificateHashSha256", default)]
        pub certificate_hash_sha_256: Option<String>,
    }
    impl ::field_selector::FieldSelector for ProductSigningCertificate {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for ProductVisibility {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ProductsApproveRequest {
        ...
        #[serde(rename = "approvalUrlInfo", default)]
        pub approval_url_info: Option<crate::schemas::ApprovalUrlInfo>,
    ...
    impl ::field_selector::FieldSelector for ProductsApproveRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for ProductsGenerateApprovalUrlResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ProductsListResponse {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#productsListResponse\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        ...
        pub product: Option<Vec<crate::schemas::Product>>,
    ...
    pub struct ServiceAccount {
        ...
        #[serde(rename = "key", default)]
        pub key: Option<crate::schemas::ServiceAccountKey>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#serviceAccount\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    ...
    pub struct ServiceAccountKey {
        ...
        #[serde(rename = "id", default)]
        pub id: Option<String>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#serviceAccountKey\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        ...
        #[serde(rename = "publicData", default)]
    ...
    pub struct ServiceAccountKeysListResponse {
        ...
        pub service_account_key: Option<Vec<crate::schemas::ServiceAccountKey>>,
    }
    impl ::field_selector::FieldSelector for ServiceAccountKeysListResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct SignupInfo {
        ...
        #[serde(rename = "completionToken", default)]
        pub completion_token: Option<String>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#signupInfo\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    ...
    impl ::field_selector::FieldSelector for SignupInfo {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct StoreCluster {
        ...
        #[serde(rename = "id", default)]
        pub id: Option<String>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#storeCluster\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        ...
        #[serde(rename = "name", default)]
        pub name: Option<Vec<crate::schemas::LocalizedText>>,
        #[doc = "String (US-ASCII only) used to determine order of this cluster within the parent page's elements. Page elements are sorted in lexicographic order of this field. Duplicated values are allowed, but ordering between elements with duplicate order is undefined.\n\nThe value of this field is never visible to a user, it is used solely for the purpose of defining an ordering. Maximum length is 256 characters."]
        #[serde(rename = "orderInPage", default)]
    ...
    impl ::field_selector::FieldSelector for StoreCluster {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct StoreLayout {
        #[doc = "The ID of the store page to be used as the homepage. The homepage is the first page shown in the managed Google Play Store.\n\nNot specifying a homepage is equivalent to setting the store layout type to \"basic\"."]
        #[serde(rename = "homepageId", default)]
        pub homepage_id: Option<String>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#storeLayout\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        ...
        #[serde(rename = "storeLayoutType", default)]
        pub store_layout_type: Option<String>,
    }
    impl ::field_selector::FieldSelector for StoreLayout {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct StoreLayoutClustersListResponse {
        ...
        pub cluster: Option<Vec<crate::schemas::StoreCluster>>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#storeLayoutClustersListResponse\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    }
    impl ::field_selector::FieldSelector for StoreLayoutClustersListResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct StoreLayoutPagesListResponse {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#storeLayoutPagesListResponse\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        #[doc = "A store page of an enterprise."]
        #[serde(rename = "page", default)]
        pub page: Option<Vec<crate::schemas::StorePage>>,
    }
    impl ::field_selector::FieldSelector for StoreLayoutPagesListResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct StorePage {
        ...
        #[serde(rename = "id", default)]
        pub id: Option<String>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#storePage\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        #[doc = "Ordered list of pages a user should be able to reach from this page. The list can't include this page. It is recommended that the basic pages are created first, before adding the links between pages.\n\nThe API doesn't verify that the pages exist or the pages are reachable."]
    ...
    impl ::field_selector::FieldSelector for StorePage {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct TrackInfo {
        ...
        #[serde(rename = "trackAlias", default)]
    ...
    impl ::field_selector::FieldSelector for TrackInfo {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct User {
        ...
        #[doc = "The name that will appear in user interfaces. Setting this property is optional when creating EMM-managed users. If you do set this property, use something generic about the organization (such as \"Example, Inc.\") or your name (as EMM). Not used for Google-managed user accounts."]
        #[serde(rename = "displayName", default)]
        pub display_name: Option<String>,
        #[doc = "The unique ID for the user."]
        #[serde(rename = "id", default)]
        pub id: Option<String>,
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#user\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    ...
    pub struct UserToken {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#userToken\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        #[doc = "The token (activation code) to be entered by the user. This consists of a sequence of decimal digits. Note that the leading digit may be 0."]
        #[serde(rename = "token", default)]
        pub token: Option<String>,
        #[doc = "The unique ID for the user."]
        #[serde(rename = "userId", default)]
    ...
    impl ::field_selector::FieldSelector for UserToken {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct UsersListResponse {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#usersListResponse\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        #[doc = "A user of an enterprise."]
        #[serde(rename = "user", default)]
    ...
    pub struct VariableSet {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#variableSet\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    ...
    impl ::field_selector::FieldSelector for VariableSet {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct WebAppsListResponse {
        #[doc = "Identifies what kind of resource this is. Value: the fixed string \"androidenterprise#webAppsListResponse\"."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
        #[doc = "The manifest describing a web app."]
        #[serde(rename = "webApp", default)]
        pub web_app: Option<Vec<crate::schemas::WebApp>>,
    }
    impl ::field_selector::FieldSelector for WebAppsListResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn devices(&self) -> crate::devices::DevicesActions<A> {
        crate::devices::DevicesActions {
    ...
    pub fn entitlements(&self) -> crate::entitlements::EntitlementsActions<A> {
        crate::entitlements::EntitlementsActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    #[doc = "Actions that can be performed on the grouplicenses resource"]
    pub fn grouplicenses(&self) -> crate::grouplicenses::GrouplicensesActions<A> {
        crate::grouplicenses::GrouplicensesActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    #[doc = "Actions that can be performed on the grouplicenseusers resource"]
    pub fn grouplicenseusers(&self) -> crate::grouplicenseusers::GrouplicenseusersActions<A> {
        crate::grouplicenseusers::GrouplicenseusersActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    #[doc = "Actions that can be performed on the installs resource"]
    pub fn installs(&self) -> crate::installs::InstallsActions<A> {
        crate::installs::InstallsActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    ...
    pub fn managedconfigurationsfordevice(
        &self,
    ) -> crate::managedconfigurationsfordevice::ManagedconfigurationsfordeviceActions<A> {
        crate::managedconfigurationsfordevice::ManagedconfigurationsfordeviceActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    ...
    pub fn managedconfigurationsforuser(
        &self,
    ) -> crate::managedconfigurationsforuser::ManagedconfigurationsforuserActions<A> {
        crate::managedconfigurationsforuser::ManagedconfigurationsforuserActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    ...
    pub fn managedconfigurationssettings(
        &self,
    ) -> crate::managedconfigurationssettings::ManagedconfigurationssettingsActions<A> {
        crate::managedconfigurationssettings::ManagedconfigurationssettingsActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    ...
    pub fn serviceaccountkeys(&self) -> crate::serviceaccountkeys::ServiceaccountkeysActions<A> {
        crate::serviceaccountkeys::ServiceaccountkeysActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    #[doc = "Actions that can be performed on the storelayoutclusters resource"]
    pub fn storelayoutclusters(&self) -> crate::storelayoutclusters::StorelayoutclustersActions<A> {
        crate::storelayoutclusters::StorelayoutclustersActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    #[doc = "Actions that can be performed on the storelayoutpages resource"]
    pub fn storelayoutpages(&self) -> crate::storelayoutpages::StorelayoutpagesActions<A> {
        crate::storelayoutpages::StorelayoutpagesActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    ...
    pub fn webapps(&self) -> crate::webapps::WebappsActions<A> {
        crate::webapps::WebappsActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
...
pub mod devices {
    ...
    impl<'a, A: yup_oauth2::GetToken> DevicesActions<'a, A> {
        #[doc = "Uploads a report containing any changes in app states on the device since the last report was generated. You can call this method up to 3 times every 24 hours for a given device."]
        pub fn force_report_upload(
            &self,
            enterprise_id: impl Into<String>,
            user_id: impl Into<String>,
            device_id: impl Into<String>,
        ) -> ForceReportUploadRequestBuilder<A> {
        ...
        #[doc = "Updates the device policy. This method supports patch semantics."]
        pub fn patch(
            &self,
    ...
    #[derive(Debug, Clone)]
    pub struct ForceReportUploadRequestBuilder<'a, A> {
    ...
    impl<'a, A: yup_oauth2::GetToken> ForceReportUploadRequestBuilder<'a, A> {
        ...
        fn _path(&self) -> String {
            let mut output = "https://www.googleapis.com/androidenterprise/v1/".to_owned();
            output.push_str("enterprises/");
            output.push_str(&self.enterprise_id);
            output.push_str("/users/");
            output.push_str(&self.user_id);
            output.push_str("/devices/");
            output.push_str(&self.device_id);
        ...
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            ...
            let req = req.bearer_auth(
                auth.token::<_, &str>(&["https://www.googleapis.com/auth/androidenterprise"])
                    .unwrap()
                    .access_token,
            );
            req
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(self) -> Result<crate::schemas::Device, Box<dyn ::std::error::Error>> {
            self.execute()
        }
    ...
    #[derive(Debug, Clone)]
    pub struct GetStateRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        enterprise_id: String,
        user_id: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> GetStateRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::DeviceState, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::DevicesListResponse, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    impl<'a, A: yup_oauth2::GetToken> PatchRequestBuilder<'a, A> {
        #[doc = "Mask that identifies which fields to update. If not set, all modifiable fields will be modified.\n\nWhen set in a query parameter, this field should be specified as updateMask=<field1>,<field2>,..."]
...
pub mod enterprises {
        ...
        impl PullNotificationSetRequestMode {
            pub fn as_str(self) -> &'static str {
                match self {
                    ...
                    PullNotificationSetRequestMode::WaitForNotifications => "waitForNotifications",
                }
            }
        }
        ...
        impl<'de> ::serde::Deserialize<'de> for PullNotificationSetRequestMode {
                ...
                D: ::serde::de::Deserializer<'de>,
            {
                ...
                Ok(match value {
                    ...
                    "waitForNotifications" => PullNotificationSetRequestMode::WaitForNotifications,
                    _ => {
                        return Err(::serde::de::Error::custom(format!(
                            "invalid enum for #name: {}",
                            value
    ...
    impl<'a, A: yup_oauth2::GetToken> EnterprisesActions<'a, A> {
        ...
        pub fn acknowledge_notification_set(&self) -> AcknowledgeNotificationSetRequestBuilder<A> {
        ...
        pub fn complete_signup(&self) -> CompleteSignupRequestBuilder<A> {
        ...
        pub fn create_web_token(
            ...
            enterprise_id: impl Into<String>,
        ) -> CreateWebTokenRequestBuilder<A> {
        ...
        pub fn generate_signup_url(&self) -> GenerateSignupUrlRequestBuilder<A> {
        ...
        pub fn get(&self, enterprise_id: impl Into<String>) -> GetRequestBuilder<A> {
            GetRequestBuilder {
                reqwest: &self.reqwest,
                auth: &self.auth,
                alt: None,
        ...
        #[doc = "Returns a service account and credentials. The service account can be bound to the enterprise by calling setAccount. The service account is unique to this enterprise and EMM, and will be deleted if the enterprise is unbound. The credentials contain private key data and are not stored server-side.\n\nThis method can only be called after calling Enterprises.Enroll or Enterprises.CompleteSignup, and before Enterprises.SetAccount; at other times it will return an error.\n\nSubsequent calls after the first will generate a new, unique set of credentials, and invalidate the previously generated credentials.\n\nOnce the service account is bound to the enterprise, it can be managed using the serviceAccountKeys resource."]
        ...
        pub fn get_store_layout(
            &self,
            enterprise_id: impl Into<String>,
        ) -> GetStoreLayoutRequestBuilder<A> {
        ...
        pub fn list(&self, domain: impl Into<String>) -> ListRequestBuilder<A> {
            ListRequestBuilder {
                reqwest: &self.reqwest,
                auth: &self.auth,
                alt: None,
        ...
        #[doc = "Pulls and returns a notification set for the enterprises associated with the service account authenticated for the request. The notification set may be empty if no notification are pending.\nA notification set returned needs to be acknowledged within 20 seconds by calling Enterprises.AcknowledgeNotificationSet, unless the notification set is empty.\nNotifications that are not acknowledged within the 20 seconds will eventually be included again in the response to another PullNotificationSet request, and those that are never acknowledged will ultimately be deleted according to the Google Cloud Platform Pub/Sub system policy.\nMultiple requests might be performed concurrently to retrieve notifications, in which case the pending notifications (if any) will be split among each caller, if any are pending.\nIf no notifications are present, an empty notification list is returned. Subsequent requests may return more notifications once they become available."]
        pub fn pull_notification_set(&self) -> PullNotificationSetRequestBuilder<A> {
        ...
        pub fn send_test_push_notification(
            &self,
            enterprise_id: impl Into<String>,
        ) -> SendTestPushNotificationRequestBuilder<A> {
        ...
        pub fn set_store_layout(
            ...
            enterprise_id: impl Into<String>,
        ) -> SetStoreLayoutRequestBuilder<A> {
        ...
        pub fn unenroll(&self, enterprise_id: impl Into<String>) -> UnenrollRequestBuilder<A> {
    ...
    #[derive(Debug, Clone)]
    pub struct AcknowledgeNotificationSetRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
    ...
    impl<'a, A: yup_oauth2::GetToken> AcknowledgeNotificationSetRequestBuilder<'a, A> {
        #[doc = "The notification set ID as returned by Enterprises.PullNotificationSet. This must be provided."]
        pub fn notification_set_id(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        fn _path(&self) -> String {
            let mut output = "https://www.googleapis.com/androidenterprise/v1/".to_owned();
            output.push_str("enterprises/acknowledgeNotificationSet");
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            let req = self.reqwest.request(::reqwest::Method::POST, path);
    ...
    #[derive(Debug, Clone)]
    pub struct CompleteSignupRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
    ...
    impl<'a, A: yup_oauth2::GetToken> CompleteSignupRequestBuilder<'a, A> {
        #[doc = "The Completion token initially returned by GenerateSignupUrl."]
        pub fn completion_token(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        fn _path(&self) -> String {
            let mut output = "https://www.googleapis.com/androidenterprise/v1/".to_owned();
            output.push_str("enterprises/completeSignup");
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            let req = self.reqwest.request(::reqwest::Method::POST, path);
    ...
    #[derive(Debug, Clone)]
    pub struct CreateWebTokenRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        request: crate::schemas::AdministratorWebTokenSpec,
        enterprise_id: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> CreateWebTokenRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::AdministratorWebToken, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    #[derive(Debug, Clone)]
    pub struct EnrollRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        request: crate::schemas::Enterprise,
        token: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> EnrollRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
        ...
        fn _path(&self) -> String {
            let mut output = "https://www.googleapis.com/androidenterprise/v1/".to_owned();
            output.push_str("enterprises/enroll");
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            let req = self.reqwest.request(::reqwest::Method::POST, path);
    ...
    #[derive(Debug, Clone)]
    pub struct GenerateSignupUrlRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
    ...
    impl<'a, A: yup_oauth2::GetToken> GenerateSignupUrlRequestBuilder<'a, A> {
        #[doc = "The callback URL to which the Admin will be redirected after successfully creating an enterprise. Before redirecting there the system will add a single query parameter to this URL named \"enterpriseToken\" which will contain an opaque token to be used for the CompleteSignup request.\nBeware that this means that the URL will be parsed, the parameter added and then a new URL formatted, i.e. there may be some minor formatting changes and, more importantly, the URL must be well-formed so that it can be parsed."]
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::SignupInfo, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
        ...
        fn _path(&self) -> String {
            let mut output = "https://www.googleapis.com/androidenterprise/v1/".to_owned();
            output.push_str("enterprises/signupUrl");
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            let req = self.reqwest.request(::reqwest::Method::POST, path);
    ...
    pub struct GetServiceAccountRequestBuilder<'a, A> {
        ...
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        enterprise_id: String,
        key_type: Option<crate::enterprises::params::GetServiceAccountKeyType>,
        alt: Option<crate::params::Alt>,
        fields: Option<String>,
        key: Option<String>,
        oauth_token: Option<String>,
    ...
    impl<'a, A: yup_oauth2::GetToken> GetServiceAccountRequestBuilder<'a, A> {
        ...
        pub fn key_type(
            &mut self,
            value: crate::enterprises::params::GetServiceAccountKeyType,
        ) -> &mut Self {
    ...
    #[derive(Debug, Clone)]
    pub struct GetStoreLayoutRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        enterprise_id: String,
        alt: Option<crate::params::Alt>,
    ...
    impl<'a, A: yup_oauth2::GetToken> GetStoreLayoutRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::StoreLayout, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::EnterprisesListResponse, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    #[derive(Debug, Clone)]
    pub struct PullNotificationSetRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        request_mode: Option<crate::enterprises::params::PullNotificationSetRequestMode>,
        alt: Option<crate::params::Alt>,
        fields: Option<String>,
        key: Option<String>,
        oauth_token: Option<String>,
    ...
    impl<'a, A: yup_oauth2::GetToken> PullNotificationSetRequestBuilder<'a, A> {
        ...
        pub fn request_mode(
            &mut self,
            value: crate::enterprises::params::PullNotificationSetRequestMode,
        ) -> &mut Self {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::NotificationSet, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
        ...
        fn _path(&self) -> String {
            let mut output = "https://www.googleapis.com/androidenterprise/v1/".to_owned();
            output.push_str("enterprises/pullNotificationSet");
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            let req = self.reqwest.request(::reqwest::Method::POST, path);
    ...
    #[derive(Debug, Clone)]
    pub struct SendTestPushNotificationRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        enterprise_id: String,
        alt: Option<crate::params::Alt>,
    ...
    impl<'a, A: yup_oauth2::GetToken> SendTestPushNotificationRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
        ...
        pub fn execute_debug(
            ...
            crate::schemas::EnterprisesSendTestPushNotificationResponse,
    ...
    #[derive(Debug, Clone)]
    pub struct SetAccountRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        request: crate::schemas::EnterpriseAccount,
        enterprise_id: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> SetAccountRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::EnterpriseAccount, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    #[derive(Debug, Clone)]
    pub struct SetStoreLayoutRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        request: crate::schemas::StoreLayout,
        enterprise_id: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> SetStoreLayoutRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
    ...
    #[derive(Debug, Clone)]
    pub struct UnenrollRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        enterprise_id: String,
        alt: Option<crate::params::Alt>,
    ...
    impl<'a, A: yup_oauth2::GetToken> UnenrollRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
...
pub mod entitlements {
    pub mod params {}
    pub struct EntitlementsActions<'a, A> {
        pub(super) reqwest: &'a reqwest::Client,
        pub(super) auth: &'a std::sync::Mutex<A>,
    }
    impl<'a, A: yup_oauth2::GetToken> EntitlementsActions<'a, A> {
        ...
        #[doc = "Adds or updates an entitlement to an app for a user. This method supports patch semantics."]
        pub fn patch(
            &self,
    ...
    impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
        ...
        fn _path(&self) -> String {
            ...
            output.push_str(&self.entitlement_id);
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::Entitlement, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::EntitlementsListResponse, Box<dyn ::std::error::Error>>
        {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
    ...
    impl<'a, A: yup_oauth2::GetToken> PatchRequestBuilder<'a, A> {
        ...
        pub fn install(&mut self, value: bool) -> &mut Self {
...
pub mod grouplicenses {
    pub mod params {}
    pub struct GrouplicensesActions<'a, A> {
        pub(super) reqwest: &'a reqwest::Client,
        pub(super) auth: &'a std::sync::Mutex<A>,
    }
    impl<'a, A: yup_oauth2::GetToken> GrouplicensesActions<'a, A> {
        ...
        pub fn list(&self, enterprise_id: impl Into<String>) -> ListRequestBuilder<A> {
            ListRequestBuilder {
                reqwest: &self.reqwest,
                auth: &self.auth,
                alt: None,
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::GroupLicense, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
        ...
        fn _path(&self) -> String {
            ...
            output.push_str(&self.group_license_id);
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            let req = self.reqwest.request(::reqwest::Method::GET, path);
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::GroupLicensesListResponse, Box<dyn ::std::error::Error>>
        {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
...
pub mod grouplicenseusers {
    pub mod params {}
    pub struct GrouplicenseusersActions<'a, A> {
        pub(super) reqwest: &'a reqwest::Client,
        pub(super) auth: &'a std::sync::Mutex<A>,
    }
    impl<'a, A: yup_oauth2::GetToken> GrouplicenseusersActions<'a, A> {
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::GroupLicenseUsersListResponse, Box<dyn ::std::error::Error>>
        {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
...
pub mod installs {
    pub mod params {}
    pub struct InstallsActions<'a, A> {
        pub(super) reqwest: &'a reqwest::Client,
        pub(super) auth: &'a std::sync::Mutex<A>,
    }
    impl<'a, A: yup_oauth2::GetToken> InstallsActions<'a, A> {
        ...
        #[doc = "Requests to install the latest version of an app to a device. If the app is already installed, then it is updated to the latest version if necessary. This method supports patch semantics."]
        pub fn patch(
            &self,
    ...
    impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
        ...
        fn _path(&self) -> String {
            ...
            output.push_str(&self.install_id);
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            let req = self.reqwest.request(::reqwest::Method::DELETE, path);
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::Install, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::InstallsListResponse, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
...
pub mod managedconfigurationsfordevice {
    pub mod params {}
    pub struct ManagedconfigurationsfordeviceActions<'a, A> {
        pub(super) reqwest: &'a reqwest::Client,
        pub(super) auth: &'a std::sync::Mutex<A>,
    }
    impl<'a, A: yup_oauth2::GetToken> ManagedconfigurationsfordeviceActions<'a, A> {
        ...
        #[doc = "Adds or updates a per-device managed configuration for an app for the specified device. This method supports patch semantics."]
        pub fn patch(
            &self,
    ...
    impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
        ...
        fn _path(&self) -> String {
            ...
            output.push_str(&self.managed_configuration_for_device_id);
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            let req = self.reqwest.request(::reqwest::Method::DELETE, path);
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::ManagedConfiguration, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            ...
            crate::schemas::ManagedConfigurationsForDeviceListResponse,
            Box<dyn ::std::error::Error>,
        > {
            self.execute()
        }
...
pub mod managedconfigurationsforuser {
    pub mod params {}
    pub struct ManagedconfigurationsforuserActions<'a, A> {
        pub(super) reqwest: &'a reqwest::Client,
        pub(super) auth: &'a std::sync::Mutex<A>,
    }
    impl<'a, A: yup_oauth2::GetToken> ManagedconfigurationsforuserActions<'a, A> {
    ...
    impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
        ...
        fn _path(&self) -> String {
            ...
            output.push_str(&self.managed_configuration_for_user_id);
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            let req = self.reqwest.request(::reqwest::Method::DELETE, path);
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            ...
            crate::schemas::ManagedConfigurationsForUserListResponse,
            Box<dyn ::std::error::Error>,
        > {
            self.execute()
        }
...
pub mod managedconfigurationssettings {
    pub mod params {}
    pub struct ManagedconfigurationssettingsActions<'a, A> {
        pub(super) reqwest: &'a reqwest::Client,
        pub(super) auth: &'a std::sync::Mutex<A>,
    }
    impl<'a, A: yup_oauth2::GetToken> ManagedconfigurationssettingsActions<'a, A> {
        #[doc = "Lists all the managed configurations settings for the specified app. Only the ID and the name is set."]
        pub fn list(
            &self,
            enterprise_id: impl Into<String>,
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            ...
            crate::schemas::ManagedConfigurationsSettingsListResponse,
            Box<dyn ::std::error::Error>,
        > {
            self.execute()
        }
...
pub mod permissions {
    ...
    impl<'a, A: yup_oauth2::GetToken> PermissionsActions<'a, A> {
        ...
        pub fn get(&self, permission_id: impl Into<String>) -> GetRequestBuilder<A> {
            GetRequestBuilder {
                reqwest: &self.reqwest,
                auth: &self.auth,
                alt: None,
...
pub mod products {
    ...
    impl<'a, A: yup_oauth2::GetToken> ProductsActions<'a, A> {
        #[doc = "Approves the specified product and the relevant app permissions, if any. The maximum number of products that you can approve per enterprise customer is 1,000.\n\nTo learn how to use managed Google Play to design and create a store layout to display approved products to your users, see Store Layout Design."]
        pub fn approve(
            &self,
        ...
        #[doc = "Generates a URL that can be rendered in an iframe to display the permissions (if any) of a product. An enterprise admin must view these permissions and accept them on behalf of their organization in order to approve that product.\n\nAdmins should accept the displayed permissions by interacting with a separate UI element in the EMM console, which in turn should trigger the use of this URL as the approvalUrlInfo.approvalUrl property in a Products.approve call to approve the product. This URL can only be used to display permissions for up to 1 day."]
        pub fn generate_approval_url(
            &self,
            enterprise_id: impl Into<String>,
            product_id: impl Into<String>,
        ) -> GenerateApprovalUrlRequestBuilder<A> {
        ...
        pub fn get_app_restrictions_schema(
            ...
            enterprise_id: impl Into<String>,
            product_id: impl Into<String>,
        ) -> GetAppRestrictionsSchemaRequestBuilder<A> {
        ...
        pub fn get_permissions(
            ...
            enterprise_id: impl Into<String>,
            product_id: impl Into<String>,
        ) -> GetPermissionsRequestBuilder<A> {
    ...
    #[derive(Debug, Clone)]
    pub struct GenerateApprovalUrlRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        enterprise_id: String,
        product_id: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> GenerateApprovalUrlRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::ProductsGenerateApprovalUrlResponse, Box<dyn ::std::error::Error>>
        {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
    ...
    #[derive(Debug, Clone)]
    pub struct GetAppRestrictionsSchemaRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        enterprise_id: String,
        product_id: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> GetAppRestrictionsSchemaRequestBuilder<'a, A> {
        #[doc = "The BCP47 tag for the user's preferred language (e.g. \"en-US\", \"de\")."]
        pub fn language(&mut self, value: impl Into<String>) -> &mut Self {
            self.language = Some(value.into());
            self
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::AppRestrictionsSchema, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    #[derive(Debug, Clone)]
    pub struct GetPermissionsRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        enterprise_id: String,
        product_id: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> GetPermissionsRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::ProductPermissions, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn approved(&mut self, value: bool) -> &mut Self {
        ...
        #[doc = "Specifies the maximum number of products that can be returned per request. If not specified, uses a default value of 100, which is also the maximum retrievable within a single response."]
        ...
        #[doc = "A pagination token is contained in a request's response when there are more products. The token can be used in a subsequent request to obtain more products, and so forth. This parameter cannot be used in the initial request."]
    ...
    #[derive(Debug, Clone)]
    pub struct UnapproveRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        enterprise_id: String,
        product_id: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> UnapproveRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
...
pub mod serviceaccountkeys {
    pub mod params {}
    pub struct ServiceaccountkeysActions<'a, A> {
        pub(super) reqwest: &'a reqwest::Client,
        pub(super) auth: &'a std::sync::Mutex<A>,
    }
    impl<'a, A: yup_oauth2::GetToken> ServiceaccountkeysActions<'a, A> {
        ...
        #[doc = "Generates new credentials for the service account associated with this enterprise. The calling service account must have been retrieved by calling Enterprises.GetServiceAccount and must have been set as the enterprise service account by calling Enterprises.SetAccount.\n\nOnly the type of the key should be populated in the resource to be inserted."]
        pub fn insert(
            &self,
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::ServiceAccountKeysListResponse, Box<dyn ::std::error::Error>>
        {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
...
pub mod storelayoutclusters {
    pub mod params {}
    pub struct StorelayoutclustersActions<'a, A> {
        pub(super) reqwest: &'a reqwest::Client,
        pub(super) auth: &'a std::sync::Mutex<A>,
    }
    impl<'a, A: yup_oauth2::GetToken> StorelayoutclustersActions<'a, A> {
        ...
        #[doc = "Updates a cluster. This method supports patch semantics."]
        pub fn patch(
            &self,
            request: crate::schemas::StoreCluster,
            enterprise_id: impl Into<String>,
    ...
    impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
        ...
        fn _path(&self) -> String {
            ...
            output.push_str(&self.page_id);
            output.push_str("/clusters/");
            output.push_str(&self.cluster_id);
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            let req = self.reqwest.request(::reqwest::Method::DELETE, path);
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::StoreCluster, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::StoreLayoutClustersListResponse, Box<dyn ::std::error::Error>>
        {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
...
pub mod storelayoutpages {
    pub mod params {}
    pub struct StorelayoutpagesActions<'a, A> {
        pub(super) reqwest: &'a reqwest::Client,
        pub(super) auth: &'a std::sync::Mutex<A>,
    }
    impl<'a, A: yup_oauth2::GetToken> StorelayoutpagesActions<'a, A> {
        ...
        #[doc = "Updates the content of a store page. This method supports patch semantics."]
        pub fn patch(
            &self,
            request: crate::schemas::StorePage,
            enterprise_id: impl Into<String>,
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::StorePage, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::StoreLayoutPagesListResponse, Box<dyn ::std::error::Error>>
        {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
...
pub mod users {
    ...
    impl<'a, A: yup_oauth2::GetToken> UsersActions<'a, A> {
        ...
        #[doc = "Generates an authentication token which the device policy client can use to provision the given EMM-managed user account on a device. The generated token is single-use and expires after a few minutes.\n\nYou can provision a maximum of 10 devices per user.\n\nThis call only works with EMM-managed accounts."]
        pub fn generate_authentication_token(
            &self,
            enterprise_id: impl Into<String>,
            user_id: impl Into<String>,
        ) -> GenerateAuthenticationTokenRequestBuilder<A> {
        ...
        #[doc = "Generates a token (activation code) to allow this user to configure their managed account in the Android Setup Wizard. Revokes any previously generated token.\n\nThis call only works with Google managed accounts."]
        pub fn generate_token(
            &self,
            enterprise_id: impl Into<String>,
            user_id: impl Into<String>,
        ) -> GenerateTokenRequestBuilder<A> {
        ...
        pub fn get_available_product_set(
            ...
            enterprise_id: impl Into<String>,
            user_id: impl Into<String>,
        ) -> GetAvailableProductSetRequestBuilder<A> {
        ...
        #[doc = "Revokes access to all devices currently provisioned to the user. The user will no longer be able to use the managed Play store on any of their managed devices.\n\nThis call only works with EMM-managed accounts."]
        pub fn revoke_device_access(
            &self,
            enterprise_id: impl Into<String>,
            user_id: impl Into<String>,
        ) -> RevokeDeviceAccessRequestBuilder<A> {
        ...
        #[doc = "Revokes a previously generated token (activation code) for the user."]
        pub fn revoke_token(
            &self,
            enterprise_id: impl Into<String>,
            user_id: impl Into<String>,
        ) -> RevokeTokenRequestBuilder<A> {
        ...
        pub fn set_available_product_set(
            ...
            enterprise_id: impl Into<String>,
            user_id: impl Into<String>,
        ) -> SetAvailableProductSetRequestBuilder<A> {
    ...
    #[derive(Debug, Clone)]
    pub struct GenerateAuthenticationTokenRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        enterprise_id: String,
        user_id: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> GenerateAuthenticationTokenRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::AuthenticationToken, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    #[derive(Debug, Clone)]
    pub struct GenerateTokenRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        enterprise_id: String,
        user_id: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> GenerateTokenRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::UserToken, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(self) -> Result<crate::schemas::User, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    #[derive(Debug, Clone)]
    pub struct GetAvailableProductSetRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        enterprise_id: String,
        user_id: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> GetAvailableProductSetRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::ProductSet, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::UsersListResponse, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    #[derive(Debug, Clone)]
    pub struct RevokeDeviceAccessRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        enterprise_id: String,
        user_id: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> RevokeDeviceAccessRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
    ...
    #[derive(Debug, Clone)]
    pub struct RevokeTokenRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        enterprise_id: String,
        user_id: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> RevokeTokenRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
    ...
    #[derive(Debug, Clone)]
    pub struct SetAvailableProductSetRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        request: crate::schemas::ProductSet,
        enterprise_id: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> SetAvailableProductSetRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
...
pub mod webapps {
    ...
    impl<'a, A: yup_oauth2::GetToken> WebappsActions<'a, A> {
        ...
        #[doc = "Updates an existing web app. This method supports patch semantics."]
        pub fn patch(
            &self,
            request: crate::schemas::WebApp,
            enterprise_id: impl Into<String>,
    ...
    impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
        ...
        fn _path(&self) -> String {
            ...
            output.push_str(&self.web_app_id);
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            let req = self.reqwest.request(::reqwest::Method::DELETE, path);
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(self) -> Result<crate::schemas::WebApp, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::WebAppsListResponse, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
