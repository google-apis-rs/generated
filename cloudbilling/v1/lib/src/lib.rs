pub mod schemas {
    ...
    pub struct BillingAccount {
        #[doc = "The display name given to the billing account, such as `My Billing\nAccount`. This name is displayed in the GCP Console."]
...
pub mod billing_accounts {
    ...
    impl<'a, A: yup_oauth2::GetToken> BillingAccountsActions<'a, A> {
        ...
        pub fn create(&self, request: crate::schemas::BillingAccount) -> CreateRequestBuilder<A> {
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn iter_billing_accounts<T>(
            &'a mut self,
    ...
    pub mod projects {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn iter_project_billing_info<T>(
                &'a mut self,
            ) -> impl Iterator<Item = Result<T, Box<dyn ::std::error::Error>>> + 'a
            where
                T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector + 'a,
            ...
            pub fn execute_debug(
                self,
            ) -> Result<crate::schemas::ListProjectBillingInfoResponse, Box<dyn ::std::error::Error>>
            {
                self.execute()
            }
            fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
...
pub mod projects {
    ...
    impl<'a, A: yup_oauth2::GetToken> ProjectsActions<'a, A> {
        ...
        pub fn get_billing_info(&self, name: impl Into<String>) -> GetBillingInfoRequestBuilder<A> {
...
pub mod services {
    ...
    impl<'a, A: yup_oauth2::GetToken> ServicesActions<'a, A> {
        ...
        pub fn skus(&self) -> skus::SkusActions<A> {
            skus::SkusActions
        }
    }
    #[derive(Debug, Clone)]
    ...
    pub mod skus {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn currency_code(&mut self, value: impl Into<String>) -> &mut Self {
