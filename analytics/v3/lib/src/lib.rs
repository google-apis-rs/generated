...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn data(&self) -> crate::data::DataActions<A> {
        crate::data::DataActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    #[doc = "Actions that can be performed on the management resource"]
    pub fn management(&self) -> crate::management::ManagementActions<A> {
        crate::management::ManagementActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    #[doc = "Actions that can be performed on the metadata resource"]
    pub fn metadata(&self) -> crate::metadata::MetadataActions<A> {
        crate::metadata::MetadataActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    #[doc = "Actions that can be performed on the provisioning resource"]
    pub fn provisioning(&self) -> crate::provisioning::ProvisioningActions<A> {
        crate::provisioning::ProvisioningActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    #[doc = "Actions that can be performed on the user_deletion resource"]
    pub fn user_deletion(&self) -> crate::user_deletion::UserDeletionActions<A> {
        crate::user_deletion::UserDeletionActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
...
pub mod data {
    ...
    pub mod ga {
        ...
        pub struct GetRequestBuilder<'a, A> {
            ...
            output: Option<crate::ga::params::GetOutput>,
            sampling_level: Option<crate::ga::params::GetSamplingLevel>,
        ...
        impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
            ...
            pub fn dimensions(&mut self, value: impl Into<String>) -> &mut Self {
            ...
            pub fn include_empty_rows(&mut self, value: bool) -> &mut Self {
            ...
            pub fn output(&mut self, value: crate::ga::params::GetOutput) -> &mut Self {
            ...
            pub fn sampling_level(
                &mut self,
                value: crate::ga::params::GetSamplingLevel,
            ) -> &mut Self {
                self.sampling_level = Some(value);
                self
            }
            #[doc = "An Analytics segment to be applied to data."]
            pub fn segment(&mut self, value: impl Into<String>) -> &mut Self {
            ...
            pub fn start_index(&mut self, value: i32) -> &mut Self {
            ...
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                ...
                let req = req.bearer_auth(
                    auth.token::<_, &str>(&["https://www.googleapis.com/auth/analytics.readonly"])
                        .unwrap()
                        .access_token,
                );
                req
    ...
    pub mod mcf {
        ...
        pub struct GetRequestBuilder<'a, A> {
            ...
            filters: Option<String>,
            max_results: Option<i32>,
            sampling_level: Option<crate::mcf::params::GetSamplingLevel>,
            sort: Option<String>,
            start_index: Option<i32>,
            alt: Option<crate::params::Alt>,
            fields: Option<String>,
        ...
        impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
            ...
            pub fn sampling_level(
                &mut self,
                value: crate::mcf::params::GetSamplingLevel,
            ) -> &mut Self {
                self.sampling_level = Some(value);
                self
            }
...
pub mod management {
    ...
    impl<'a, A: yup_oauth2::GetToken> ManagementActions<'a, A> {
        ...
        pub fn account_summaries(&self) -> account_summaries::AccountSummariesActions<A> {
            account_summaries::AccountSummariesActions
        }
        #[doc = "Actions that can be performed on the account_user_links resource"]
        pub fn account_user_links(&self) -> account_user_links::AccountUserLinksActions<A> {
            account_user_links::AccountUserLinksActions
        }
        ...
        pub fn client_id(&self) -> client_id::ClientIdActions<A> {
            client_id::ClientIdActions
        }
        #[doc = "Actions that can be performed on the custom_data_sources resource"]
        pub fn custom_data_sources(&self) -> custom_data_sources::CustomDataSourcesActions<A> {
            custom_data_sources::CustomDataSourcesActions
        }
        #[doc = "Actions that can be performed on the custom_dimensions resource"]
        pub fn custom_dimensions(&self) -> custom_dimensions::CustomDimensionsActions<A> {
            custom_dimensions::CustomDimensionsActions
        }
        #[doc = "Actions that can be performed on the custom_metrics resource"]
        pub fn custom_metrics(&self) -> custom_metrics::CustomMetricsActions<A> {
            custom_metrics::CustomMetricsActions
        }
        #[doc = "Actions that can be performed on the experiments resource"]
        pub fn experiments(&self) -> experiments::ExperimentsActions<A> {
            experiments::ExperimentsActions
        }
        #[doc = "Actions that can be performed on the filters resource"]
        pub fn filters(&self) -> filters::FiltersActions<A> {
            filters::FiltersActions
        }
        #[doc = "Actions that can be performed on the goals resource"]
        pub fn goals(&self) -> goals::GoalsActions<A> {
            goals::GoalsActions
        }
        #[doc = "Actions that can be performed on the profile_filter_links resource"]
        pub fn profile_filter_links(&self) -> profile_filter_links::ProfileFilterLinksActions<A> {
            profile_filter_links::ProfileFilterLinksActions
        }
        #[doc = "Actions that can be performed on the profile_user_links resource"]
        pub fn profile_user_links(&self) -> profile_user_links::ProfileUserLinksActions<A> {
            profile_user_links::ProfileUserLinksActions
        }
        #[doc = "Actions that can be performed on the profiles resource"]
        pub fn profiles(&self) -> profiles::ProfilesActions<A> {
            profiles::ProfilesActions
        }
        #[doc = "Actions that can be performed on the remarketing_audience resource"]
        pub fn remarketing_audience(&self) -> remarketing_audience::RemarketingAudienceActions<A> {
            remarketing_audience::RemarketingAudienceActions
        }
        #[doc = "Actions that can be performed on the segments resource"]
        pub fn segments(&self) -> segments::SegmentsActions<A> {
            segments::SegmentsActions
        }
        #[doc = "Actions that can be performed on the unsampled_reports resource"]
        pub fn unsampled_reports(&self) -> unsampled_reports::UnsampledReportsActions<A> {
            unsampled_reports::UnsampledReportsActions
        }
        #[doc = "Actions that can be performed on the uploads resource"]
        pub fn uploads(&self) -> uploads::UploadsActions<A> {
            uploads::UploadsActions
        }
        #[doc = "Actions that can be performed on the web_property_ad_words_links resource"]
        pub fn web_property_ad_words_links(
            &self,
        ) -> web_property_ad_words_links::WebPropertyAdWordsLinksActions<A> {
            web_property_ad_words_links::WebPropertyAdWordsLinksActions
        }
        #[doc = "Actions that can be performed on the webproperties resource"]
        pub fn webproperties(&self) -> webproperties::WebpropertiesActions<A> {
            webproperties::WebpropertiesActions
        }
        #[doc = "Actions that can be performed on the webproperty_user_links resource"]
        pub fn webproperty_user_links(
            &self,
        ) -> webproperty_user_links::WebpropertyUserLinksActions<A> {
            webproperty_user_links::WebpropertyUserLinksActions
        }
    }
    ...
    pub mod client_id {
        ...
        impl<'a, A: yup_oauth2::GetToken> HashClientIdRequestBuilder<'a, A> {
            ...
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                ...
                let mut auth = self.auth.lock().unwrap();
                let req = req.bearer_auth(
                    auth.token::<_, &str>(&["https://www.googleapis.com/auth/analytics.edit"])
                        .unwrap()
                        .access_token,
                );
                req
    ...
    pub mod custom_data_sources {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            fn _path(&self) -> String {
                ...
                output.push_str(&self.web_property_id);
    ...
    pub mod custom_dimensions {
        ...
        impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
            ...
            fn _path(&self) -> String {
                ...
                output.push_str(&self.custom_dimension_id);
                output
            }
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                let req = self.reqwest.request(::reqwest::Method::GET, path);
        ...
        impl<'a, A: yup_oauth2::GetToken> PatchRequestBuilder<'a, A> {
            ...
            pub fn ignore_custom_data_source_links(&mut self, value: bool) -> &mut Self {
    ...
    pub mod custom_metrics {
        ...
        impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
            ...
            fn _path(&self) -> String {
                ...
                output.push_str(&self.custom_metric_id);
                output
            }
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                let req = self.reqwest.request(::reqwest::Method::GET, path);
    ...
    pub mod experiments {
        ...
        impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
            ...
            fn _path(&self) -> String {
                ...
                output.push_str(&self.profile_id);
                output.push_str("/experiments/");
                output.push_str(&self.experiment_id);
                output
            }
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                let req = self.reqwest.request(::reqwest::Method::DELETE, path);
    ...
    pub mod filters {
        ...
        impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
            ...
            fn _path(&self) -> String {
                ...
                output.push_str(&self.filter_id);
                output
            }
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                let req = self.reqwest.request(::reqwest::Method::DELETE, path);
    ...
    pub mod remarketing_audience {
        ...
        impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
            ...
            fn _path(&self) -> String {
                ...
                output.push_str(&self.remarketing_audience_id);
                output
            }
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                let req = self.reqwest.request(::reqwest::Method::DELETE, path);
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            #[doc = ""]
            pub fn r_type(&mut self, value: impl Into<String>) -> &mut Self {
    ...
    pub mod unsampled_reports {
        ...
        impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
            ...
            fn _path(&self) -> String {
                ...
                output.push_str(&self.unsampled_report_id);
                output
            }
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                let req = self.reqwest.request(::reqwest::Method::DELETE, path);
    ...
    pub mod uploads {
        ...
        impl<'a, A: yup_oauth2::GetToken> DeleteUploadDataRequestBuilder<'a, A> {
            ...
            fn _path(&self) -> String {
                ...
                output.push_str(&self.web_property_id);
                output.push_str("/customDataSources/");
                output.push_str(&self.custom_data_source_id);
        ...
        impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
            ...
            fn _path(&self) -> String {
                ...
                output.push_str(&self.upload_id);
                output
            }
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                let req = self.reqwest.request(::reqwest::Method::GET, path);
    ...
    pub mod web_property_ad_words_links {
        ...
        impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
            ...
            fn _path(&self) -> String {
                ...
                output.push_str(&self.web_property_ad_words_link_id);
                output
            }
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                let req = self.reqwest.request(::reqwest::Method::DELETE, path);
...
pub mod metadata {
    ...
    impl<'a, A: yup_oauth2::GetToken> MetadataActions<'a, A> {
        ...
        pub fn columns(&self) -> columns::ColumnsActions<A> {
    ...
    pub mod columns {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            fn _path(&self) -> String {
                ...
                output.push_str(&self.report_type);
...
pub mod provisioning {
    ...
    impl<'a, A: yup_oauth2::GetToken> CreateAccountTicketRequestBuilder<'a, A> {
        ...
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            ...
            let mut auth = self.auth.lock().unwrap();
            let req = req.bearer_auth(
                auth.token::<_, &str>(&["https://www.googleapis.com/auth/analytics.provision"])
                    .unwrap()
                    .access_token,
            );
            req
...
pub mod user_deletion {
    ...
    impl<'a, A: yup_oauth2::GetToken> UserDeletionActions<'a, A> {
        ...
        pub fn user_deletion_request(
            &self,
        ) -> user_deletion_request::UserDeletionRequestActions<A> {
            user_deletion_request::UserDeletionRequestActions
        }
    }
