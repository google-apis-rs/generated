...
appengine1_beta4-cargo: appengine1_beta4
	cd appengine/v1beta4 && cargo $(ARGS)

appengine1_beta5: appengine/v1beta5/spec.json
	$(MCP) generate $< appengine/v1beta5
appengine1_beta5-cargo: appengine1_beta5
	cd appengine/v1beta5 && cargo $(ARGS)
...
cloudiot1_alpha1-cargo: cloudiot1_alpha1
	cd cloudiot/v1alpha1 && cargo $(ARGS)
...
cloudtrace2_alpha1-cargo: cloudtrace2_alpha1
	cd cloudtrace/v2alpha1 && cargo $(ARGS)
...
monitoring3_p1alpha1-cargo: monitoring3_p1alpha1
	cd monitoring/v3p1alpha1 && cargo $(ARGS)
...
osconfig1_alpha1-cargo: osconfig1_alpha1
	cd osconfig/v1alpha1 && cargo $(ARGS)

osconfig1_alpha2: osconfig/v1alpha2/spec.json
	$(MCP) generate $< osconfig/v1alpha2
osconfig1_alpha2-cargo: osconfig1_alpha2
	cd osconfig/v1alpha2 && cargo $(ARGS)
