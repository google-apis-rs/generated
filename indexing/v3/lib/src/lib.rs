pub mod schemas {
    ...
    pub struct PublishUrlNotificationResponse {
        ...
        pub url_notification_metadata: Option<crate::schemas::UrlNotificationMetadata>,
    }
    impl ::field_selector::FieldSelector for PublishUrlNotificationResponse {
...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn url_notifications(&self) -> crate::url_notifications::UrlNotificationsActions<A> {
        crate::url_notifications::UrlNotificationsActions {
...
pub mod url_notifications {
    pub mod params {}
    pub struct UrlNotificationsActions<'a, A> {
    ...
    impl<'a, A: yup_oauth2::GetToken> GetMetadataRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::UrlNotificationMetadata, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        ...
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            ...
            let req = req.bearer_auth(
                auth.token::<_, &str>(&["https://www.googleapis.com/auth/indexing"])
                    .unwrap()
                    .access_token,
            );
            req
    ...
    impl<'a, A: yup_oauth2::GetToken> PublishRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::PublishUrlNotificationResponse, Box<dyn ::std::error::Error>>
        {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
