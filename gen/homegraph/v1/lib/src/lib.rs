#![doc = "# Resources and Methods\n    * [agent_users](resources/agent_users/struct.AgentUsersActions.html)\n      * [*delete*](resources/agent_users/struct.DeleteRequestBuilder.html)\n    * [devices](resources/devices/struct.DevicesActions.html)\n      * [*query*](resources/devices/struct.QueryRequestBuilder.html), [*reportStateAndNotification*](resources/devices/struct.ReportStateAndNotificationRequestBuilder.html), [*requestLink*](resources/devices/struct.RequestLinkRequestBuilder.html), [*requestSync*](resources/devices/struct.RequestSyncRequestBuilder.html), [*sync*](resources/devices/struct.SyncRequestBuilder.html)\n"]
pub mod scopes {
...
pub mod schemas {
    ...
    pub struct Device {
        ...
        #[serde(
            rename = "nonLocalTraits",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub non_local_traits: ::std::option::Option<Vec<crate::schemas::NonLocalTrait>>,
    ...
    pub struct NonLocalTrait {
        ...
        pub r#trait: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for NonLocalTrait {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for NonLocalTrait {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct RequestLinkRequest {
        #[doc = "Required. ID(s) and detection time of potential Cast devices."]
        #[serde(
            rename = "payload",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub payload: ::std::option::Option<crate::schemas::RequestLinkRequestPayload>,
        #[doc = "Required. Request ID used for debugging."]
        #[serde(
            rename = "requestId",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for RequestLinkRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for RequestLinkRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct RequestLinkRequestPayload {
        #[doc = "Required. Time at which devices represented in `potential_cast_device_ids` were detected."]
        #[serde(
            rename = "detectionTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub detection_time: ::std::option::Option<String>,
        #[doc = "Required. List of device IDs detected that may potentially be for Cast devices."]
        #[serde(
            rename = "potentialCastDeviceIds",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub potential_cast_device_ids: ::std::option::Option<Vec<String>>,
    }
    impl ::google_field_selector::FieldSelector for RequestLinkRequestPayload {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for RequestLinkRequestPayload {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
pub mod resources {
    ...
    pub mod devices {
        ...
        impl<'a> DevicesActions<'a> {
            ...
            #[doc = "Sends an account linking suggestion to users associated with any potential Cast devices detected by third-party devices. This request must be authorized using service account credentials from your Actions console project."]
            pub fn request_link(
                &self,
                request: crate::schemas::RequestLinkRequest,
            ) -> RequestLinkRequestBuilder {
                RequestLinkRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                    request,
        ...
        #[doc = "Created via [DevicesActions::request_link()](struct.DevicesActions.html#method.request_link)"]
        #[derive(Debug, Clone)]
        pub struct RequestLinkRequestBuilder<'a> {
            pub(crate) reqwest: &'a ::reqwest::blocking::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            request: crate::schemas::RequestLinkRequest,
            access_token: Option<String>,
        ...
        impl<'a> RequestLinkRequestBuilder<'a> {
            #[doc = "OAuth access token."]
            pub fn access_token(mut self, value: impl Into<String>) -> Self {
                self.access_token = Some(value.into());
                self
            ...
            fn _path(&self) -> String {
                let mut output = "https://homegraph.googleapis.com/".to_owned();
                output.push_str("v1/devices:requestLink");
                output
            }
            fn _request(
                &self,
