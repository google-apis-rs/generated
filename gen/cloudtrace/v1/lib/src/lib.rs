...
pub mod projects {
    ...
    impl<'a, A: yup_oauth2::GetToken> ProjectsActions<'a, A> {
        ...
        pub fn traces(&self) -> traces::TracesActions<A> {
            traces::TracesActions
        }
    }
    #[derive(Debug, Clone)]
    ...
    pub mod traces {
        ...
        impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
            ...
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                ...
                let mut auth = self.auth.lock().unwrap();
                let req = req.bearer_auth(
                    auth.token::<_, &str>(&["https://www.googleapis.com/auth/trace.readonly"])
                        .unwrap()
                        .access_token,
                );
                req
        ...
        pub struct ListRequestBuilder<'a, A> {
            ...
            view: Option<crate::traces::params::ListView>,
            access_token: Option<String>,
            alt: Option<crate::params::Alt>,
            callback: Option<String>,
            fields: Option<String>,
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn view(&mut self, value: crate::traces::params::ListView) -> &mut Self {
