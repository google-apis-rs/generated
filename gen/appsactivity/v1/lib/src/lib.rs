...
mod resources {
    pub mod activities {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn iter_activities<T>(self) -> ListActivitiesIter<'a, A, T>
            where
            ...
            #[doc = r" the server."]
            pub fn iter_activities_standard(
                mut self,
            ) -> ListActivitiesIter<'a, A, crate::schemas::Activity> {
                self.fields = Some(concat!("nextPageToken,", "activities").to_owned());
                ListActivitiesIter {
                    method: self,
                    last_page_reached: false,
                    items_iter: None,
            ...
            pub fn execute_standard(
                self,
            ) -> Result<crate::schemas::ListActivitiesResponse, Box<dyn ::std::error::Error>>
            {
        ...
        pub struct ListActivitiesIter<'a, A, T> {
            method: ListRequestBuilder<'a, A>,
            last_page_reached: bool,
            items_iter: Option<::std::vec::IntoIter<T>>,
        }
        impl<'a, A, T> Iterator for ListActivitiesIter<'a, A, T>
        where
