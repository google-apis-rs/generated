pub mod schemas {
    ...
    impl ::field_selector::FieldSelector for CreateSlotPoolMetadata {
    ...
    impl ::field_selector::FieldSelector for ListReservationGrantsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for ListReservationsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for ListSlotPoolsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for Reservation {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for ReservationGrantJobType {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for ReservationGrant {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for SearchReservationGrantsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for SlotPoolPlan {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for SlotPoolState {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for SlotPool {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub mod projects {
        ...
        pub mod locations {
            ...
            impl<'a, A: yup_oauth2::GetToken> LocationsActions<'a, A> {
                ...
                ) -> SearchReservationGrantsRequestBuilder<A> {
                ...
                #[doc = "Actions that can be performed on the reservation_grants resource"]pub fn reservation_grants ( & self ) -> crate :: resources :: projects :: locations :: reservation_grants :: ReservationGrantsActions < A >{
                    crate :: resources :: projects :: locations :: reservation_grants :: ReservationGrantsActions { reqwest : & self . reqwest , auth : & self . auth }
                }
                #[doc = "Actions that can be performed on the reservations resource"]
                pub fn reservations(
                    &self,
                ) -> crate::resources::projects::locations::reservations::ReservationsActions<A>
                {
            ...
            impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
                ...
                fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                    ...
                    let fut = auth.token(vec!["https://www.googleapis.com/auth/bigquery"]);
            ...
            #[derive(Debug, Clone)]
            pub struct SearchReservationGrantsRequestBuilder<'a, A> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a ::std::sync::Mutex<A>,
                parent: String,
                page_size: Option<i32>,
            ...
            impl<'a, A: yup_oauth2::GetToken> SearchReservationGrantsRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_reservation_grants<T>(
                    self,
                ) -> SearchReservationGrantsReservationGrantsIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    SearchReservationGrantsReservationGrantsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                    }
                ...
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_reservation_grants_standard(
                    mut self,
                ) -> SearchReservationGrantsReservationGrantsIter<
                    'a,
                    A,
                    crate::schemas::ReservationGrant,
                > {
                    self.fields = Some(concat!("nextPageToken,", "reservationGrants").to_owned());
                    SearchReservationGrantsReservationGrantsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                #[doc = r" all fields can be expensive both in bandwidth and server"]
                #[doc = r" resources."]
                pub fn iter_reservation_grants_debug(
                    mut self,
                ) -> SearchReservationGrantsReservationGrantsIter<
                    'a,
                    A,
                ...
                > {
                    self.fields =
                        Some(concat!("nextPageToken,", "reservationGrants", "(*)").to_owned());
                    SearchReservationGrantsReservationGrantsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                pub fn execute_standard(
                    ...
                    crate::schemas::SearchReservationGrantsResponse,
            ...
            pub struct SearchReservationGrantsReservationGrantsIter<'a, A, T> {
                method: SearchReservationGrantsRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for SearchReservationGrantsReservationGrantsIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
                ...
                fn next(&mut self) -> Option<Result<T, Box<dyn ::std::error::Error>>> {
                    #[derive(:: serde :: Deserialize)]
                    struct Resp<T> {
                        #[serde(rename = "reservationGrants")]
                        items: Option<Vec<T>>,
                        #[serde(rename = "nextPageToken")]
                        next_page_token: Option<String>,
                    }
            ...
            impl<'a, A: yup_oauth2::GetToken> crate::IterableMethod
                for SearchReservationGrantsRequestBuilder<'a, A>
            {
                fn set_page_token(&mut self, value: String) {
                    self.page_token = value.into();
                }
            ...
            pub mod reservation_grants {
                pub mod params {}
                pub struct ReservationGrantsActions<'a, A> {
                    pub(crate) reqwest: &'a reqwest::Client,
                    pub(crate) auth: &'a std::sync::Mutex<A>,
                }
                impl<'a, A: yup_oauth2::GetToken> ReservationGrantsActions<'a, A> {
                ...
                impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
                    ...
                    pub fn execute_standard(
                        self,
                    ) -> Result<crate::schemas::ReservationGrant, Box<dyn ::std::error::Error>>
                    {
                        self.execute_fields::<_, &str>(None)
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                    ...
                    #[doc = r" populated fields in the yielded items will be determined by the"]
                    #[doc = r" `FieldSelector` implementation."]
                    pub fn iter_reservation_grants<T>(self) -> ListReservationGrantsIter<'a, A, T>
                    where
                        T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                    {
                        ListReservationGrantsIter {
                            method: self,
                            last_page_reached: false,
                            items_iter: None,
                        }
                    ...
                    pub fn iter_reservation_grants_standard(
                        mut self,
                    ) -> ListReservationGrantsIter<'a, A, crate::schemas::ReservationGrant>
                    {
                        self.fields =
                            Some(concat!("nextPageToken,", "reservationGrants").to_owned());
                        ListReservationGrantsIter {
                    ...
                    pub fn execute_standard(
                        ...
                        crate::schemas::ListReservationGrantsResponse,
                        Box<dyn ::std::error::Error>,
                    > {
                        self.execute_fields::<_, &str>(None)
                    }
                ...
                pub struct ListReservationGrantsIter<'a, A, T> {
                    method: ListRequestBuilder<'a, A>,
                    last_page_reached: bool,
                    items_iter: Option<::std::vec::IntoIter<T>>,
                }
                impl<'a, A, T> Iterator for ListReservationGrantsIter<'a, A, T>
                where
                    A: ::yup_oauth2::GetToken,
                    T: ::serde::de::DeserializeOwned,
                {
            ...
            pub mod reservations {
                pub mod params {}
                pub struct ReservationsActions<'a, A> {
                    pub(crate) reqwest: &'a reqwest::Client,
                    pub(crate) auth: &'a std::sync::Mutex<A>,
                }
                impl<'a, A: yup_oauth2::GetToken> ReservationsActions<'a, A> {
                    ...
                    pub fn create_reservation(
                        ...
                        request: crate::schemas::Reservation,
                        parent: impl Into<String>,
                    ) -> CreateReservationRequestBuilder<A> {
                    ...
                    #[doc = "Actions that can be performed on the slot_pools resource"]pub fn slot_pools ( & self ) -> crate :: resources :: projects :: locations :: reservations :: slot_pools :: SlotPoolsActions < A >{
                        crate :: resources :: projects :: locations :: reservations :: slot_pools :: SlotPoolsActions { reqwest : & self . reqwest , auth : & self . auth }
                    }
                }
                #[derive(Debug, Clone)]
                pub struct CreateRequestBuilder<'a, A> {
                ...
                impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
                    ...
                    pub fn execute_standard(
                        self,
                    ) -> Result<crate::schemas::Reservation, Box<dyn ::std::error::Error>>
                    {
                        self.execute_fields::<_, &str>(None)
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                #[derive(Debug, Clone)]
                pub struct CreateReservationRequestBuilder<'a, A> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a ::std::sync::Mutex<A>,
                    request: crate::schemas::Reservation,
                    parent: String,
                ...
                impl<'a, A: yup_oauth2::GetToken> CreateReservationRequestBuilder<'a, A> {
                    #[doc = "The reservation ID relative to the parent, e.g., \"dev\". This field must\nonly contain alphanumeric characters."]
                    pub fn reservation_id(mut self, value: impl Into<String>) -> Self {
                        self.reservation_id = Some(value.into());
                        self
                ...
                impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                    ...
                    #[doc = r" populated fields in the yielded items will be determined by the"]
                    #[doc = r" `FieldSelector` implementation."]
                    pub fn iter_reservations<T>(self) -> ListReservationsIter<'a, A, T>
                    where
                        T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                    {
                        ListReservationsIter {
                            method: self,
                            last_page_reached: false,
                            items_iter: None,
                        }
                    ...
                    #[doc = r" fields in `#items_type` will be the default fields populated by"]
                    #[doc = r" the server."]
                    pub fn iter_reservations_standard(
                        mut self,
                    ) -> ListReservationsIter<'a, A, crate::schemas::Reservation>
                    {
                        self.fields = Some(concat!("nextPageToken,", "reservations").to_owned());
                        ListReservationsIter {
                            method: self,
                            last_page_reached: false,
                            items_iter: None,
                    ...
                    #[doc = r" all fields can be expensive both in bandwidth and server"]
                    #[doc = r" resources."]
                    pub fn iter_reservations_debug(
                        mut self,
                    ) -> ListReservationsIter<'a, A, crate::schemas::Reservation>
                    {
                        self.fields =
                            Some(concat!("nextPageToken,", "reservations", "(*)").to_owned());
                        ListReservationsIter {
                            method: self,
                            last_page_reached: false,
                            items_iter: None,
                    ...
                    pub fn execute_standard(
                        ...
                        crate::schemas::ListReservationsResponse,
                        Box<dyn ::std::error::Error>,
                    > {
                        self.execute_fields::<_, &str>(None)
                    }
                ...
                pub struct ListReservationsIter<'a, A, T> {
                    method: ListRequestBuilder<'a, A>,
                    last_page_reached: bool,
                    items_iter: Option<::std::vec::IntoIter<T>>,
                }
                impl<'a, A, T> Iterator for ListReservationsIter<'a, A, T>
                where
                    A: ::yup_oauth2::GetToken,
                    T: ::serde::de::DeserializeOwned,
                {
                ...
                pub mod slot_pools {
                    pub mod params {}
                    pub struct SlotPoolsActions<'a, A> {
                        pub(crate) reqwest: &'a reqwest::Client,
                        pub(crate) auth: &'a std::sync::Mutex<A>,
                    }
                    impl<'a, A: yup_oauth2::GetToken> SlotPoolsActions<'a, A> {
                    ...
                    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
                        ...
                        pub fn execute_standard(
                            self,
                        ) -> Result<crate::schemas::SlotPool, Box<dyn ::std::error::Error>>
                        {
                            self.execute_fields::<_, &str>(None)
                        }
                        #[doc = r" Execute the given operation. This will provide a `fields`"]
                    ...
                    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                        ...
                        #[doc = r" populated fields in the yielded items will be determined by the"]
                        #[doc = r" `FieldSelector` implementation."]
                        pub fn iter_slot_pools<T>(self) -> ListSlotPoolsIter<'a, A, T>
                        where
                            T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                        {
                            ListSlotPoolsIter {
                        ...
                        #[doc = r" fields in `#items_type` will be the default fields populated by"]
                        #[doc = r" the server."]
                        pub fn iter_slot_pools_standard(
                            mut self,
                        ) -> ListSlotPoolsIter<'a, A, crate::schemas::SlotPool>
                        {
                            self.fields = Some(concat!("nextPageToken,", "slotPools").to_owned());
                            ListSlotPoolsIter {
                                method: self,
                                last_page_reached: false,
                                items_iter: None,
                        ...
                        #[doc = r" all fields can be expensive both in bandwidth and server"]
                        #[doc = r" resources."]
                        pub fn iter_slot_pools_debug(
                            mut self,
                        ) -> ListSlotPoolsIter<'a, A, crate::schemas::SlotPool>
                        {
                            self.fields =
                                Some(concat!("nextPageToken,", "slotPools", "(*)").to_owned());
                            ListSlotPoolsIter {
                                method: self,
                                last_page_reached: false,
                                items_iter: None,
                        ...
                        pub fn execute_standard(
                            ...
                            crate::schemas::ListSlotPoolsResponse,
                            Box<dyn ::std::error::Error>,
                        > {
                            self.execute_fields::<_, &str>(None)
                        }
                    ...
                    pub struct ListSlotPoolsIter<'a, A, T> {
                        method: ListRequestBuilder<'a, A>,
                        last_page_reached: bool,
                        items_iter: Option<::std::vec::IntoIter<T>>,
                    }
                    impl<'a, A, T> Iterator for ListSlotPoolsIter<'a, A, T>
                    where
                        A: ::yup_oauth2::GetToken,
                        T: ::serde::de::DeserializeOwned,
                    {
