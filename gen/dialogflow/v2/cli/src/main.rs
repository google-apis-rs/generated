...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        ...
        let mut locations1 = SubCommand::with_name("locations")
                        .setting(AppSettings::ColoredHelp)
                        .about("sub-resources: answer_records, conversation_profiles, conversations, knowledge_bases and operations");
        ...
        {
            let mcmd = SubCommand::with_name("create").about("Creates a new document. Operation ");
            documents2 = documents2.subcommand(mcmd);
        }
        {
            let mcmd =
                SubCommand::with_name("delete").about("Deletes the specified document. Operation ");
            documents2 = documents2.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd =
                SubCommand::with_name("patch").about("Updates the specified document. Operation ");
            documents2 = documents2.subcommand(mcmd);
        }
        {
        ...
        let mut suggestions3 = SubCommand::with_name("suggestions")
            .setting(AppSettings::ColoredHelp)
            .about("methods: suggest_articles and suggest_faq_answers");
        {
