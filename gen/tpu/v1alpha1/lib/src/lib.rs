    ...
    pub mod projects {
        ...
        pub mod locations {
            ...
            pub mod accelerator_types {
                ...
                impl<'a, A: ::google_api_auth::GetAccessToken> AcceleratorTypesActions<'a, A> {
            ...
            pub mod nodes {
                ...
                impl<'a, A: ::google_api_auth::GetAccessToken> NodesActions<'a, A> {
                    #[doc = "Creates a node."]
                    pub fn create(
                        &self,
                ...
                impl<'a, A: ::google_api_auth::GetAccessToken> ReimageRequestBuilder<'a, A> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
            ...
            pub mod tensorflow_versions {
                ...
                impl<'a, A: ::google_api_auth::GetAccessToken> TensorflowVersionsActions<'a, A> {
