...
pub mod schemas {
    ...
    impl ::google_field_selector::FieldSelector for AnalyticsSnapshot {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for AnalyticsSnapshot {
    ...
    impl ::google_field_selector::ToFieldType for AnalyticsSummary {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for StringCount {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    impl ::google_field_selector::ToFieldType for UrlHistory {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
impl Client {
    ...
    #[doc = "Actions that can be performed on the url resource"]
    pub fn url(&self) -> crate::resources::url::UrlActions {
        crate::resources::url::UrlActions {
    ...
    pub mod url {
        pub mod params {
            ...
            pub enum GetProjection {
                #[doc = "Returns only click counts."]
                AnalyticsClicks,
                #[doc = "Returns only top string counts."]
                AnalyticsTopStrings,
                #[doc = "Returns the creation timestamp and all available analytics."]
                Full,
            }
            impl GetProjection {
                pub fn as_str(self) -> &'static str {
                    match self {
                        GetProjection::AnalyticsClicks => "ANALYTICS_CLICKS",
                        GetProjection::AnalyticsTopStrings => "ANALYTICS_TOP_STRINGS",
        ...
        impl<'a> UrlActions<'a> {
            ...
            #[doc = "Expands a short URL or gets creation time and analytics."]
            pub fn get(&self, short_url: impl Into<String>) -> GetRequestBuilder {
                GetRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                    alt: None,
            ...
            #[doc = "Creates a new short URL."]
            pub fn insert(&self, request: crate::schemas::Url) -> InsertRequestBuilder {
            ...
            #[doc = "Retrieves a list of URLs shortened by a user."]
        ...
        pub struct GetRequestBuilder<'a> {
            ...
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            short_url: String,
            projection: Option<crate::resources::url::params::GetProjection>,
        ...
        impl<'a> GetRequestBuilder<'a> {
            #[doc = "Additional information to return."]
            pub fn projection(
                mut self,
                value: crate::resources::url::params::GetProjection,
            ) -> Self {
            ...
            pub fn execute_with_default_fields(self) -> Result<crate::schemas::Url, crate::Error> {
            ...
            pub fn execute_with_all_fields(self) -> Result<crate::schemas::Url, crate::Error> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://www.googleapis.com/urlshortener/v1/".to_owned();
                output.push_str("url");
                output
            }
            fn _request(&self, path: &str) -> Result<::reqwest::RequestBuilder, crate::Error> {
                let req = self.reqwest.request(::reqwest::Method::GET, path);
                let req = req.query(&[("shortUrl", &self.short_url)]);
        ...
        pub struct ListRequestBuilder<'a> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            projection: Option<crate::resources::url::params::ListProjection>,
        ...
        impl<'a> ListRequestBuilder<'a> {
            ...
            pub fn projection(
                mut self,
                value: crate::resources::url::params::ListProjection,
            ) -> Self {
                self.projection = Some(value);
                self
            }
            #[doc = "Token for requesting successive pages of results."]
            pub fn start_token(mut self, value: impl Into<String>) -> Self {
                self.start_token = Some(value.into());
                self
            }
            #[doc = "API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token."]
            pub fn key(mut self, value: impl Into<String>) -> Self {
            ...
            pub fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::UrlHistory, crate::Error> {
                self.execute_with_fields(None::<&str>)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            fn _path(&self) -> String {
                let mut output = "https://www.googleapis.com/urlshortener/v1/".to_owned();
                output.push_str("url/history");
                output
            }
            fn _request(&self, path: &str) -> Result<::reqwest::RequestBuilder, crate::Error> {
                let req = self.reqwest.request(::reqwest::Method::GET, path);
                let req = req.query(&[("projection", &self.projection)]);
                let req = req.query(&[("start-token", &self.start_token)]);
                let req = req.query(&[("alt", &self.alt)]);
                let req = req.query(&[("fields", &self.fields)]);
                let req = req.query(&[("key", &self.key)]);
                let req = req.query(&[("oauth_token", &self.oauth_token)]);
