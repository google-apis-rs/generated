...
mod resources {
    pub mod applications {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn iter_applications<T>(self) -> ListApplicationsIter<'a, A, T>
            where
                T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
            {
                ListApplicationsIter {
                    method: self,
            ...
            pub fn iter_applications_standard(
                mut self,
            ) -> ListApplicationsIter<'a, A, crate::schemas::Application> {
        ...
        pub struct ListApplicationsIter<'a, A, T> {
            method: ListRequestBuilder<'a, A>,
            last_page_reached: bool,
            items_iter: Option<::std::vec::IntoIter<T>>,
        }
        impl<'a, A, T> Iterator for ListApplicationsIter<'a, A, T>
        where
    ...
    pub mod transfers {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            #[doc = r" populated fields in the yielded items will be determined by the"]
            #[doc = r" `FieldSelector` implementation."]
            pub fn iter_data_transfers<T>(self) -> ListDataTransfersIter<'a, A, T>
            where
                T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
            {
                ListDataTransfersIter {
                    method: self,
                    last_page_reached: false,
                    items_iter: None,
                }
            ...
            pub fn iter_data_transfers_standard(
                mut self,
            ) -> ListDataTransfersIter<'a, A, crate::schemas::DataTransfer> {
        ...
        pub struct ListDataTransfersIter<'a, A, T> {
            method: ListRequestBuilder<'a, A>,
            last_page_reached: bool,
            items_iter: Option<::std::vec::IntoIter<T>>,
        }
        impl<'a, A, T> Iterator for ListDataTransfersIter<'a, A, T>
        where
            A: ::yup_oauth2::GetToken,
            T: ::serde::de::DeserializeOwned,
        {
