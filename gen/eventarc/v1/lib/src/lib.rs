...
pub mod schemas {
    ...
    pub struct Trigger {
        ...
        #[doc = "Required. null The list of filters that applies to event attributes. Only events that match all the provided filters will be sent to the destination."]
        #[serde(
            rename = "eventFilters",
            default,
            skip_serializing_if = "std::option::Option::is_none"
