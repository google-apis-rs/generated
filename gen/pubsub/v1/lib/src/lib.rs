    ...
    pub mod projects {
        ...
        impl<'a, A: yup_oauth2::GetToken> ProjectsActions<'a, A> {
            ...
            pub fn subscriptions(
                &self,
            ) -> crate::resources::projects::subscriptions::SubscriptionsActions<A> {
            ...
            pub fn topics(&self) -> crate::resources::projects::topics::TopicsActions<A> {
        ...
        pub mod snapshots {
            ...
            impl<'a, A: yup_oauth2::GetToken> SnapshotsActions<'a, A> {
                ...
                pub fn delete(&self, snapshot: impl Into<String>) -> DeleteRequestBuilder<A> {
                ...
                pub fn get(&self, snapshot: impl Into<String>) -> GetRequestBuilder<A> {
                    GetRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: &self.auth,
                        access_token: None,
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                pub fn iter_snapshots<T>(self) -> ListSnapshotsIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListSnapshotsIter {
                ...
                #[doc = r" the server."]
                pub fn iter_snapshots_standard(
                    mut self,
                ) -> ListSnapshotsIter<'a, A, crate::schemas::Snapshot> {
                    self.fields = Some(concat!("nextPageToken,", "snapshots").to_owned());
                    ListSnapshotsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
            ...
            pub struct ListSnapshotsIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListSnapshotsIter<'a, A, T>
            where
        ...
        pub mod subscriptions {
            ...
            impl<'a, A: yup_oauth2::GetToken> SubscriptionsActions<'a, A> {
                ...
                pub fn delete(&self, subscription: impl Into<String>) -> DeleteRequestBuilder<A> {
                    DeleteRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: &self.auth,
                        access_token: None,
                ...
                pub fn get(&self, subscription: impl Into<String>) -> GetRequestBuilder<A> {
                    GetRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: &self.auth,
                        access_token: None,
                ...
                pub fn modify_ack_deadline(
                    ...
                    subscription: impl Into<String>,
                ) -> ModifyAckDeadlineRequestBuilder<A> {
                ...
                pub fn modify_push_config(
                    ...
                    subscription: impl Into<String>,
                ) -> ModifyPushConfigRequestBuilder<A> {
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                pub fn iter_subscriptions_debug(
                    ...
                    self.fields =
                        Some(concat!("nextPageToken,", "subscriptions", "(*)").to_owned());
                    ListSubscriptionsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::ListSubscriptionsResponse, Box<dyn ::std::error::Error>>
                {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            #[derive(Debug, Clone)]
            pub struct ModifyAckDeadlineRequestBuilder<'a, A> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a ::std::sync::Mutex<A>,
                request: crate::schemas::ModifyAckDeadlineRequest,
                subscription: String,
            ...
            impl<'a, A: yup_oauth2::GetToken> ModifyAckDeadlineRequestBuilder<'a, A> {
                #[doc = "OAuth access token."]
                pub fn access_token(mut self, value: impl Into<String>) -> Self {
                    self.access_token = Some(value.into());
                    self
            ...
            #[derive(Debug, Clone)]
            pub struct ModifyPushConfigRequestBuilder<'a, A> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a ::std::sync::Mutex<A>,
                request: crate::schemas::ModifyPushConfigRequest,
                subscription: String,
            ...
            impl<'a, A: yup_oauth2::GetToken> ModifyPushConfigRequestBuilder<'a, A> {
                #[doc = "OAuth access token."]
                pub fn access_token(mut self, value: impl Into<String>) -> Self {
                    self.access_token = Some(value.into());
                    self
            ...
            #[derive(Debug, Clone)]
            pub struct PullRequestBuilder<'a, A> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a ::std::sync::Mutex<A>,
                request: crate::schemas::PullRequest,
                subscription: String,
            ...
            impl<'a, A: yup_oauth2::GetToken> PullRequestBuilder<'a, A> {
                #[doc = "OAuth access token."]
                pub fn access_token(mut self, value: impl Into<String>) -> Self {
                    self.access_token = Some(value.into());
                    self
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::PullResponse, Box<dyn ::std::error::Error>>
                {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            #[derive(Debug, Clone)]
            pub struct SeekRequestBuilder<'a, A> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a ::std::sync::Mutex<A>,
                request: crate::schemas::SeekRequest,
                subscription: String,
            ...
            impl<'a, A: yup_oauth2::GetToken> SeekRequestBuilder<'a, A> {
                #[doc = "OAuth access token."]
                pub fn access_token(mut self, value: impl Into<String>) -> Self {
                    self.access_token = Some(value.into());
                    self
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::SeekResponse, Box<dyn ::std::error::Error>>
                {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
        ...
        pub mod topics {
            ...
            impl<'a, A: yup_oauth2::GetToken> TopicsActions<'a, A> {
                ...
                pub fn delete(&self, topic: impl Into<String>) -> DeleteRequestBuilder<A> {
                    DeleteRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: &self.auth,
                        access_token: None,
                ...
                pub fn get(&self, topic: impl Into<String>) -> GetRequestBuilder<A> {
                    GetRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: &self.auth,
                        access_token: None,
                ...
                pub fn snapshots(
                    &self,
                ) -> crate::resources::projects::topics::snapshots::SnapshotsActions<A>
                {
                ...
                pub fn subscriptions(
                    &self,
                ) -> crate::resources::projects::topics::subscriptions::SubscriptionsActions<A>
                {
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_topics<T>(self) -> ListTopicsIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListTopicsIter {
                ...
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_topics_standard(
                    mut self,
                ) -> ListTopicsIter<'a, A, crate::schemas::Topic> {
                    self.fields = Some(concat!("nextPageToken,", "topics").to_owned());
                    ListTopicsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                #[doc = r" all fields can be expensive both in bandwidth and server"]
                #[doc = r" resources."]
                pub fn iter_topics_debug(mut self) -> ListTopicsIter<'a, A, crate::schemas::Topic> {
                    self.fields = Some(concat!("nextPageToken,", "topics", "(*)").to_owned());
                    ListTopicsIter {
                        method: self,
                        last_page_reached: false,
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::ListTopicsResponse, Box<dyn ::std::error::Error>>
                {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            pub struct ListTopicsIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListTopicsIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
            ...
            impl<'a, A: yup_oauth2::GetToken> PublishRequestBuilder<'a, A> {
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::PublishResponse, Box<dyn ::std::error::Error>>
                {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            pub mod snapshots {
                ...
                impl<'a, A: yup_oauth2::GetToken> SnapshotsActions<'a, A> {
                    ...
                    pub fn list(&self, topic: impl Into<String>) -> ListRequestBuilder<A> {
                        ListRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: &self.auth,
                            access_token: None,
                ...
                impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                    ...
                    #[doc = r" fields in `#items_type` will be the default fields populated by"]
                    #[doc = r" the server."]
                    pub fn iter_snapshots_standard(mut self) -> ListSnapshotsIter<'a, A, String> {
                        self.fields = Some(concat!("nextPageToken,", "snapshots").to_owned());
                        ListSnapshotsIter {
                            method: self,
                            last_page_reached: false,
                    ...
                    #[doc = r" all fields can be expensive both in bandwidth and server"]
                    #[doc = r" resources."]
                    pub fn iter_snapshots_debug(mut self) -> ListSnapshotsIter<'a, A, String> {
                        self.fields =
                            Some(concat!("nextPageToken,", "snapshots", "(*)").to_owned());
                        ListSnapshotsIter {
                            method: self,
                            last_page_reached: false,
                            items_iter: None,
                    ...
                    pub fn execute_standard(
                        ...
                        crate::schemas::ListTopicSnapshotsResponse,
            ...
            pub mod subscriptions {
                ...
                impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                    ...
                    pub fn iter_subscriptions_standard(
                        mut self,
                    ) -> ListSubscriptionsIter<'a, A, String> {
                        self.fields = Some(concat!("nextPageToken,", "subscriptions").to_owned());
                        ListSubscriptionsIter {
                            method: self,
                            last_page_reached: false,
