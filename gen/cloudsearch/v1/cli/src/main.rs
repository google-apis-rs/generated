...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        ...
        {
            let mcmd = SubCommand::with_name("suggest")
                .about("Provides suggestions for autocompleting the query.");
            query0 = query0.subcommand(mcmd);
        }
        ...
        {
            let mcmd = SubCommand::with_name("delete_schema")
                .about("Deletes the schema of a data source.");
            datasources1 = datasources1.subcommand(mcmd);
        }
        {
            let mcmd =
                SubCommand::with_name("get_schema").about("Gets the schema of a data source.");
            datasources1 = datasources1.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("update_schema")
                .about("Updates the schema of a data source.");
            datasources1 = datasources1.subcommand(mcmd);
        }
            ...
            .about("methods: list");
        {
            let mcmd = SubCommand::with_name("list")
                .about("Returns list of sources that user can use for Search and Suggest APIs.");
        ...
        {
            let mcmd = SubCommand::with_name("create").about("Creates a datasource.");
            datasources1 = datasources1.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("delete").about("Deletes a datasource.");
            datasources1 = datasources1.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("get").about("Gets a datasource.");
            datasources1 = datasources1.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("Lists datasources.");
            datasources1 = datasources1.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("update").about("Updates a datasource.");
            datasources1 = datasources1.subcommand(mcmd);
        }
        ...
        {
            let mcmd = SubCommand::with_name("check_access")
                .about("Checks whether an item is accessible by specified principal.");
        ...
        {
            let mcmd = SubCommand::with_name("list_forunmappedidentity")
                .about("Lists names of items associated with an unmapped identity.");
            items2 = items2.subcommand(mcmd);
        }
        ...
        {
            let mcmd = SubCommand::with_name("list")
                .about("Lists unmapped user identities for an identity source.");
                        ...
                        .about("methods: delete, delete_queue_items, get, index, list, poll, push, unreserve and upload");
        {
            let mcmd = SubCommand::with_name("delete")
                .about("Deletes Item resource for the\nspecified resource name.");
            items2 = items2.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("delete_queue_items").about(
        ...
        {
            let mcmd =
                SubCommand::with_name("list").about("Lists all or a subset of Item resources.");
            items2 = items2.subcommand(mcmd);
        }
        {
        ...
        }
        {
            let mcmd = SubCommand::with_name("push")
                .about("Pushes an item onto a queue for later polling and updating.");
            items2 = items2.subcommand(mcmd);
        }
        {
            ...
            .about("methods: get");
        {
            let mcmd = SubCommand::with_name("get")
                .about("Gets indexed item statistics for a single data source.");
        ...
        {
            let mcmd = SubCommand::with_name("list")
                .about("List all unmapped identities for a specific item.");
