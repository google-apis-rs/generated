pub mod schemas {
    ...
    impl ::field_selector::FieldSelector for ArgumentArgumentKind {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct BigtableColumn {
        ...
        pub qualifier_encoded: ::std::option::Option<crate::bytes::Bytes>,
    ...
    type JsonObject = ::std::collections::BTreeMap<String, crate::schemas::JsonValue>;
    ...
    impl ::field_selector::FieldSelector for ModelModelType {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct QueryParameterType {
        ...
        pub array_type: ::std::option::Option<crate::schemas::QueryParameterType>,
    ...
    impl ::field_selector::FieldSelector for RoutineLanguage {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for RoutineRoutineType {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct StandardSqlDataType {
        ...
        pub array_element_type: ::std::option::Option<crate::schemas::StandardSqlDataType>,
    ...
    impl ::field_selector::FieldSelector for TrainingOptionsDataSplitMethod {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for TrainingOptionsDistanceType {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for TrainingOptionsKmeansInitializationMethod {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for TrainingOptionsLearnRateStrategy {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for TrainingOptionsLossType {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn datasets(&self) -> crate::resources::datasets::DatasetsActions<A> {
    ...
    pub fn models(&self) -> crate::resources::models::ModelsActions<A> {
    ...
    pub fn routines(&self) -> crate::resources::routines::RoutinesActions<A> {
    ...
    pub fn tabledata(&self) -> crate::resources::tabledata::TabledataActions<A> {
    ...
    pub fn tables(&self) -> crate::resources::tables::TablesActions<A> {
...
mod resources {
    pub mod datasets {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn iter_datasets_standard(
                mut self,
            ) -> ListDatasetsIter<'a, A, crate::schemas::DatasetListDatasetsItems> {
    ...
    pub mod jobs {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn iter_jobs_standard(
                mut self,
            ) -> ListJobsIter<'a, A, crate::schemas::JobListJobsItems> {
    ...
    pub mod models {
        ...
        impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
            ...
            pub fn execute_standard(
                self,
            ) -> Result<crate::schemas::Model, Box<dyn ::std::error::Error>> {
                self.execute_fields::<_, &str>(None)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            #[doc = r" fields in `#items_type` will be the default fields populated by"]
            #[doc = r" the server."]
            pub fn iter_models_standard(mut self) -> ListModelsIter<'a, A, crate::schemas::Model> {
            ...
            #[doc = r" all fields can be expensive both in bandwidth and server"]
            #[doc = r" resources."]
            pub fn iter_models_debug(mut self) -> ListModelsIter<'a, A, crate::schemas::Model> {
                self.fields = Some(concat!("nextPageToken,", "models", "(*)").to_owned());
                ListModelsIter {
                    method: self,
                    last_page_reached: false,
    ...
    pub mod projects {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn iter_projects_standard(
                mut self,
            ) -> ListProjectsIter<'a, A, crate::schemas::ProjectListProjectsItems> {
    ...
    pub mod routines {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            #[doc = r" populated fields in the yielded items will be determined by the"]
            #[doc = r" `FieldSelector` implementation."]
            pub fn iter_routines<T>(self) -> ListRoutinesIter<'a, A, T>
            where
                T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
            {
                ListRoutinesIter {
            ...
            #[doc = r" fields in `#items_type` will be the default fields populated by"]
            #[doc = r" the server."]
            pub fn iter_routines_standard(
                mut self,
            ) -> ListRoutinesIter<'a, A, crate::schemas::Routine> {
                self.fields = Some(concat!("nextPageToken,", "routines").to_owned());
                ListRoutinesIter {
                    method: self,
                    last_page_reached: false,
                    items_iter: None,
        ...
        pub struct ListRoutinesIter<'a, A, T> {
            method: ListRequestBuilder<'a, A>,
            last_page_reached: bool,
            items_iter: Option<::std::vec::IntoIter<T>>,
        }
        impl<'a, A, T> Iterator for ListRoutinesIter<'a, A, T>
        where
            A: ::yup_oauth2::GetToken,
            T: ::serde::de::DeserializeOwned,
        {
    ...
    pub mod tables {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn iter_tables_standard(
                mut self,
            ) -> ListTablesIter<'a, A, crate::schemas::TableListTablesItems> {
