pub mod schemas {
        ...
        for GoogleCloudVideointelligenceV1P1Beta1AnnotateVideoRequestFeaturesItems
    {
        ...
        {
            let value: &'de str = <&str>::deserialize(deserializer)?;
            Ok ( match value { "FEATURE_UNSPECIFIED" => GoogleCloudVideointelligenceV1P1Beta1AnnotateVideoRequestFeaturesItems :: FeatureUnspecified , "LABEL_DETECTION" => GoogleCloudVideointelligenceV1P1Beta1AnnotateVideoRequestFeaturesItems :: LabelDetection , "SHOT_CHANGE_DETECTION" => GoogleCloudVideointelligenceV1P1Beta1AnnotateVideoRequestFeaturesItems :: ShotChangeDetection , "EXPLICIT_CONTENT_DETECTION" => GoogleCloudVideointelligenceV1P1Beta1AnnotateVideoRequestFeaturesItems :: ExplicitContentDetection , "SPEECH_TRANSCRIPTION" => GoogleCloudVideointelligenceV1P1Beta1AnnotateVideoRequestFeaturesItems :: SpeechTranscription , "TEXT_DETECTION" => GoogleCloudVideointelligenceV1P1Beta1AnnotateVideoRequestFeaturesItems :: TextDetection , "OBJECT_TRACKING" => GoogleCloudVideointelligenceV1P1Beta1AnnotateVideoRequestFeaturesItems :: ObjectTracking , _ => return Err ( :: serde :: de :: Error :: custom ( format ! ( "invalid enum for #name: {}" , value ) ) ) , } )
        }
    }
    #[derive(
        Debug, Clone, PartialEq, PartialOrd, Default, :: serde :: Deserialize, :: serde :: Serialize,
    )]
    pub struct GoogleCloudVideointelligenceV1P1Beta1AnnotateVideoRequest { # [ doc = "Requested video annotation features." ] # [ serde ( rename = "features" , default ) ] pub features : Option < Vec < crate :: schemas :: GoogleCloudVideointelligenceV1P1Beta1AnnotateVideoRequestFeaturesItems > > , # [ doc = "The video data bytes.\nIf unset, the input video(s) should be specified via `input_uri`.\nIf set, `input_uri` should be unset." ] # [ serde ( rename = "inputContent" , default ) ] pub input_content : Option < Vec < u8 > > , # [ doc = "Input video location. Currently, only\n[Google Cloud Storage](https://cloud.google.com/storage/) URIs are\nsupported, which must be specified in the following format:\n`gs://bucket-id/object-id` (other URI formats return\ngoogle.rpc.Code.INVALID_ARGUMENT). For more information, see\n[Request URIs](/storage/docs/reference-uris).\nA video URI may include wildcards in `object-id`, and thus identify\nmultiple videos. Supported wildcards: '*' to match 0 or more characters;\n'?' to match 1 character. If unset, the input video should be embedded\nin the request as `input_content`. If set, `input_content` should be unset." ] # [ serde ( rename = "inputUri" , default ) ] pub input_uri : Option < String > , # [ doc = "Optional cloud region where annotation should take place. Supported cloud\nregions: `us-east1`, `us-west1`, `europe-west1`, `asia-east1`. If no region\nis specified, a region will be determined based on video file location." ] # [ serde ( rename = "locationId" , default ) ] pub location_id : Option < String > , # [ doc = "Optional location where the output (in JSON format) should be stored.\nCurrently, only [Google Cloud Storage](https://cloud.google.com/storage/)\nURIs are supported, which must be specified in the following format:\n`gs://bucket-id/object-id` (other URI formats return\ngoogle.rpc.Code.INVALID_ARGUMENT). For more information, see\n[Request URIs](/storage/docs/reference-uris)." ] # [ serde ( rename = "outputUri" , default ) ] pub output_uri : Option < String > , # [ doc = "Additional video context and/or feature-specific parameters." ] # [ serde ( rename = "videoContext" , default ) ] pub video_context : Option < crate :: schemas :: GoogleCloudVideointelligenceV1P1Beta1VideoContext > , }
    impl ::field_selector::FieldSelector for GoogleCloudVideointelligenceV1P1Beta1AnnotateVideoRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl GoogleCloudVideointelligenceV1P1Beta1LabelDetectionConfigLabelDetectionMode {
        pub fn as_str(self) -> &'static str {
            match self { GoogleCloudVideointelligenceV1P1Beta1LabelDetectionConfigLabelDetectionMode :: LabelDetectionModeUnspecified => "LABEL_DETECTION_MODE_UNSPECIFIED" , GoogleCloudVideointelligenceV1P1Beta1LabelDetectionConfigLabelDetectionMode :: ShotMode => "SHOT_MODE" , GoogleCloudVideointelligenceV1P1Beta1LabelDetectionConfigLabelDetectionMode :: FrameMode => "FRAME_MODE" , GoogleCloudVideointelligenceV1P1Beta1LabelDetectionConfigLabelDetectionMode :: ShotAndFrameMode => "SHOT_AND_FRAME_MODE" , }
        }
    }
    impl ::std::fmt::Display
        ...
        for GoogleCloudVideointelligenceV1P1Beta1LabelDetectionConfigLabelDetectionMode
    {
        ...
        {
            let value: &'de str = <&str>::deserialize(deserializer)?;
            Ok ( match value { "LABEL_DETECTION_MODE_UNSPECIFIED" => GoogleCloudVideointelligenceV1P1Beta1LabelDetectionConfigLabelDetectionMode :: LabelDetectionModeUnspecified , "SHOT_MODE" => GoogleCloudVideointelligenceV1P1Beta1LabelDetectionConfigLabelDetectionMode :: ShotMode , "FRAME_MODE" => GoogleCloudVideointelligenceV1P1Beta1LabelDetectionConfigLabelDetectionMode :: FrameMode , "SHOT_AND_FRAME_MODE" => GoogleCloudVideointelligenceV1P1Beta1LabelDetectionConfigLabelDetectionMode :: ShotAndFrameMode , _ => return Err ( :: serde :: de :: Error :: custom ( format ! ( "invalid enum for #name: {}" , value ) ) ) , } )
        }
    }
    #[derive(
        Debug, Clone, PartialEq, PartialOrd, Default, :: serde :: Deserialize, :: serde :: Serialize,
    )]
    pub struct GoogleCloudVideointelligenceV1P1Beta1LabelDetectionConfig { # [ doc = "The confidence threshold we perform filtering on the labels from\nframe-level detection. If not set, it is set to 0.4 by default. The valid\nrange for this threshold is [0.1, 0.9]. Any value set outside of this\nrange will be clipped.\nNote: for best results please follow the default threshold. We will update\nthe default threshold everytime when we release a new model." ] # [ serde ( rename = "frameConfidenceThreshold" , default ) ] pub frame_confidence_threshold : Option < f32 > , # [ doc = "What labels should be detected with LABEL_DETECTION, in addition to\nvideo-level labels or segment-level labels.\nIf unspecified, defaults to `SHOT_MODE`." ] # [ serde ( rename = "labelDetectionMode" , default ) ] pub label_detection_mode : Option < crate :: schemas :: GoogleCloudVideointelligenceV1P1Beta1LabelDetectionConfigLabelDetectionMode > , # [ doc = "Model to use for label detection.\nSupported values: \"builtin/stable\" (the default if unset) and\n\"builtin/latest\"." ] # [ serde ( rename = "model" , default ) ] pub model : Option < String > , # [ doc = "Whether the video has been shot from a stationary (i.e. non-moving) camera.\nWhen set to true, might improve detection accuracy for moving objects.\nShould be used with `SHOT_AND_FRAME_MODE` enabled." ] # [ serde ( rename = "stationaryCamera" , default ) ] pub stationary_camera : Option < bool > , # [ doc = "The confidence threshold we perform filtering on the labels from\nvideo-level and shot-level detections. If not set, it is set to 0.3 by\ndefault. The valid range for this threshold is [0.1, 0.9]. Any value set\noutside of this range will be clipped.\nNote: for best results please follow the default threshold. We will update\nthe default threshold everytime when we release a new model." ] # [ serde ( rename = "videoConfidenceThreshold" , default ) ] pub video_confidence_threshold : Option < f32 > , }
    impl ::field_selector::FieldSelector for GoogleCloudVideointelligenceV1P1Beta1LabelDetectionConfig {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleCloudVideointelligenceV1P1Beta1ObjectTrackingConfig {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleCloudVideointelligenceV1P1Beta1SpeechContext {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GoogleCloudVideointelligenceV1P1Beta1SpeechTranscriptionConfig {
        ...
        pub speech_contexts:
            Option<Vec<crate::schemas::GoogleCloudVideointelligenceV1P1Beta1SpeechContext>>,
    }
    impl ::field_selector::FieldSelector
    ...
    impl ::field_selector::FieldSelector for GoogleCloudVideointelligenceV1P1Beta1TextDetectionConfig {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GoogleCloudVideointelligenceV1P1Beta1VideoContext {
        ...
        pub label_detection_config:
            Option<crate::schemas::GoogleCloudVideointelligenceV1P1Beta1LabelDetectionConfig>,
        #[doc = "Config for OBJECT_TRACKING."]
        #[serde(rename = "objectTrackingConfig", default)]
        pub object_tracking_config:
            Option<crate::schemas::GoogleCloudVideointelligenceV1P1Beta1ObjectTrackingConfig>,
        ...
        pub shot_change_detection_config:
            Option<crate::schemas::GoogleCloudVideointelligenceV1P1Beta1ShotChangeDetectionConfig>,
        #[doc = "Config for SPEECH_TRANSCRIPTION."]
        #[serde(rename = "speechTranscriptionConfig", default)]
        pub speech_transcription_config:
            Option<crate::schemas::GoogleCloudVideointelligenceV1P1Beta1SpeechTranscriptionConfig>,
        #[doc = "Config for TEXT_DETECTION."]
        #[serde(rename = "textDetectionConfig", default)]
        pub text_detection_config:
            Option<crate::schemas::GoogleCloudVideointelligenceV1P1Beta1TextDetectionConfig>,
    }
    impl ::field_selector::FieldSelector for GoogleCloudVideointelligenceV1P1Beta1VideoContext {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
