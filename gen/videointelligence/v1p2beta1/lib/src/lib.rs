pub mod schemas {
    ...
    impl GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems {
        pub fn as_str(self) -> &'static str {
            match self { GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems :: FeatureUnspecified => "FEATURE_UNSPECIFIED" , GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems :: LabelDetection => "LABEL_DETECTION" , GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems :: ShotChangeDetection => "SHOT_CHANGE_DETECTION" , GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems :: ExplicitContentDetection => "EXPLICIT_CONTENT_DETECTION" , GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems :: SpeechTranscription => "SPEECH_TRANSCRIPTION" , GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems :: TextDetection => "TEXT_DETECTION" , GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems :: ObjectTracking => "OBJECT_TRACKING" , }
        }
    }
    impl ::std::fmt::Display
        ...
        for GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems
    {
        ...
        {
            let value: &'de str = <&str>::deserialize(deserializer)?;
            Ok ( match value { "FEATURE_UNSPECIFIED" => GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems :: FeatureUnspecified , "LABEL_DETECTION" => GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems :: LabelDetection , "SHOT_CHANGE_DETECTION" => GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems :: ShotChangeDetection , "EXPLICIT_CONTENT_DETECTION" => GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems :: ExplicitContentDetection , "SPEECH_TRANSCRIPTION" => GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems :: SpeechTranscription , "TEXT_DETECTION" => GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems :: TextDetection , "OBJECT_TRACKING" => GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems :: ObjectTracking , _ => return Err ( :: serde :: de :: Error :: custom ( format ! ( "invalid enum for #name: {}" , value ) ) ) , } )
        }
    }
    impl ::field_selector::FieldSelector
        for GoogleCloudVideointelligenceV1P2Beta1AnnotateVideoRequestFeaturesItems
