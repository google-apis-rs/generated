pub mod schemas {
    ...
    impl GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesItems {
        pub fn as_str(self) -> &'static str {
            match self { GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesItems :: FeatureUnspecified => "FEATURE_UNSPECIFIED" , GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesItems :: LabelDetection => "LABEL_DETECTION" , GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesItems :: ShotChangeDetection => "SHOT_CHANGE_DETECTION" , GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesItems :: ExplicitContentDetection => "EXPLICIT_CONTENT_DETECTION" , GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesItems :: SpeechTranscription => "SPEECH_TRANSCRIPTION" , GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesItems :: TextDetection => "TEXT_DETECTION" , GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesItems :: ObjectTracking => "OBJECT_TRACKING" , }
        }
    }
        ...
        for GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesItems
    {
            ...
            D: ::serde::de::Deserializer<'de>,
        {
            ...
            Ok ( match value { "FEATURE_UNSPECIFIED" => GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesItems :: FeatureUnspecified , "LABEL_DETECTION" => GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesItems :: LabelDetection , "SHOT_CHANGE_DETECTION" => GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesItems :: ShotChangeDetection , "EXPLICIT_CONTENT_DETECTION" => GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesItems :: ExplicitContentDetection , "SPEECH_TRANSCRIPTION" => GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesItems :: SpeechTranscription , "TEXT_DETECTION" => GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesItems :: TextDetection , "OBJECT_TRACKING" => GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesItems :: ObjectTracking , _ => return Err ( :: serde :: de :: Error :: custom ( format ! ( "invalid enum for #name: {}" , value ) ) ) , } )
        }
    }
    #[derive(
    ...
    pub struct GoogleCloudVideointelligenceV1AnnotateVideoRequest {
        ...
        #[serde(rename = "videoContext", default)]
        pub video_context: Option<crate::schemas::GoogleCloudVideointelligenceV1VideoContext>,
    }
    impl ::field_selector::FieldSelector for GoogleCloudVideointelligenceV1AnnotateVideoRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionMode {
        pub fn as_str(self) -> &'static str {
            match self { GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionMode :: LabelDetectionModeUnspecified => "LABEL_DETECTION_MODE_UNSPECIFIED" , GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionMode :: ShotMode => "SHOT_MODE" , GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionMode :: FrameMode => "FRAME_MODE" , GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionMode :: ShotAndFrameMode => "SHOT_AND_FRAME_MODE" , }
        }
    }
        ...
        for GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionMode
    {
        ...
        {
            let value: &'de str = <&str>::deserialize(deserializer)?;
            Ok ( match value { "LABEL_DETECTION_MODE_UNSPECIFIED" => GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionMode :: LabelDetectionModeUnspecified , "SHOT_MODE" => GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionMode :: ShotMode , "FRAME_MODE" => GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionMode :: FrameMode , "SHOT_AND_FRAME_MODE" => GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionMode :: ShotAndFrameMode , _ => return Err ( :: serde :: de :: Error :: custom ( format ! ( "invalid enum for #name: {}" , value ) ) ) , } )
        }
    }
    #[derive(
        Debug, Clone, PartialEq, PartialOrd, Default, :: serde :: Deserialize, :: serde :: Serialize,
    ...
    pub struct GoogleCloudVideointelligenceV1LabelDetectionConfig {
        ...
        #[serde(rename = "frameConfidenceThreshold", default)]
        pub frame_confidence_threshold: Option<f32>,
        #[doc = "What labels should be detected with LABEL_DETECTION, in addition to\nvideo-level labels or segment-level labels.\nIf unspecified, defaults to `SHOT_MODE`."]
        #[serde(rename = "labelDetectionMode", default)]
        pub label_detection_mode: Option<
            crate::schemas::GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionMode,
        >,
        #[doc = "Model to use for label detection.\nSupported values: \"builtin/stable\" (the default if unset) and\n\"builtin/latest\"."]
        #[serde(rename = "model", default)]
        pub model: Option<String>,
        #[doc = "Whether the video has been shot from a stationary (i.e. non-moving) camera.\nWhen set to true, might improve detection accuracy for moving objects.\nShould be used with `SHOT_AND_FRAME_MODE` enabled."]
        #[serde(rename = "stationaryCamera", default)]
        pub stationary_camera: Option<bool>,
        #[doc = "The confidence threshold we perform filtering on the labels from\nvideo-level and shot-level detections. If not set, it is set to 0.3 by\ndefault. The valid range for this threshold is [0.1, 0.9]. Any value set\noutside of this range will be clipped.\nNote: for best results please follow the default threshold. We will update\nthe default threshold everytime when we release a new model."]
        #[serde(rename = "videoConfidenceThreshold", default)]
        pub video_confidence_threshold: Option<f32>,
    }
    impl ::field_selector::FieldSelector for GoogleCloudVideointelligenceV1LabelDetectionConfig {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleCloudVideointelligenceV1ObjectTrackingConfig {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleCloudVideointelligenceV1ShotChangeDetectionConfig {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleCloudVideointelligenceV1SpeechContext {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GoogleCloudVideointelligenceV1SpeechTranscriptionConfig {
        ...
        pub speech_contexts:
            Option<Vec<crate::schemas::GoogleCloudVideointelligenceV1SpeechContext>>,
    }
    impl ::field_selector::FieldSelector for GoogleCloudVideointelligenceV1SpeechTranscriptionConfig {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleCloudVideointelligenceV1TextDetectionConfig {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub mod operations {
        ...
        pub mod projects {
            ...
            impl<'a, A: yup_oauth2::GetToken> ProjectsActions<'a, A> {
                ...
                pub fn locations(
                    &self,
                ) -> crate::resources::operations::projects::locations::LocationsActions<A>
                {
            ...
            pub mod locations {
                ...
                impl<'a, A: yup_oauth2::GetToken> LocationsActions<'a, A> {
                    #[doc = "Actions that can be performed on the operations resource"]pub fn operations ( & self ) -> crate :: resources :: operations :: projects :: locations :: operations :: OperationsActions < A >{
                        crate :: resources :: operations :: projects :: locations :: operations :: OperationsActions { reqwest : & self . reqwest , auth : & self . auth }
                    }
                }
                pub mod operations {
                    pub mod params {}
