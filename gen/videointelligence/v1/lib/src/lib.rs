    ...
    pub mod projects {
        ...
        pub mod locations {
            ...
            impl<'a> LocationsActions<'a> {
                ...
                #[doc = "Actions that can be performed on the corpura resource"]
                pub fn corpura(
                    &self,
                ) -> crate::resources::projects::locations::corpura::CorpuraActions
                {
                    crate::resources::projects::locations::corpura::CorpuraActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
            ...
            pub mod corpura {
                pub mod params {}
                pub struct CorpuraActions<'a> {
                    pub(crate) reqwest: &'a reqwest::blocking::Client,
                    pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
                }
                impl<'a> CorpuraActions<'a> {
                    fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                        self.auth
                    }
                    #[doc = "Actions that can be performed on the operations resource"]
                    pub fn operations(
                        &self,
                    ) -> crate::resources::projects::locations::corpura::operations::OperationsActions
                    {
                        crate :: resources :: projects :: locations :: corpura :: operations :: OperationsActions { reqwest : & self . reqwest , auth : self . auth_ref ( ) , }
                    }
                }
                pub mod operations {
                    pub mod params {}
