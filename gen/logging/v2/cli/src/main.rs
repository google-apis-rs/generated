...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        ...
        let mut billing_accounts0 = SubCommand::with_name("billing_accounts")
            ...
            .about("sub-resources: exclusions, logs and sinks");
        ...
        {
            let mcmd = SubCommand::with_name("delete").about("Deletes all the log entries in a log. The log reappears if it receives new entries. Log entries written shortly before the delete operation might not be deleted.");
        ...
        let mut projects0 = SubCommand::with_name("projects")
            .setting(AppSettings::ColoredHelp)
            .about("sub-resources: exclusions, logs, metrics and sinks");
