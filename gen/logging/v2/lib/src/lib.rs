pub mod schemas {
    ...
    pub struct ListExclusionsResponse {
        ...
        pub exclusions: Option<Vec<crate::schemas::LogExclusion>>,
    ...
    pub struct ListLogEntriesResponse {
        ...
        pub entries: Option<Vec<crate::schemas::LogEntry>>,
    ...
    pub struct ListLogMetricsResponse {
        ...
        pub metrics: Option<Vec<crate::schemas::LogMetric>>,
    ...
    pub struct ListSinksResponse {
        ...
        pub sinks: Option<Vec<crate::schemas::LogSink>>,
    }
    ...
    pub struct LogEntry {
        ...
        pub json_payload: Option<::std::collections::BTreeMap<String, ::serde_json::Value>>,
    ...
    pub struct LogLine {
        ...
        #[serde(rename = "severity", default)]
        pub severity: Option<crate::schemas::LogLineSeverity>,
        #[doc = "Where in the source code this log message was written."]
        #[serde(rename = "sourceLocation", default)]
        pub source_location: Option<crate::schemas::SourceLocation>,
    ...
    pub struct LogMetric {
        ...
        pub label_extractors: Option<::std::collections::BTreeMap<String, String>>,
        ...
        pub metric_descriptor: Option<crate::schemas::MetricDescriptor>,
        ...
        pub version: Option<crate::schemas::LogMetricVersion>,
    }
    ...
    pub struct RequestLog {
        ...
        pub source_reference: Option<Vec<crate::schemas::SourceReference>>,
...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn billing_accounts(&self) -> crate::billing_accounts::BillingAccountsActions<A> {
        crate::billing_accounts::BillingAccountsActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    #[doc = "Actions that can be performed on the entries resource"]
    pub fn entries(&self) -> crate::entries::EntriesActions<A> {
        crate::entries::EntriesActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    #[doc = "Actions that can be performed on the exclusions resource"]
    pub fn exclusions(&self) -> crate::exclusions::ExclusionsActions<A> {
        crate::exclusions::ExclusionsActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    ...
    pub fn logs(&self) -> crate::logs::LogsActions<A> {
        crate::logs::LogsActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    ...
    pub fn monitored_resource_descriptors(
        &self,
    ) -> crate::monitored_resource_descriptors::MonitoredResourceDescriptorsActions<A> {
        crate::monitored_resource_descriptors::MonitoredResourceDescriptorsActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    ...
    pub fn sinks(&self) -> crate::sinks::SinksActions<A> {
        crate::sinks::SinksActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
...
pub mod billing_accounts {
    ...
    impl<'a, A: yup_oauth2::GetToken> BillingAccountsActions<'a, A> {
        #[doc = "Actions that can be performed on the exclusions resource"]
        pub fn exclusions(&self) -> exclusions::ExclusionsActions<A> {
            exclusions::ExclusionsActions
        }
        #[doc = "Actions that can be performed on the logs resource"]
        pub fn logs(&self) -> logs::LogsActions<A> {
            logs::LogsActions
        }
        #[doc = "Actions that can be performed on the sinks resource"]
        pub fn sinks(&self) -> sinks::SinksActions<A> {
            sinks::SinksActions
        }
    }
    pub mod exclusions {
    ...
    pub mod sinks {
        ...
        impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
            ...
            pub fn unique_writer_identity(&mut self, value: bool) -> &mut Self {
        ...
        impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://logging.googleapis.com/".to_owned();
                output.push_str("v2/");
                output.push_str(&self.sink_name);
                output
            }
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                let req = self.reqwest.request(::reqwest::Method::DELETE, path);
...
pub mod projects {
    ...
    impl<'a, A: yup_oauth2::GetToken> ProjectsActions<'a, A> {
        ...
        pub fn metrics(&self) -> metrics::MetricsActions<A> {
