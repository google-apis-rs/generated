...
pub mod users {
    ...
    impl<'a, A: yup_oauth2::GetToken> UsersActions<'a, A> {
        ...
        pub fn settings(&self) -> settings::SettingsActions<A> {
            settings::SettingsActions
        }
        #[doc = "Actions that can be performed on the threads resource"]
        pub fn threads(&self) -> threads::ThreadsActions<A> {
    ...
    impl<'a, A: yup_oauth2::GetToken> GetProfileRequestBuilder<'a, A> {
        ...
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            ...
            let req = req.bearer_auth(
                auth.token::<_, &str>(&["https://www.googleapis.com/auth/gmail.readonly"])
                    .unwrap()
                    .access_token,
            );
            req
    ...
    pub mod drafts {
        ...
        pub struct GetRequestBuilder<'a, A> {
            ...
            user_id: String,
            id: String,
            format: Option<crate::drafts::params::GetFormat>,
            alt: Option<crate::params::Alt>,
            fields: Option<String>,
            key: Option<String>,
            oauth_token: Option<String>,
        ...
        impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
            ...
            pub fn format(&mut self, value: crate::drafts::params::GetFormat) -> &mut Self {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn include_spam_trash(&mut self, value: bool) -> &mut Self {
    ...
    pub mod history {
        pub mod params {
            #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
            pub enum ListHistoryTypes {
                LabelAdded,
                LabelRemoved,
                MessageAdded,
                MessageDeleted,
            }
            impl ListHistoryTypes {
                pub fn as_str(self) -> &'static str {
                    match self {
                        ListHistoryTypes::LabelAdded => "labelAdded",
                        ListHistoryTypes::LabelRemoved => "labelRemoved",
                        ListHistoryTypes::MessageAdded => "messageAdded",
                        ListHistoryTypes::MessageDeleted => "messageDeleted",
                    }
                }
            }
            impl ::std::fmt::Display for ListHistoryTypes {
                fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                    f.write_str(self.as_str())
                }
            }
            impl ::serde::Serialize for ListHistoryTypes {
                fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
                where
                    S: ::serde::ser::Serializer,
                {
            ...
            impl<'de> ::serde::Deserialize<'de> for ListHistoryTypes {
                fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
                where
                    D: ::serde::de::Deserializer<'de>,
                {
                    let value: &'de str = <&str>::deserialize(deserializer)?;
                    Ok(match value {
                        "labelAdded" => ListHistoryTypes::LabelAdded,
                        "labelRemoved" => ListHistoryTypes::LabelRemoved,
                        "messageAdded" => ListHistoryTypes::MessageAdded,
                        "messageDeleted" => ListHistoryTypes::MessageDeleted,
                        _ => {
                            return Err(::serde::de::Error::custom(format!(
                                "invalid enum for #name: {}",
                                value
        ...
        pub struct ListRequestBuilder<'a, A> {
            ...
            pub(crate) auth: &'a ::std::sync::Mutex<A>,
            user_id: String,
            history_types: Option<crate::history::params::ListHistoryTypes>,
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn history_types(
                &mut self,
                value: crate::history::params::ListHistoryTypes,
            ) -> &mut Self {
                self.history_types = Some(value);
                self
            }
            #[doc = "Only return messages with a label matching the ID."]
            pub fn label_id(&mut self, value: impl Into<String>) -> &mut Self {
            ...
            pub fn start_history_id(&mut self, value: u64) -> &mut Self {
    ...
    pub mod messages {
        ...
        pub struct GetRequestBuilder<'a, A> {
            ...
            user_id: String,
            id: String,
            format: Option<crate::messages::params::GetFormat>,
        ...
        impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
            ...
            pub fn format(&mut self, value: crate::messages::params::GetFormat) -> &mut Self {
                self.format = Some(value);
                self
            }
            #[doc = "When given and format is METADATA, only include headers specified."]
            pub fn metadata_headers(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        pub struct ImportRequestBuilder<'a, A> {
            ...
            user_id: String,
            deleted: Option<bool>,
            internal_date_source: Option<crate::messages::params::ImportInternalDateSource>,
        ...
        impl<'a, A: yup_oauth2::GetToken> ImportRequestBuilder<'a, A> {
            ...
            pub fn internal_date_source(
                &mut self,
                value: crate::messages::params::ImportInternalDateSource,
            ) -> &mut Self {
            ...
            pub fn never_mark_spam(&mut self, value: bool) -> &mut Self {
            ...
            pub fn process_for_calendar(&mut self, value: bool) -> &mut Self {
        ...
        pub struct InsertRequestBuilder<'a, A> {
            ...
            user_id: String,
            deleted: Option<bool>,
            internal_date_source: Option<crate::messages::params::InsertInternalDateSource>,
            alt: Option<crate::params::Alt>,
            fields: Option<String>,
            key: Option<String>,
            oauth_token: Option<String>,
        ...
        impl<'a, A: yup_oauth2::GetToken> InsertRequestBuilder<'a, A> {
            ...
            pub fn internal_date_source(
                &mut self,
                value: crate::messages::params::InsertInternalDateSource,
            ) -> &mut Self {
                self.internal_date_source = Some(value);
                self
            }
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn label_ids(&mut self, value: impl Into<String>) -> &mut Self {
            ...
            #[doc = "Only return messages matching the specified query. Supports the same query format as the Gmail search box. For example, \"from:someuser@example.com rfc822msgid:<somemsgid@example.com> is:unread\". Parameter cannot be used when accessing the api using the gmail.metadata scope."]
            pub fn q(&mut self, value: impl Into<String>) -> &mut Self {
                self.q = Some(value.into());
                self
            }
        ...
        pub mod attachments {
            ...
            impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
                ...
                fn _path(&self) -> String {
                    ...
                    output.push_str(&self.user_id);
                    output.push_str("/messages/");
                    output.push_str(&self.message_id);
    ...
    pub mod settings {
        ...
        impl<'a, A: yup_oauth2::GetToken> SettingsActions<'a, A> {
            ...
            pub fn get_language(&self, user_id: impl Into<String>) -> GetLanguageRequestBuilder<A> {
            ...
            pub fn get_vacation(&self, user_id: impl Into<String>) -> GetVacationRequestBuilder<A> {
            ...
            pub fn delegates(&self) -> delegates::DelegatesActions<A> {
            ...
            #[doc = "Actions that can be performed on the forwarding_addresses resource"]
            pub fn forwarding_addresses(
                &self,
            ) -> forwarding_addresses::ForwardingAddressesActions<A> {
                forwarding_addresses::ForwardingAddressesActions
            }
            #[doc = "Actions that can be performed on the send_as resource"]
            pub fn send_as(&self) -> send_as::SendAsActions<A> {
                send_as::SendAsActions
            }
        }
        #[derive(Debug, Clone)]
        ...
        pub mod delegates {
            ...
            impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
                ...
                fn _path(&self) -> String {
                    ...
                    output.push_str(&self.user_id);
                    output.push_str("/settings/delegates/");
                    output.push_str(&self.delegate_email);
                    output
                }
                fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                    let req = self.reqwest.request(::reqwest::Method::DELETE, path);
        ...
        pub mod forwarding_addresses {
            ...
            impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
                ...
                fn _path(&self) -> String {
                    ...
                    output.push_str(&self.user_id);
                    output.push_str("/settings/forwardingAddresses/");
                    output.push_str(&self.forwarding_email);
                    output
                }
                fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                    let req = self.reqwest.request(::reqwest::Method::DELETE, path);
        ...
        pub mod send_as {
            ...
            impl<'a, A: yup_oauth2::GetToken> SendAsActions<'a, A> {
                ...
                pub fn smime_info(&self) -> smime_info::SmimeInfoActions<A> {
                    smime_info::SmimeInfoActions
                }
            }
            #[derive(Debug, Clone)]
            pub struct CreateRequestBuilder<'a, A> {
            ...
            impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
                ...
                fn _path(&self) -> String {
                    ...
                    output.push_str(&self.user_id);
                    output.push_str("/settings/sendAs/");
                    output.push_str(&self.send_as_email);
                    output
                }
                fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                    let req = self.reqwest.request(::reqwest::Method::DELETE, path);
            ...
            pub mod smime_info {
                ...
                impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                    ...
                    pub fn execute_debug(
                        self,
                    ) -> Result<crate::schemas::ListSmimeInfoResponse, Box<dyn ::std::error::Error>>
                    {
                        self.execute()
                    }
                    fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
    ...
    pub mod threads {
        ...
        pub struct GetRequestBuilder<'a, A> {
            ...
            user_id: String,
            id: String,
            format: Option<crate::threads::params::GetFormat>,
            metadata_headers: Option<String>,
            alt: Option<crate::params::Alt>,
            fields: Option<String>,
            key: Option<String>,
        ...
        impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
            ...
            pub fn format(&mut self, value: crate::threads::params::GetFormat) -> &mut Self {
                self.format = Some(value);
                self
            }
            #[doc = "When given and format is METADATA, only include headers specified."]
