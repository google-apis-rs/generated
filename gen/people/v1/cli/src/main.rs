...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        ...
        {
            let mcmd = SubCommand::with_name("batch_create_contacts").about("Create a batch of new contacts and return the PersonResponses for the newly created contacts.");
            people0 = people0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("batch_delete_contacts")
                .about("Delete a batch of contacts. Any non-contact data will not be deleted.");
            people0 = people0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("batch_update_contacts").about("Update a batch of contacts and return a map of resource names to PersonResponses for the updated contacts.");
            people0 = people0.subcommand(mcmd);
        }
        {
