...
pub mod schemas {
    ...
    pub struct SasPortalBulkCreateDeviceRequest {
        #[doc = "Required. A csv with each row representing a [device]. Each row must\nconform to the regulations described on CreateDeviceRequest's device field."]
        #[serde(
            rename = "csv",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        pub csv: ::std::option::Option<String>,
    }
    impl ::google_field_selector::FieldSelector for SasPortalBulkCreateDeviceRequest {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SasPortalBulkCreateDeviceRequest {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct SasPortalBulkCreateDeviceResponse {
        #[doc = "Required. The devices that were imported."]
        #[serde(
            rename = "devices",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    impl ::google_field_selector::FieldSelector for SasPortalBulkCreateDeviceResponse {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for SasPortalBulkCreateDeviceResponse {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
    ...
    pub struct SasPortalCreateSignedDeviceRequest {
        ...
        #[doc = "Required. Unique installer id (cpiId) from the Certified Professional\nInstallers database."]
        #[serde(
            rename = "installerId",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct SasPortalDevice {
        ...
        #[doc = "Device parameters that can be overridden by both SAS Portal and SAS\nregistration requests."]
        #[serde(
        ...
        #[doc = "A serial number assigned to the device by the device\nmanufacturer."]
        #[serde(
            rename = "serialNumber",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub enum SasPortalDeviceState {
        ...
        Registered,
        #[doc = "Device created in the SAS Portal, however, not yet registered\nwith SAS."]
        Reserved,
    }
    ...
    pub struct SasPortalDeviceAirInterface {
        #[doc = "This field specifies the radio access technology that is used for the CBSD.\n\nConditional"]
        #[serde(
        ...
        #[doc = "This field is related to the radioTechnology field and provides the air\ninterface specification that the CBSD is compliant with at the time of\nregistration.\n\nOptional"]
        #[serde(
    ...
    pub struct SasPortalGenerateSecretResponse {
        #[doc = "The secret generated by the string and used by\n[ValidateInstaller] method."]
        #[serde(
            rename = "secret",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct SasPortalInstallationParams {
        ...
        #[doc = "Peak antenna gain in dBi. This parameter is an integer with a\nvalue between -127 and +128 (dBi) inclusive."]
        #[serde(
            rename = "antennaGain",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "If an external antenna is used, the antenna model is optionally\nprovided in this field. The string has a maximum length of 128\noctets."]
        #[serde(
            rename = "antennaModel",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Whether the device antenna is indoor or not. True: indoor. False:\noutdoor."]
        #[serde(
    ...
    pub struct SasPortalListCustomersResponse {
        #[doc = "The list of customers that\nmatch the request."]
        #[serde(
            rename = "customers",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct SasPortalMoveDeviceRequest {
        #[doc = "Required. The name of the new parent resource (Node or Customer) to\nreparent the device under."]
        #[serde(
            rename = "destination",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct SasPortalSetPolicyRequest {
        ...
        #[doc = "Required. The resource for which the policy is being specified. This policy\nreplaces any existing policy."]
        #[serde(
            rename = "resource",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct SasPortalUpdateSignedDeviceRequest {
        #[doc = "Required. The JSON Web Token signed using a CPI private key. Payload\nmust be the JSON encoding\nof the device. The user_id field must be set."]
        #[serde(
            rename = "encodedDevice",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub encoded_device: ::std::option::Option<::google_api_bytes::Bytes>,
        #[doc = "Required. Unique installer ID (CPI ID) from the Certified Professional\nInstallers database."]
        #[serde(
            rename = "installerId",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct SasPortalValidateInstallerRequest {
        ...
        #[doc = "Required. Unique installer id (cpiId) from the Certified\nProfessional Installers database."]
        #[serde(
            rename = "installerId",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub installer_id: ::std::option::Option<String>,
        #[doc = "Required. Secret returned by the GenerateSecret method."]
        #[serde(
            rename = "secret",
            default,
            skip_serializing_if = "std::option::Option::is_none"
...
pub mod resources {
    pub mod customers {
        ...
        impl<'a> ListRequestBuilder<'a> {
            #[doc = "The maximum number of customers\nto return in the response."]
            pub fn page_size(mut self, value: i32) -> Self {
                self.page_size = Some(value);
                self
            }
            #[doc = "A pagination token returned from a previous call to ListCustomers method that indicates where\nthis listing should continue from."]
        ...
        pub mod devices {
            ...
            impl<'a> DevicesActions<'a> {
                ...
                #[doc = "Creates a device under a node or customer. Returned devices are unordered."]
                pub fn bulk(
                    &self,
                    request: crate::schemas::SasPortalBulkCreateDeviceRequest,
                ...
                #[doc = "Creates a signed device under a\nnode or customer."]
            ...
            #[doc = "Created via [DevicesActions::bulk()](struct.DevicesActions.html#method.bulk)"]
            #[derive(Debug, Clone)]
            ...
            impl<'a> BulkRequestBuilder<'a> {
                ...
                pub fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::SasPortalBulkCreateDeviceResponse, crate::Error>
                {
                    self.execute_with_fields(None::<&str>)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
        ...
        pub mod nodes {
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                #[doc = "A pagination token returned from a previous call to ListNodes method\nthat indicates where this listing should continue from."]
                pub fn page_token(mut self, value: impl Into<String>) -> Self {
                    self.page_token = Some(value.into());
                    self
                }
    ...
    pub mod installer {
        ...
        impl<'a> InstallerActions<'a> {
            ...
            #[doc = "Generates a secret to be used with the ValidateInstaller method"]
