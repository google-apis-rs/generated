pub mod schemas {
    ...
    pub struct Account {
        ...
        pub sub_accounts: Option<Vec<crate::schemas::Account>>,
    ...
    pub struct AdUnit {
        ...
        pub feed_ads_settings: Option<crate::schemas::AdUnitFeedAdsSettings>,
    ...
    pub struct AdsenseReportsGenerateResponse {
        ...
        pub headers: Option<Vec<crate::schemas::AdsenseReportsGenerateResponseHeadersItems>>,
    ...
    pub struct Alerts {
        ...
        #[serde(rename = "items", default)]
        pub items: Option<Vec<crate::schemas::Alert>>,
    ...
    pub struct CustomChannel {
        ...
        pub targeting_info: Option<crate::schemas::CustomChannelTargetingInfo>,
    }
    ...
    pub struct Metadata {
        #[serde(rename = "items", default)]
        pub items: Option<Vec<crate::schemas::ReportingMetadataEntry>>,
    ...
    pub struct Payments {
        ...
        #[serde(rename = "items", default)]
        pub items: Option<Vec<crate::schemas::Payment>>,
    ...
    pub struct SavedAdStyle {
        ...
        pub ad_style: Option<crate::schemas::AdStyle>,
    ...
    pub struct SavedAdStyles {
        ...
        #[serde(rename = "items", default)]
        pub items: Option<Vec<crate::schemas::SavedAdStyle>>,
    ...
    pub struct SavedReports {
        ...
        #[serde(rename = "items", default)]
        pub items: Option<Vec<crate::schemas::SavedReport>>,
...
mod resources {
    pub mod accounts {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            #[doc = r" the server."]
            pub fn iter_items_standard(mut self) -> ListItemsIter<'a, A, crate::schemas::Account> {
            ...
            #[doc = r" resources."]
            pub fn iter_items_debug(mut self) -> ListItemsIter<'a, A, crate::schemas::Account> {
                self.fields = Some(concat!("nextPageToken,", "items", "(*)").to_owned());
                ListItemsIter {
                    method: self,
                    last_page_reached: false,
        ...
        pub mod reports {
            ...
            pub mod saved {
                ...
                impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                    ...
                    pub fn iter_items_standard(
                        mut self,
                    ) -> ListItemsIter<'a, A, crate::schemas::SavedReport> {
                        self.fields = Some(concat!("nextPageToken,", "items").to_owned());
                        ListItemsIter {
                            method: self,
                            last_page_reached: false,
        ...
        pub mod savedadstyles {
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                pub fn iter_items_standard(
                    mut self,
                ) -> ListItemsIter<'a, A, crate::schemas::SavedAdStyle> {
                    self.fields = Some(concat!("nextPageToken,", "items").to_owned());
                    ListItemsIter {
                        method: self,
                        last_page_reached: false,
    ...
    pub mod adunits {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            #[doc = r" fields in `#items_type` will be the default fields populated by"]
            #[doc = r" the server."]
            pub fn iter_items_standard(mut self) -> ListItemsIter<'a, A, crate::schemas::AdUnit> {
                self.fields = Some(concat!("nextPageToken,", "items").to_owned());
                ListItemsIter {
                    method: self,
                    last_page_reached: false,
