...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        let mut app = App::new("dfareporting3d2")
        ...
        let mut directory_site_contacts0 = SubCommand::with_name("directory_site_contacts")
            .setting(AppSettings::ColoredHelp)
            .about("methods: get and list");
        {
            let mcmd = SubCommand::with_name("get").about("Gets one directory site contact by ID.");
            directory_site_contacts0 = directory_site_contacts0.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("list").about("Retrieves a list of directory site contacts, possibly filtered. This method supports paging.");
            directory_site_contacts0 = directory_site_contacts0.subcommand(mcmd);
        }
        ...
        app = app.subcommand(directory_site_contacts0);
...
use google_dfareporting3d2 as api;
