...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        ...
        let mut custom_events0 = SubCommand::with_name("custom_events")
            .setting(AppSettings::ColoredHelp)
            .about("methods: batchinsert");
        {
            let mcmd = SubCommand::with_name("batchinsert").about("Inserts custom events.");
            custom_events0 = custom_events0.subcommand(mcmd);
        }
        ...
        let mut reports0 = SubCommand::with_name("reports")
            .setting(AppSettings::ColoredHelp)
            .about("methods: delete, get, insert, list, run and update");
        {
        ...
        app = app.subcommand(custom_events0);
...
use google_dfareporting3d4 as api;
