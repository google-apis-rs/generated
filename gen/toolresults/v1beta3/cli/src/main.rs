...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        let mut app = App::new("toolresults1_beta3")
            ...
            .about("Reads and publishes results from Firebase Test Lab.")
        ...
        let mut steps3 = SubCommand::with_name("steps")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: create, get, get_perf_metrics_summary, list, patch and publish_xunit_xml_files");
        {
        ...
        {
            let mcmd = SubCommand::with_name("create").about("Creates a PerfMetricsSummary resource. Returns the existing one if it has already been created.\n\nMay return any of the following error code(s): - NOT_FOUND - The containing Step does not exist");
