...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn license_assignments(
        &self,
    ) -> crate::resources::license_assignments::LicenseAssignmentsActions<A> {
...
mod resources {
    pub mod license_assignments {
        pub mod params {}
        pub struct LicenseAssignmentsActions<'a, A> {
            pub(crate) reqwest: &'a reqwest::Client,
            pub(crate) auth: &'a std::sync::Mutex<A>,
        }
        impl<'a, A: yup_oauth2::GetToken> LicenseAssignmentsActions<'a, A> {
            #[doc = "Revoke License."]
            pub fn delete(
                &self,
            ...
            ) -> ListForProductRequestBuilder<A> {
            ...
            pub fn list_for_product_and_sku(
                ...
                sku_id: impl Into<String>,
                customer_id: impl Into<String>,
            ) -> ListForProductAndSkuRequestBuilder<A> {
        ...
        impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://www.googleapis.com/apps/licensing/v1/product/".to_owned();
                {
            ...
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                ...
                let fut = auth.token(vec!["https://www.googleapis.com/auth/apps.licensing"]);
        ...
        impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
            ...
            pub fn execute_standard(
                self,
            ) -> Result<crate::schemas::LicenseAssignment, Box<dyn ::std::error::Error>>
            {
        ...
        #[derive(Debug, Clone)]
        pub struct ListForProductRequestBuilder<'a, A> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a ::std::sync::Mutex<A>,
            product_id: String,
            customer_id: String,
        ...
        impl<'a, A: yup_oauth2::GetToken> ListForProductRequestBuilder<'a, A> {
            ...
            pub fn iter_items<T>(self) -> ListForProductItemsIter<'a, A, T>
            where
                T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
            {
                ListForProductItemsIter {
                    method: self,
            ...
            pub fn iter_items_standard(
                mut self,
            ) -> ListForProductItemsIter<'a, A, crate::schemas::LicenseAssignment> {
            ...
            pub fn execute_standard(
                self,
            ) -> Result<crate::schemas::LicenseAssignmentList, Box<dyn ::std::error::Error>>
            {
                self.execute_fields::<_, &str>(None)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
        ...
        pub struct ListForProductItemsIter<'a, A, T> {
            method: ListForProductRequestBuilder<'a, A>,
            last_page_reached: bool,
            items_iter: Option<::std::vec::IntoIter<T>>,
        }
        impl<'a, A, T> Iterator for ListForProductItemsIter<'a, A, T>
        where
        ...
        impl<'a, A: yup_oauth2::GetToken> crate::IterableMethod for ListForProductRequestBuilder<'a, A> {
        ...
        #[derive(Debug, Clone)]
        pub struct ListForProductAndSkuRequestBuilder<'a, A> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a ::std::sync::Mutex<A>,
            product_id: String,
            sku_id: String,
        ...
        impl<'a, A: yup_oauth2::GetToken> ListForProductAndSkuRequestBuilder<'a, A> {
            #[doc = "Maximum number of campaigns to return at one time. Must be positive. Optional. Default value is 100."]
            pub fn max_results(mut self, value: u32) -> Self {
                self.max_results = Some(value);
                self
            ...
            #[doc = r" populated fields in the yielded items will be determined by the"]
            #[doc = r" `FieldSelector` implementation."]
            pub fn iter_items<T>(self) -> ListForProductAndSkuItemsIter<'a, A, T>
            where
                T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
            {
                ListForProductAndSkuItemsIter {
                    method: self,
                    last_page_reached: false,
                    items_iter: None,
                }
            ...
            pub fn iter_items_standard(
                mut self,
            ) -> ListForProductAndSkuItemsIter<'a, A, crate::schemas::LicenseAssignment>
            {
                self.fields = Some(concat!("nextPageToken,", "items").to_owned());
                ListForProductAndSkuItemsIter {
                    method: self,
        ...
        pub struct ListForProductAndSkuItemsIter<'a, A, T> {
            method: ListForProductAndSkuRequestBuilder<'a, A>,
            last_page_reached: bool,
            items_iter: Option<::std::vec::IntoIter<T>>,
        }
        impl<'a, A, T> Iterator for ListForProductAndSkuItemsIter<'a, A, T>
        where
            A: ::yup_oauth2::GetToken,
            T: ::serde::de::DeserializeOwned,
        {
        ...
        impl<'a, A: yup_oauth2::GetToken> crate::IterableMethod
            for ListForProductAndSkuRequestBuilder<'a, A>
        {
            fn set_page_token(&mut self, value: String) {
                self.page_token = value.into();
            }
