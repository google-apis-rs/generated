    ...
    pub mod license_assignments {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListForProductRequestBuilder<'a, A> {
            ...
            pub fn iter_items_standard(
                mut self,
            ) -> crate::iter::PageItemIter<Self, crate::schemas::LicenseAssignment> {
            ...
            pub fn iter_standard(
                self,
            ) -> crate::iter::PageIter<Self, crate::schemas::LicenseAssignmentList> {
                crate::iter::PageIter::new(self)
            }
            pub fn iter_debug(
                mut self,
        ...
        impl<'a, A: yup_oauth2::GetToken> crate::iter::IterableMethod
            for ListForProductRequestBuilder<'a, A>
        {
