...
pub mod resources {
    pub mod text {
        ...
        impl<'a, A: ::google_api_auth::GetAccessToken> TextActions<'a, A> {
        ...
        impl<'a, A: ::google_api_auth::GetAccessToken> SynthesizeRequestBuilder<'a, A> {
    ...
    pub mod voices {
        ...
        impl<'a, A: ::google_api_auth::GetAccessToken> VoicesActions<'a, A> {
