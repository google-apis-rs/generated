...
pub mod schemas {
    ...
    impl ::std::str::FromStr for ClusterStatus {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<ClusterStatus, ()> {
            Ok(match s {
    ...
    pub struct ClusterUpdate {
        ...
        #[serde(
            rename = "desiredIntraNodeVisibilityConfig",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
        ...
        #[serde(
            rename = "desiredResourceUsageExportConfig",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
    ...
    impl ::std::convert::AsRef<str> for NetworkPolicyProvider {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for NetworkPolicyProvider {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<NetworkPolicyProvider, ()> {
            Ok(match s {
    ...
    impl ::std::convert::AsRef<str> for NodePoolStatus {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for NodePoolStatus {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<NodePoolStatus, ()> {
            Ok(match s {
    ...
    impl ::std::convert::AsRef<str> for NodeTaintEffect {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for NodeTaintEffect {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<NodeTaintEffect, ()> {
            Ok(match s {
    ...
    pub struct ResourceUsageExportConfig {
        ...
        #[serde(
            rename = "consumptionMeteringConfig",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        )]
    ...
    impl ::std::convert::AsRef<str> for SetMasterAuthRequestAction {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for SetMasterAuthRequestAction {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<SetMasterAuthRequestAction, ()> {
            Ok(match s {
    ...
    impl ::std::convert::AsRef<str> for StatusConditionCode {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for StatusConditionCode {
        type Err = ();
    ...
    impl ::std::convert::AsRef<str> for UsableSubnetworkSecondaryRangeStatus {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for UsableSubnetworkSecondaryRangeStatus {
        type Err = ();
        fn from_str(s: &str) -> ::std::result::Result<UsableSubnetworkSecondaryRangeStatus, ()> {
            Ok(match s {
