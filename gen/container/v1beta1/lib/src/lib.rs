...
pub mod projects {
    ...
    impl<'a, A: yup_oauth2::GetToken> ProjectsActions<'a, A> {
        ...
        pub fn aggregated(&self) -> aggregated::AggregatedActions<A> {
            aggregated::AggregatedActions
        }
    ...
    pub mod aggregated {
        ...
        impl<'a, A: yup_oauth2::GetToken> AggregatedActions<'a, A> {
            #[doc = "Actions that can be performed on the usable_subnetworks resource"]
            pub fn usable_subnetworks(&self) -> usable_subnetworks::UsableSubnetworksActions<A> {
                usable_subnetworks::UsableSubnetworksActions
            }
        }
    ...
    pub mod locations {
        ...
        impl<'a, A: yup_oauth2::GetToken> LocationsActions<'a, A> {
            ...
            pub fn clusters(&self) -> clusters::ClustersActions<A> {
        ...
        impl<'a, A: yup_oauth2::GetToken> GetServerConfigRequestBuilder<'a, A> {
            ...
            pub fn zone(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        pub mod clusters {
            ...
            impl<'a, A: yup_oauth2::GetToken> ClustersActions<'a, A> {
                ...
                pub fn node_pools(&self) -> node_pools::NodePoolsActions<A> {
                    node_pools::NodePoolsActions
                }
                #[doc = "Actions that can be performed on the well_known resource"]
                pub fn well_known(&self) -> well_known::WellKnownActions<A> {
                    well_known::WellKnownActions
                }
            }
            #[derive(Debug, Clone)]
            ...
            impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
                ...
                pub fn cluster_id(&mut self, value: impl Into<String>) -> &mut Self {
            ...
            pub mod node_pools {
                ...
                impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
                    ...
                    pub fn node_pool_id(&mut self, value: impl Into<String>) -> &mut Self {
                ...
                impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                    ...
                    pub fn execute_debug(
                        self,
                    ) -> Result<crate::schemas::ListNodePoolsResponse, Box<dyn ::std::error::Error>>
                    {
                        self.execute()
                    }
                    fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
            ...
            pub mod well_known {
                ...
                impl<'a, A: yup_oauth2::GetToken> GetOpenidConfigurationRequestBuilder<'a, A> {
                    ...
                    pub fn execute_debug(
                        self,
                    ) -> Result<crate::schemas::GetOpenIDConfigResponse, Box<dyn ::std::error::Error>>
                    {
                        self.execute()
                    }
                    fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        ...
        pub mod operations {
            ...
            impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
                #[doc = "Deprecated. The server-assigned `name` of the operation.\nThis field has been deprecated and replaced by the name field."]
                pub fn operation_id(&mut self, value: impl Into<String>) -> &mut Self {
    ...
    pub mod zones {
        ...
        pub mod clusters {
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                pub fn parent(&mut self, value: impl Into<String>) -> &mut Self {
            ...
            pub mod node_pools {
                ...
                impl<'a, A: yup_oauth2::GetToken> AutoscalingRequestBuilder<'a, A> {
                    ...
                    fn _path(&self) -> String {
                        ...
                        output.push_str(&self.cluster_id);
                        output.push_str("/nodePools/");
                        output.push_str(&self.node_pool_id);
        ...
        pub mod operations {
            ...
            impl<'a, A: yup_oauth2::GetToken> CancelRequestBuilder<'a, A> {
                ...
                fn _path(&self) -> String {
                    ...
                    output.push_str(&self.zone);
                    output.push_str("/operations/");
                    output.push_str(&self.operation_id);
                    output.push_str(":cancel");
                    output
                }
                fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
