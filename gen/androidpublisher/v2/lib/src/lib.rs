...
pub mod resources {
    pub mod edits {
        ...
        impl<'a> EditsActions<'a> {
            ...
            pub fn apklistings(&self) -> crate::resources::edits::apklistings::ApklistingsActions {
        ...
        pub mod apklistings {
            pub mod params {}
            pub struct ApklistingsActions<'a> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a dyn ::google_api_auth::GetAccessToken,
            }
            impl<'a> ApklistingsActions<'a> {
                fn auth_ref(&self) -> &dyn ::google_api_auth::GetAccessToken {
                    self.auth
                }
            ...
            impl<'a> GetRequestBuilder<'a> {
                ...
                pub fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::ApkListing, crate::Error> {
                    self.execute_with_fields(None::<&str>)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            impl<'a> ListRequestBuilder<'a> {
                ...
                pub fn execute_with_default_fields(
                    self,
                ) -> Result<crate::schemas::ApkListingsListResponse, crate::Error> {
                    self.execute_with_fields(None::<&str>)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
