...
pub mod schemas {
    ...
    impl ::google_field_selector::ToFieldType for InappPurchase {
...
impl Client {
    ...
    pub fn inapppurchases(&self) -> crate::resources::inapppurchases::InapppurchasesActions {
    ...
    pub mod inapppurchases {
        ...
        impl<'a> GetRequestBuilder<'a> {
            ...
            pub async fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::InappPurchase, crate::Error> {
