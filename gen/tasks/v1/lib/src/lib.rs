pub mod schemas {
    ...
    impl ::field_selector::FieldSelector for TaskLinksItems {
    ...
    pub struct Task {
        ...
        pub completed: Option<::chrono::DateTime<chrono::offset::Utc>>,
        ...
        pub due: Option<::chrono::DateTime<chrono::offset::Utc>>,
        ...
        pub links: Option<Vec<crate::schemas::TaskLinksItems>>,
    ...
    pub struct TaskLists {
        ...
        pub items: Option<Vec<crate::schemas::TaskList>>,
    ...
    impl ::field_selector::FieldSelector for TaskLists {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for Tasks {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn tasklists(&self) -> crate::resources::tasklists::TasklistsActions<A> {
    ...
    pub fn tasks(&self) -> crate::resources::tasks::TasksActions<A> {
...
mod resources {
    pub mod tasklists {
        pub mod params {}
        pub struct TasklistsActions<'a, A> {
            pub(crate) reqwest: &'a reqwest::Client,
            pub(crate) auth: &'a std::sync::Mutex<A>,
        }
        impl<'a, A: yup_oauth2::GetToken> TasklistsActions<'a, A> {
            #[doc = "Deletes the authenticated user's specified task list."]
            pub fn delete(&self, tasklist: impl Into<String>) -> DeleteRequestBuilder<A> {
            ...
            pub fn get(&self, tasklist: impl Into<String>) -> GetRequestBuilder<A> {
                GetRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: &self.auth,
                    alt: None,
            ...
            pub fn insert(&self, request: crate::schemas::TaskList) -> InsertRequestBuilder<A> {
        ...
        impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://www.googleapis.com/tasks/v1/".to_owned();
            ...
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                ...
                let fut = auth.token(vec!["https://www.googleapis.com/auth/tasks"]);
        ...
        impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
            ...
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                ...
                let req = req.query(&[("userIp", &self.user_ip)]);
                let mut auth = self.auth.lock().unwrap();
                let fut = auth.token(vec!["https://www.googleapis.com/auth/tasks.readonly"]);
                let mut runtime = ::tokio::runtime::Runtime::new().unwrap();
                let token = runtime.block_on(fut).unwrap().access_token;
                let req = req.bearer_auth(&token);
                req
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            #[doc = r" the server."]
            pub fn iter_items_standard(mut self) -> ListItemsIter<'a, A, crate::schemas::TaskList> {
            ...
            #[doc = r" resources."]
            pub fn iter_items_debug(mut self) -> ListItemsIter<'a, A, crate::schemas::TaskList> {
                self.fields = Some(concat!("nextPageToken,", "items", "(*)").to_owned());
                ListItemsIter {
                    method: self,
                    last_page_reached: false,
            ...
            pub fn execute_standard(
                self,
            ) -> Result<crate::schemas::TaskLists, Box<dyn ::std::error::Error>> {
                self.execute_fields::<_, &str>(None)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
    ...
    pub mod tasks {
        ...
        impl<'a, A: yup_oauth2::GetToken> TasksActions<'a, A> {
            ...
            pub fn clear(&self, tasklist: impl Into<String>) -> ClearRequestBuilder<A> {
                ClearRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: &self.auth,
                    alt: None,
            ...
            pub fn list(&self, tasklist: impl Into<String>) -> ListRequestBuilder<A> {
                ListRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: &self.auth,
                    alt: None,
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            #[doc = "Flag indicating whether completed tasks are returned in the result. Optional. The default is True."]
            ...
            pub fn execute_standard(
                self,
            ) -> Result<crate::schemas::Tasks, Box<dyn ::std::error::Error>> {
                self.execute_fields::<_, &str>(None)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
