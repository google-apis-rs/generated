pub mod schemas {
    ...
    impl ::field_selector::FieldSelector for GoogleExampleLibraryagentV1Book {
    ...
    pub struct GoogleExampleLibraryagentV1ListBooksResponse {
        ...
        pub books: Option<Vec<crate::schemas::GoogleExampleLibraryagentV1Book>>,
        #[doc = "A token to retrieve next page of results.\nPass this value in the\nListBooksRequest.page_token\nfield in the subsequent call to `ListBooks` method to retrieve the next\npage of results."]
        #[serde(rename = "nextPageToken", default)]
        pub next_page_token: Option<String>,
    }
    impl ::field_selector::FieldSelector for GoogleExampleLibraryagentV1ListBooksResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GoogleExampleLibraryagentV1ListShelvesResponse {
        ...
        pub shelves: Option<Vec<crate::schemas::GoogleExampleLibraryagentV1Shelf>>,
    }
    impl ::field_selector::FieldSelector for GoogleExampleLibraryagentV1ListShelvesResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleExampleLibraryagentV1Shelf {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn shelves(&self) -> crate::resources::shelves::ShelvesActions<A> {
...
mod resources {
    pub mod shelves {
        pub mod params {}
        pub struct ShelvesActions<'a, A> {
            pub(crate) reqwest: &'a reqwest::Client,
            pub(crate) auth: &'a std::sync::Mutex<A>,
        }
        impl<'a, A: yup_oauth2::GetToken> ShelvesActions<'a, A> {
            ...
            pub fn books(&self) -> crate::resources::shelves::books::BooksActions<A> {
        ...
        impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
            ...
            pub fn execute_standard(
                ...
                crate::schemas::GoogleExampleLibraryagentV1Shelf,
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn iter_shelves<T>(self) -> ListShelvesIter<'a, A, T>
            where
                T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
            {
                ListShelvesIter {
            ...
            #[doc = r" the server."]
            pub fn iter_shelves_standard(
                mut self,
            ) -> ListShelvesIter<'a, A, crate::schemas::GoogleExampleLibraryagentV1Shelf>
            {
                self.fields = Some(concat!("nextPageToken,", "shelves").to_owned());
                ListShelvesIter {
                    method: self,
                    last_page_reached: false,
                    items_iter: None,
        ...
        pub struct ListShelvesIter<'a, A, T> {
            method: ListRequestBuilder<'a, A>,
            last_page_reached: bool,
            items_iter: Option<::std::vec::IntoIter<T>>,
        }
        impl<'a, A, T> Iterator for ListShelvesIter<'a, A, T>
        where
        ...
        pub mod books {
            pub mod params {}
            pub struct BooksActions<'a, A> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a std::sync::Mutex<A>,
            }
            impl<'a, A: yup_oauth2::GetToken> BooksActions<'a, A> {
                ...
                pub fn borrow(&self, name: impl Into<String>) -> BorrowRequestBuilder<A> {
                ...
                pub fn r#return(&self, name: impl Into<String>) -> ReturnRequestBuilder<A> {
            ...
            #[derive(Debug, Clone)]
            pub struct BorrowRequestBuilder<'a, A> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a ::std::sync::Mutex<A>,
                name: String,
                access_token: Option<String>,
            ...
            impl<'a, A: yup_oauth2::GetToken> BorrowRequestBuilder<'a, A> {
                #[doc = "OAuth access token."]
                pub fn access_token(mut self, value: impl Into<String>) -> Self {
                    self.access_token = Some(value.into());
                    self
                ...
                pub fn execute_standard(
                    ...
                    crate::schemas::GoogleExampleLibraryagentV1Book,
                    Box<dyn ::std::error::Error>,
                > {
                    self.execute_fields::<_, &str>(None)
                }
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_books<T>(self) -> ListBooksIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListBooksIter {
                ...
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_books_standard(
                    mut self,
                ) -> ListBooksIter<'a, A, crate::schemas::GoogleExampleLibraryagentV1Book>
                {
                    self.fields = Some(concat!("nextPageToken,", "books").to_owned());
                    ListBooksIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
            ...
            pub struct ListBooksIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListBooksIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
