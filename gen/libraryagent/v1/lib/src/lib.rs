...
pub mod resources {
    pub mod shelves {
        ...
        impl<'a, A: ::google_api_auth::GetAccessToken> ShelvesActions<'a, A> {
        ...
        pub mod books {
            ...
            impl<'a, A: ::google_api_auth::GetAccessToken> BooksActions<'a, A> {
            ...
            impl<'a, A: ::google_api_auth::GetAccessToken> BorrowRequestBuilder<'a, A> {
                #[doc = "OAuth access token."]
                pub fn access_token(mut self, value: impl Into<String>) -> Self {
                    self.access_token = Some(value.into());
                    self
