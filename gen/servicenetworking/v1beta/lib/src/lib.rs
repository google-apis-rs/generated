pub mod schemas {
    ...
    pub struct AddSubnetworkRequest {
        ...
        #[serde(rename = "consumerNetwork", default)]
        ...
        #[serde(rename = "ipPrefixLength", default)]
        ...
        #[serde(rename = "requestedAddress", default)]
        ...
        #[serde(rename = "subnetworkUsers", default)]
        pub subnetwork_users: Option<Vec<String>>,
    }
    impl ::field_selector::FieldSelector for AddSubnetworkRequest {
    ...
    pub struct Connection {
        ...
        #[serde(rename = "reservedPeeringRanges", default)]
    ...
    pub struct GoogleCloudServicenetworkingV1BetaSubnetwork {
        ...
        #[serde(rename = "outsideAllocation", default)]
        pub outside_allocation: Option<bool>,
    }
    impl ::field_selector::FieldSelector for GoogleCloudServicenetworkingV1BetaSubnetwork {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for SearchRangeRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for Subnetwork {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
...
pub mod services {
    ...
    impl<'a, A: yup_oauth2::GetToken> ServicesActions<'a, A> {
        ...
        ) -> UpdateConnectionsRequestBuilder<A> {
    ...
    #[derive(Debug, Clone)]
    pub struct AddSubnetworkRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        request: crate::schemas::AddSubnetworkRequest,
        parent: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> AddSubnetworkRequestBuilder<'a, A> {
        #[doc = "OAuth access token."]
        pub fn access_token(&mut self, value: impl Into<String>) -> &mut Self {
            self.access_token = Some(value.into());
            self
    ...
    #[derive(Debug, Clone)]
    pub struct SearchRangeRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        request: crate::schemas::SearchRangeRequest,
        parent: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> SearchRangeRequestBuilder<'a, A> {
        #[doc = "OAuth access token."]
        pub fn access_token(&mut self, value: impl Into<String>) -> &mut Self {
            self.access_token = Some(value.into());
            self
    ...
    #[derive(Debug, Clone)]
    pub struct UpdateConnectionsRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        request: crate::schemas::Connection,
        name: String,
    ...
    impl<'a, A: yup_oauth2::GetToken> UpdateConnectionsRequestBuilder<'a, A> {
    ...
    pub mod connections {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn network(&mut self, value: impl Into<String>) -> &mut Self {
