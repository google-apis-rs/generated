pub mod schemas {
    ...
    pub struct Aggregation {
        ...
        pub cross_series_reducer: Option<crate::schemas::AggregationCrossSeriesReducer>,
        ...
        pub per_series_aligner: Option<crate::schemas::AggregationPerSeriesAligner>,
    }
    ...
    pub struct AlertPolicy {
        ...
        pub combiner: Option<crate::schemas::AlertPolicyCombiner>,
        ...
        pub creation_record: Option<crate::schemas::MutationRecord>,
        ...
        pub mutation_record: Option<crate::schemas::MutationRecord>,
        ...
        pub validity: Option<crate::schemas::Status>,
    }
    ...
    impl ::field_selector::FieldSelector for BasicAuthentication {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct BucketOptions {
        ...
        pub explicit_buckets: Option<crate::schemas::Explicit>,
        #[doc = "The exponential buckets."]
        #[serde(rename = "exponentialBuckets", default)]
        pub exponential_buckets: Option<crate::schemas::Exponential>,
        #[doc = "The linear bucket."]
        #[serde(rename = "linearBuckets", default)]
        pub linear_buckets: Option<crate::schemas::Linear>,
    }
    ...
    pub struct CollectdPayload {
        ...
        pub metadata: Option<::std::collections::BTreeMap<String, crate::schemas::TypedValue>>,
        #[doc = "The name of the plugin. Example: \"disk\"."]
        #[serde(rename = "plugin", default)]
        pub plugin: Option<String>,
        #[doc = "The instance name of the plugin Example: \"hdcl\"."]
        #[serde(rename = "pluginInstance", default)]
        ...
        #[serde(rename = "typeInstance", default)]
        ...
        pub values: Option<Vec<crate::schemas::CollectdValue>>,
    }
    impl ::field_selector::FieldSelector for CollectdPayload {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct CollectdPayloadError {
        ...
        #[serde(rename = "valueErrors", default)]
        pub value_errors: Option<Vec<crate::schemas::CollectdValueError>>,
    }
    impl ::field_selector::FieldSelector for CollectdPayloadError {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct CollectdValue {
        ...
        pub data_source_type: Option<crate::schemas::CollectdValueDataSourceType>,
        #[doc = "The measurement value."]
        #[serde(rename = "value", default)]
        pub value: Option<crate::schemas::TypedValue>,
    }
    ...
    impl ::field_selector::FieldSelector for CollectdValueError {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct Condition {
        ...
        #[serde(rename = "conditionAbsent", default)]
        pub condition_absent: Option<crate::schemas::MetricAbsence>,
        #[doc = "A condition that compares a time series against a threshold."]
        #[serde(rename = "conditionThreshold", default)]
        pub condition_threshold: Option<crate::schemas::MetricThreshold>,
    ...
    pub struct ContentMatcher {
        ...
        pub matcher: Option<crate::schemas::ContentMatcherMatcher>,
    }
    ...
    pub struct CreateCollectdTimeSeriesRequest {
        ...
        #[serde(rename = "collectdPayloads", default)]
        pub collectd_payloads: Option<Vec<crate::schemas::CollectdPayload>>,
        #[doc = "The version of collectd that collected the data. Example: \"5.3.0-192.el6\"."]
        #[serde(rename = "collectdVersion", default)]
        pub collectd_version: Option<String>,
        #[doc = "The monitored resource associated with the time series."]
        #[serde(rename = "resource", default)]
        pub resource: Option<crate::schemas::MonitoredResource>,
    }
    impl ::field_selector::FieldSelector for CreateCollectdTimeSeriesRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct CreateCollectdTimeSeriesResponse {
        ...
        #[serde(rename = "payloadErrors", default)]
        pub payload_errors: Option<Vec<crate::schemas::CollectdPayloadError>>,
    }
    impl ::field_selector::FieldSelector for CreateCollectdTimeSeriesResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct CreateTimeSeriesRequest {
        ...
        pub time_series: Option<Vec<crate::schemas::TimeSeries>>,
    }
    impl ::field_selector::FieldSelector for CreateTimeSeriesRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct Distribution {
        ...
        pub bucket_options: Option<crate::schemas::BucketOptions>,
        ...
        pub exemplars: Option<Vec<crate::schemas::Exemplar>>,
    ...
    pub struct DroppedLabels {
        ...
        pub label: Option<::std::collections::BTreeMap<String, String>>,
    }
    impl ::field_selector::FieldSelector for DroppedLabels {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GetNotificationChannelVerificationCodeRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GetNotificationChannelVerificationCodeResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct Group {
        ...
        #[serde(rename = "isCluster", default)]
    ...
    pub struct HttpCheck {
        ...
        #[serde(rename = "authInfo", default)]
        pub auth_info: Option<crate::schemas::BasicAuthentication>,
        ...
        #[serde(rename = "maskHeaders", default)]
        ...
        #[serde(rename = "validateSsl", default)]
        pub validate_ssl: Option<bool>,
    }
    impl ::field_selector::FieldSelector for HttpCheck {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct InternalChecker {
        ...
        pub state: Option<crate::schemas::InternalCheckerState>,
    }
    ...
    pub struct ListAlertPoliciesResponse {
        ...
        pub alert_policies: Option<Vec<crate::schemas::AlertPolicy>>,
    ...
    impl ::field_selector::FieldSelector for ListAlertPoliciesResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListGroupMembersResponse {
        ...
        pub members: Option<Vec<crate::schemas::MonitoredResource>>,
    ...
    impl ::field_selector::FieldSelector for ListGroupMembersResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListGroupsResponse {
        ...
        pub group: Option<Vec<crate::schemas::Group>>,
        #[doc = "If there are more results than have been returned, then this field is set to a non-empty value. To see the additional results, use that value as pageToken in the next call to this method."]
        #[serde(rename = "nextPageToken", default)]
        pub next_page_token: Option<String>,
    }
    impl ::field_selector::FieldSelector for ListGroupsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListMetricDescriptorsResponse {
        ...
        #[serde(rename = "metricDescriptors", default)]
        pub metric_descriptors: Option<Vec<crate::schemas::MetricDescriptor>>,
        #[doc = "If there are more results than have been returned, then this field is set to a non-empty value. To see the additional results, use that value as pageToken in the next call to this method."]
        #[serde(rename = "nextPageToken", default)]
        pub next_page_token: Option<String>,
    }
    impl ::field_selector::FieldSelector for ListMetricDescriptorsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListMonitoredResourceDescriptorsResponse {
        ...
        pub resource_descriptors: Option<Vec<crate::schemas::MonitoredResourceDescriptor>>,
    }
    ...
    pub struct ListNotificationChannelDescriptorsResponse {
        ...
        #[serde(rename = "channelDescriptors", default)]
        pub channel_descriptors: Option<Vec<crate::schemas::NotificationChannelDescriptor>>,
    ...
    impl ::field_selector::FieldSelector for ListNotificationChannelDescriptorsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListNotificationChannelsResponse {
        ...
        #[serde(rename = "notificationChannels", default)]
        pub notification_channels: Option<Vec<crate::schemas::NotificationChannel>>,
    }
    impl ::field_selector::FieldSelector for ListNotificationChannelsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListTimeSeriesResponse {
        ...
        pub execution_errors: Option<Vec<crate::schemas::Status>>,
        #[doc = "If there are more results than have been returned, then this field is set to a non-empty value. To see the additional results, use that value as pageToken in the next call to this method."]
        #[serde(rename = "nextPageToken", default)]
        pub next_page_token: Option<String>,
    ...
    impl ::field_selector::FieldSelector for ListTimeSeriesResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListUptimeCheckConfigsResponse {
        ...
        #[serde(rename = "uptimeCheckConfigs", default)]
        pub uptime_check_configs: Option<Vec<crate::schemas::UptimeCheckConfig>>,
    }
    impl ::field_selector::FieldSelector for ListUptimeCheckConfigsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListUptimeCheckIpsResponse {
        ...
        #[serde(rename = "uptimeCheckIps", default)]
        pub uptime_check_ips: Option<Vec<crate::schemas::UptimeCheckIp>>,
    }
    impl ::field_selector::FieldSelector for ListUptimeCheckIpsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct MetricAbsence {
        ...
        pub aggregations: Option<Vec<crate::schemas::Aggregation>>,
    ...
    impl ::field_selector::FieldSelector for MetricAbsence {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct MetricThreshold {
        ...
        pub comparison: Option<crate::schemas::MetricThresholdComparison>,
        ...
        pub denominator_aggregations: Option<Vec<crate::schemas::Aggregation>>,
    ...
    pub struct MonitoredResourceMetadata {
        ...
        pub system_labels: Option<::std::collections::BTreeMap<String, ::serde_json::Value>>,
    ...
    pub struct NotificationChannel {
        ...
        pub verification_status: Option<crate::schemas::NotificationChannelVerificationStatus>,
    }
    ...
    pub struct NotificationChannelDescriptor {
        ...
        pub supported_tiers:
            Option<Vec<crate::schemas::NotificationChannelDescriptorSupportedTiersItems>>,
    }
    ...
    pub struct Point {
        ...
        pub interval: Option<crate::schemas::TimeInterval>,
    ...
    pub struct ResourceGroup {
        ...
        pub resource_type: Option<crate::schemas::ResourceGroupResourceType>,
    }
    ...
    impl ::field_selector::FieldSelector for SendNotificationChannelVerificationCodeRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {}
    }
    #[derive(
        Debug,
    ...
    impl ::field_selector::FieldSelector for SpanContext {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for TcpCheck {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct TimeSeries {
        ...
        #[serde(rename = "valueType", default)]
        pub value_type: Option<crate::schemas::TimeSeriesValueType>,
    }
    ...
    pub struct TypedValue {
        ...
        pub distribution_value: Option<crate::schemas::Distribution>,
    ...
    pub struct UptimeCheckConfig {
        ...
        pub content_matchers: Option<Vec<crate::schemas::ContentMatcher>>,
        ...
        pub http_check: Option<crate::schemas::HttpCheck>,
        ...
        pub internal_checkers: Option<Vec<crate::schemas::InternalChecker>>,
        ...
        pub monitored_resource: Option<crate::schemas::MonitoredResource>,
        ...
        pub resource_group: Option<crate::schemas::ResourceGroup>,
        ...
        pub selected_regions: Option<Vec<crate::schemas::UptimeCheckConfigSelectedRegionsItems>>,
        #[doc = "Contains information needed to make a TCP check."]
        #[serde(rename = "tcpCheck", default)]
        pub tcp_check: Option<crate::schemas::TcpCheck>,
    ...
    pub struct UptimeCheckIp {
        ...
        pub region: Option<crate::schemas::UptimeCheckIpRegion>,
    }
    ...
    impl ::field_selector::FieldSelector for VerifyNotificationChannelRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn uptime_check_ips(&self) -> crate::resources::uptime_check_ips::UptimeCheckIpsActions<A> {
...
mod resources {
    pub mod projects {
        ...
        impl<'a, A: yup_oauth2::GetToken> ProjectsActions<'a, A> {
            ...
            pub fn alert_policies(
                &self,
            ) -> crate::resources::projects::alert_policies::AlertPoliciesActions<A> {
            ...
            pub fn collectd_time_series(
                &self,
            ) -> crate::resources::projects::collectd_time_series::CollectdTimeSeriesActions<A>
            {
            ...
            pub fn metric_descriptors(
                &self,
            ) -> crate::resources::projects::metric_descriptors::MetricDescriptorsActions<A>
            {
            ...
            #[doc = "Actions that can be performed on the monitored_resource_descriptors resource"]pub fn monitored_resource_descriptors ( & self ) -> crate :: resources :: projects :: monitored_resource_descriptors :: MonitoredResourceDescriptorsActions < A >{
                crate :: resources :: projects :: monitored_resource_descriptors :: MonitoredResourceDescriptorsActions { reqwest : & self . reqwest , auth : & self . auth }
            }
            #[doc = "Actions that can be performed on the notification_channel_descriptors resource"]pub fn notification_channel_descriptors ( & self ) -> crate :: resources :: projects :: notification_channel_descriptors :: NotificationChannelDescriptorsActions < A >{
                crate :: resources :: projects :: notification_channel_descriptors :: NotificationChannelDescriptorsActions { reqwest : & self . reqwest , auth : & self . auth }
            }
            #[doc = "Actions that can be performed on the notification_channels resource"]
            pub fn notification_channels(
                &self,
            ) -> crate::resources::projects::notification_channels::NotificationChannelsActions<A>
            {
            ...
            pub fn time_series(
                &self,
            ) -> crate::resources::projects::time_series::TimeSeriesActions<A> {
            ...
            pub fn uptime_check_configs(
                &self,
            ) -> crate::resources::projects::uptime_check_configs::UptimeCheckConfigsActions<A>
            {
        ...
        pub mod alert_policies {
            pub mod params {}
            pub struct AlertPoliciesActions<'a, A> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a std::sync::Mutex<A>,
            }
            impl<'a, A: yup_oauth2::GetToken> AlertPoliciesActions<'a, A> {
            ...
            impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::AlertPolicy, Box<dyn ::std::error::Error>>
                {
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                pub fn iter_alert_policies<T>(self) -> ListAlertPoliciesIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListAlertPoliciesIter {
                        method: self,
                ...
                #[doc = r" the server."]
                pub fn iter_alert_policies_standard(
                    mut self,
                ) -> ListAlertPoliciesIter<'a, A, crate::schemas::AlertPolicy> {
                    self.fields = Some(concat!("nextPageToken,", "alertPolicies").to_owned());
                    ListAlertPoliciesIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                #[doc = r" resources."]
                pub fn iter_alert_policies_debug(
                    mut self,
                ) -> ListAlertPoliciesIter<'a, A, crate::schemas::AlertPolicy> {
                    self.fields =
                        Some(concat!("nextPageToken,", "alertPolicies", "(*)").to_owned());
                    ListAlertPoliciesIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::ListAlertPoliciesResponse, Box<dyn ::std::error::Error>>
                {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            pub struct ListAlertPoliciesIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListAlertPoliciesIter<'a, A, T>
            where
        ...
        pub mod collectd_time_series {
            pub mod params {}
            pub struct CollectdTimeSeriesActions<'a, A> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a std::sync::Mutex<A>,
            }
            impl<'a, A: yup_oauth2::GetToken> CollectdTimeSeriesActions<'a, A> {
            ...
            impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
                ...
                pub fn execute_standard(
                    ...
                    crate::schemas::CreateCollectdTimeSeriesResponse,
        ...
        pub mod groups {
            ...
            impl<'a, A: yup_oauth2::GetToken> GroupsActions<'a, A> {
                ...
                pub fn members(
                    &self,
                ) -> crate::resources::projects::groups::members::MembersActions<A>
                {
            ...
            impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::Group, Box<dyn ::std::error::Error>> {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_group<T>(self) -> ListGroupIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListGroupIter {
                ...
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_group_standard(
                    mut self,
                ) -> ListGroupIter<'a, A, crate::schemas::Group> {
                    self.fields = Some(concat!("nextPageToken,", "group").to_owned());
                    ListGroupIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                #[doc = r" all fields can be expensive both in bandwidth and server"]
                #[doc = r" resources."]
                pub fn iter_group_debug(mut self) -> ListGroupIter<'a, A, crate::schemas::Group> {
                    self.fields = Some(concat!("nextPageToken,", "group", "(*)").to_owned());
                    ListGroupIter {
                        method: self,
                        last_page_reached: false,
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::ListGroupsResponse, Box<dyn ::std::error::Error>>
                {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            pub struct ListGroupIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListGroupIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
            ...
            pub mod members {
                ...
                impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                    ...
                    #[doc = r" populated fields in the yielded items will be determined by the"]
                    #[doc = r" `FieldSelector` implementation."]
                    pub fn iter_members<T>(self) -> ListMembersIter<'a, A, T>
                    where
                        T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                    {
                        ListMembersIter {
                    ...
                    #[doc = r" fields in `#items_type` will be the default fields populated by"]
                    #[doc = r" the server."]
                    pub fn iter_members_standard(
                        mut self,
                    ) -> ListMembersIter<'a, A, crate::schemas::MonitoredResource>
                    {
                        self.fields = Some(concat!("nextPageToken,", "members").to_owned());
                        ListMembersIter {
                            method: self,
                            last_page_reached: false,
                            items_iter: None,
                    ...
                    pub fn execute_standard(
                        ...
                        crate::schemas::ListGroupMembersResponse,
                        Box<dyn ::std::error::Error>,
                    > {
                        self.execute_fields::<_, &str>(None)
                    }
                ...
                pub struct ListMembersIter<'a, A, T> {
                    method: ListRequestBuilder<'a, A>,
                    last_page_reached: bool,
                    items_iter: Option<::std::vec::IntoIter<T>>,
                }
                impl<'a, A, T> Iterator for ListMembersIter<'a, A, T>
                where
                    A: ::yup_oauth2::GetToken,
                    T: ::serde::de::DeserializeOwned,
                {
        ...
        pub mod metric_descriptors {
            pub mod params {}
            pub struct MetricDescriptorsActions<'a, A> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a std::sync::Mutex<A>,
            }
            impl<'a, A: yup_oauth2::GetToken> MetricDescriptorsActions<'a, A> {
            ...
            impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::MetricDescriptor, Box<dyn ::std::error::Error>>
                {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_metric_descriptors<T>(self) -> ListMetricDescriptorsIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListMetricDescriptorsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                    }
                ...
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_metric_descriptors_standard(
                    mut self,
                ) -> ListMetricDescriptorsIter<'a, A, crate::schemas::MetricDescriptor>
                {
                    self.fields = Some(concat!("nextPageToken,", "metricDescriptors").to_owned());
                    ListMetricDescriptorsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                #[doc = r" all fields can be expensive both in bandwidth and server"]
                #[doc = r" resources."]
                pub fn iter_metric_descriptors_debug(
                    mut self,
                ) -> ListMetricDescriptorsIter<'a, A, crate::schemas::MetricDescriptor>
                {
                    self.fields =
                        Some(concat!("nextPageToken,", "metricDescriptors", "(*)").to_owned());
                    ListMetricDescriptorsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                pub fn execute_standard(
                    ...
                    crate::schemas::ListMetricDescriptorsResponse,
                    Box<dyn ::std::error::Error>,
                > {
                    self.execute_fields::<_, &str>(None)
                }
            ...
            pub struct ListMetricDescriptorsIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListMetricDescriptorsIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
        ...
        pub mod monitored_resource_descriptors {
            ...
            impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::MonitoredResourceDescriptor, Box<dyn ::std::error::Error>>
                {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_resource_descriptors<T>(self) -> ListResourceDescriptorsIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListResourceDescriptorsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                    }
                ...
                pub fn iter_resource_descriptors_standard(
                    mut self,
                ) -> ListResourceDescriptorsIter<'a, A, crate::schemas::MonitoredResourceDescriptor>
                {
            ...
            pub struct ListResourceDescriptorsIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListResourceDescriptorsIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
        ...
        pub mod notification_channel_descriptors {
            pub mod params {}
            pub struct NotificationChannelDescriptorsActions<'a, A> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a std::sync::Mutex<A>,
            }
            impl<'a, A: yup_oauth2::GetToken> NotificationChannelDescriptorsActions<'a, A> {
            ...
            impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
                ...
                pub fn execute_standard(
                    ...
                    crate::schemas::NotificationChannelDescriptor,
                    Box<dyn ::std::error::Error>,
                > {
                    self.execute_fields::<_, &str>(None)
                }
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_channel_descriptors<T>(self) -> ListChannelDescriptorsIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListChannelDescriptorsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                    }
                ...
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_channel_descriptors_standard(
                    mut self,
                ) -> ListChannelDescriptorsIter<'a, A, crate::schemas::NotificationChannelDescriptor>
                {
                    self.fields = Some(concat!("nextPageToken,", "channelDescriptors").to_owned());
                    ListChannelDescriptorsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                #[doc = r" all fields can be expensive both in bandwidth and server"]
                #[doc = r" resources."]
                pub fn iter_channel_descriptors_debug(
                    mut self,
                ) -> ListChannelDescriptorsIter<'a, A, crate::schemas::NotificationChannelDescriptor>
                {
                    self.fields =
                        Some(concat!("nextPageToken,", "channelDescriptors", "(*)").to_owned());
                    ListChannelDescriptorsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
            ...
            pub struct ListChannelDescriptorsIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListChannelDescriptorsIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
        ...
        pub mod notification_channels {
            pub mod params {}
            pub struct NotificationChannelsActions<'a, A> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a std::sync::Mutex<A>,
            }
            impl<'a, A: yup_oauth2::GetToken> NotificationChannelsActions<'a, A> {
                ...
                pub fn get_verification_code(
                    ...
                    name: impl Into<String>,
                ) -> GetVerificationCodeRequestBuilder<A> {
            ...
            impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::NotificationChannel, Box<dyn ::std::error::Error>>
                {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            #[derive(Debug, Clone)]
            pub struct GetVerificationCodeRequestBuilder<'a, A> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a ::std::sync::Mutex<A>,
                request: crate::schemas::GetNotificationChannelVerificationCodeRequest,
                name: String,
            ...
            impl<'a, A: yup_oauth2::GetToken> GetVerificationCodeRequestBuilder<'a, A> {
                #[doc = "OAuth access token."]
                pub fn access_token(mut self, value: impl Into<String>) -> Self {
                    self.access_token = Some(value.into());
                    self
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_notification_channels<T>(self) -> ListNotificationChannelsIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListNotificationChannelsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                    }
                ...
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_notification_channels_standard(
                    mut self,
                ) -> ListNotificationChannelsIter<'a, A, crate::schemas::NotificationChannel>
                {
                    self.fields =
                        Some(concat!("nextPageToken,", "notificationChannels").to_owned());
                    ListNotificationChannelsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                #[doc = r" all fields can be expensive both in bandwidth and server"]
                #[doc = r" resources."]
                pub fn iter_notification_channels_debug(
                    mut self,
                ) -> ListNotificationChannelsIter<'a, A, crate::schemas::NotificationChannel>
                {
                    self.fields =
                ...
                pub fn execute_standard(
                    ...
                    crate::schemas::ListNotificationChannelsResponse,
                    Box<dyn ::std::error::Error>,
                > {
                    self.execute_fields::<_, &str>(None)
                }
            ...
            pub struct ListNotificationChannelsIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListNotificationChannelsIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
        ...
        pub mod time_series {
            ...
            pub struct TimeSeriesActions<'a, A> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a std::sync::Mutex<A>,
            }
            impl<'a, A: yup_oauth2::GetToken> TimeSeriesActions<'a, A> {
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_execution_errors<T>(self) -> ListExecutionErrorsIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListExecutionErrorsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                    }
                ...
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_execution_errors_standard(
                    mut self,
                ) -> ListExecutionErrorsIter<'a, A, crate::schemas::Status> {
                    self.fields = Some(concat!("nextPageToken,", "executionErrors").to_owned());
                    ListExecutionErrorsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                #[doc = r" all fields can be expensive both in bandwidth and server"]
                #[doc = r" resources."]
                pub fn iter_execution_errors_debug(
                    mut self,
                ) -> ListExecutionErrorsIter<'a, A, crate::schemas::Status> {
                    self.fields =
                        Some(concat!("nextPageToken,", "executionErrors", "(*)").to_owned());
                    ListExecutionErrorsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_time_series<T>(self) -> ListTimeSeriesIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListTimeSeriesIter {
                ...
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_time_series_standard(
                    mut self,
                ) -> ListTimeSeriesIter<'a, A, crate::schemas::TimeSeries> {
                    self.fields = Some(concat!("nextPageToken,", "timeSeries").to_owned());
                    ListTimeSeriesIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::ListTimeSeriesResponse, Box<dyn ::std::error::Error>>
                {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            pub struct ListExecutionErrorsIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListExecutionErrorsIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
            ...
            pub struct ListTimeSeriesIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListTimeSeriesIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
        ...
        pub mod uptime_check_configs {
            pub mod params {}
            pub struct UptimeCheckConfigsActions<'a, A> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a std::sync::Mutex<A>,
            }
            impl<'a, A: yup_oauth2::GetToken> UptimeCheckConfigsActions<'a, A> {
            ...
            impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::UptimeCheckConfig, Box<dyn ::std::error::Error>>
                {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_uptime_check_configs<T>(self) -> ListUptimeCheckConfigsIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListUptimeCheckConfigsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                    }
                ...
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_uptime_check_configs_standard(
                    mut self,
                ) -> ListUptimeCheckConfigsIter<'a, A, crate::schemas::UptimeCheckConfig>
                {
                    self.fields = Some(concat!("nextPageToken,", "uptimeCheckConfigs").to_owned());
                    ListUptimeCheckConfigsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                #[doc = r" all fields can be expensive both in bandwidth and server"]
                #[doc = r" resources."]
                pub fn iter_uptime_check_configs_debug(
                    mut self,
                ) -> ListUptimeCheckConfigsIter<'a, A, crate::schemas::UptimeCheckConfig>
                {
                    self.fields =
                        Some(concat!("nextPageToken,", "uptimeCheckConfigs", "(*)").to_owned());
                    ListUptimeCheckConfigsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                pub fn execute_standard(
                    ...
                    crate::schemas::ListUptimeCheckConfigsResponse,
                    Box<dyn ::std::error::Error>,
                > {
                    self.execute_fields::<_, &str>(None)
                }
            ...
            pub struct ListUptimeCheckConfigsIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListUptimeCheckConfigsIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
    ...
    pub mod uptime_check_ips {
        pub mod params {}
        pub struct UptimeCheckIpsActions<'a, A> {
            pub(crate) reqwest: &'a reqwest::Client,
            pub(crate) auth: &'a std::sync::Mutex<A>,
        }
        impl<'a, A: yup_oauth2::GetToken> UptimeCheckIpsActions<'a, A> {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            #[doc = r" populated fields in the yielded items will be determined by the"]
            #[doc = r" `FieldSelector` implementation."]
            pub fn iter_uptime_check_ips<T>(self) -> ListUptimeCheckIpsIter<'a, A, T>
            where
                T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
            {
                ListUptimeCheckIpsIter {
                    method: self,
                    last_page_reached: false,
                    items_iter: None,
                }
            ...
            #[doc = r" fields in `#items_type` will be the default fields populated by"]
            #[doc = r" the server."]
            pub fn iter_uptime_check_ips_standard(
                mut self,
            ) -> ListUptimeCheckIpsIter<'a, A, crate::schemas::UptimeCheckIp> {
                self.fields = Some(concat!("nextPageToken,", "uptimeCheckIps").to_owned());
                ListUptimeCheckIpsIter {
                    method: self,
                    last_page_reached: false,
                    items_iter: None,
            ...
            #[doc = r" all fields can be expensive both in bandwidth and server"]
            #[doc = r" resources."]
            pub fn iter_uptime_check_ips_debug(
                mut self,
            ) -> ListUptimeCheckIpsIter<'a, A, crate::schemas::UptimeCheckIp> {
                self.fields = Some(concat!("nextPageToken,", "uptimeCheckIps", "(*)").to_owned());
                ListUptimeCheckIpsIter {
            ...
            pub fn execute_standard(
                self,
            ) -> Result<crate::schemas::ListUptimeCheckIpsResponse, Box<dyn ::std::error::Error>>
            {
                self.execute_fields::<_, &str>(None)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
        ...
        pub struct ListUptimeCheckIpsIter<'a, A, T> {
            method: ListRequestBuilder<'a, A>,
            last_page_reached: bool,
            items_iter: Option<::std::vec::IntoIter<T>>,
        }
        impl<'a, A, T> Iterator for ListUptimeCheckIpsIter<'a, A, T>
        where
            A: ::yup_oauth2::GetToken,
            T: ::serde::de::DeserializeOwned,
        {
