pub mod schemas {
    ...
    pub struct AppProfile {
        ...
        #[serde(rename = "multiClusterRoutingUseAny", default)]
        ...
        #[serde(rename = "singleClusterRouting", default)]
        pub single_cluster_routing: ::std::option::Option<crate::schemas::SingleClusterRouting>,
    }
    impl ::field_selector::FieldSelector for AppProfile {
    ...
    pub struct CheckConsistencyRequest {
        ...
        #[serde(rename = "consistencyToken", default)]
        pub consistency_token: ::std::option::Option<String>,
    }
    impl ::field_selector::FieldSelector for CheckConsistencyRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct CheckConsistencyResponse {
        ...
        #[serde(rename = "consistent", default)]
        pub consistent: ::std::option::Option<bool>,
    }
    impl ::field_selector::FieldSelector for CheckConsistencyResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for ClusterStateReplicationState {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ClusterState {
        ...
        #[serde(rename = "replicationState", default)]
    ...
    pub struct ColumnFamily {
        ...
        #[serde(rename = "gcRule", default)]
        pub gc_rule: ::std::option::Option<crate::schemas::GcRule>,
    }
    impl ::field_selector::FieldSelector for ColumnFamily {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct CreateTableRequest {
        ...
        #[serde(rename = "initialSplits", default)]
    ...
    pub struct DropRowRangeRequest {
        ...
        #[serde(rename = "deleteAllDataFromTable", default)]
        ...
        #[serde(rename = "rowKeyPrefix", default)]
        pub row_key_prefix: ::std::option::Option<crate::bytes::Bytes>,
    }
    impl ::field_selector::FieldSelector for DropRowRangeRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GcRule {
        ...
        #[serde(rename = "maxNumVersions", default)]
    ...
    impl ::field_selector::FieldSelector for GcRule {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GenerateConsistencyTokenRequest {
        fn field_selector_with_ident(_ident: &str, _selector: &mut String) {}
    }
    #[derive(
        Debug,
    ...
    impl ::field_selector::FieldSelector for GenerateConsistencyTokenResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for Intersection {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListAppProfilesResponse {
        ...
        #[serde(rename = "appProfiles", default)]
        ...
        #[serde(rename = "failedLocations", default)]
    ...
    impl ::field_selector::FieldSelector for ListAppProfilesResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for ListTablesResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for Modification {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ModifyColumnFamiliesRequest {
        ...
        #[serde(rename = "modifications", default)]
        pub modifications: ::std::option::Option<Vec<crate::schemas::Modification>>,
    }
    impl ::field_selector::FieldSelector for ModifyColumnFamiliesRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for MultiClusterRoutingUseAny {
        fn field_selector_with_ident(_ident: &str, _selector: &mut String) {}
    }
    #[derive(Debug, Clone, PartialEq, Default, :: serde :: Deserialize, :: serde :: Serialize)]
    ...
    impl ::field_selector::FieldSelector for Split {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for TableGranularity {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct Table {
        ...
        #[serde(rename = "clusterStates", default)]
    ...
    impl ::field_selector::FieldSelector for Union {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
...
mod resources {
    pub mod operations {
        ...
        impl<'a, A: yup_oauth2::GetToken> OperationsActions<'a, A> {
            ...
            #[doc = "Actions that can be performed on the projects resource"]
            pub fn projects(&self) -> crate::resources::operations::projects::ProjectsActions<A> {
        ...
        impl<'a, A: yup_oauth2::GetToken> CancelRequestBuilder<'a, A> {
            ...
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                ...
                let fut = auth.token(vec!["https://www.googleapis.com/auth/bigtable.admin"]);
        ...
        pub mod projects {
            ...
            impl<'a, A: yup_oauth2::GetToken> ProjectsActions<'a, A> {
                ...
                pub fn operations(
                    &self,
                ) -> crate::resources::operations::projects::operations::OperationsActions<A>
                {
            ...
            pub mod operations {
                ...
                impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                    ...
                    fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                        ...
                        let mut auth = self.auth.lock().unwrap();
                        let fut =
                            auth.token(vec!["https://www.googleapis.com/auth/bigtable.admin"]);
                        let mut runtime = ::tokio::runtime::Runtime::new().unwrap();
                        let token = runtime.block_on(fut).unwrap().access_token;
                        let req = req.bearer_auth(&token);
                        req
    ...
    pub mod projects {
        ...
        pub mod instances {
            ...
            impl<'a, A: yup_oauth2::GetToken> InstancesActions<'a, A> {
                ...
                ) -> PartialUpdateInstanceRequestBuilder<A> {
                ...
                pub fn app_profiles(
                    &self,
                ) -> crate::resources::projects::instances::app_profiles::AppProfilesActions<A>
                {
                ...
                pub fn clusters(
                    &self,
                ) -> crate::resources::projects::instances::clusters::ClustersActions<A>
                {
                ...
                pub fn tables(
                    &self,
                ) -> crate::resources::projects::instances::tables::TablesActions<A>
                {
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_failed_locations<T>(self) -> ListFailedLocationsIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListFailedLocationsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                    }
                ...
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_failed_locations_standard(
                    mut self,
                ) -> ListFailedLocationsIter<'a, A, String> {
                    self.fields = Some(concat!("nextPageToken,", "failedLocations").to_owned());
                    ListFailedLocationsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                #[doc = r" all fields can be expensive both in bandwidth and server"]
                #[doc = r" resources."]
                pub fn iter_failed_locations_debug(
                    mut self,
                ) -> ListFailedLocationsIter<'a, A, String> {
                    self.fields =
                        Some(concat!("nextPageToken,", "failedLocations", "(*)").to_owned());
                    ListFailedLocationsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
            ...
            pub struct ListFailedLocationsIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListFailedLocationsIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
            ...
            #[derive(Debug, Clone)]
            pub struct PartialUpdateInstanceRequestBuilder<'a, A> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a ::std::sync::Mutex<A>,
                request: crate::schemas::Instance,
                name: String,
            ...
            impl<'a, A: yup_oauth2::GetToken> PartialUpdateInstanceRequestBuilder<'a, A> {
                #[doc = "The subset of Instance fields which should be replaced.\nMust be explicitly set."]
            ...
            pub mod app_profiles {
                pub mod params {}
                pub struct AppProfilesActions<'a, A> {
                    pub(crate) reqwest: &'a reqwest::Client,
                    pub(crate) auth: &'a std::sync::Mutex<A>,
                }
                impl<'a, A: yup_oauth2::GetToken> AppProfilesActions<'a, A> {
                ...
                impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
                    ...
                    pub fn execute_standard(
                        self,
                    ) -> Result<crate::schemas::AppProfile, Box<dyn ::std::error::Error>>
                    {
                        self.execute_fields::<_, &str>(None)
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                    ...
                    #[doc = r" populated fields in the yielded items will be determined by the"]
                    #[doc = r" `FieldSelector` implementation."]
                    pub fn iter_app_profiles<T>(self) -> ListAppProfilesIter<'a, A, T>
                    where
                        T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                    {
                        ListAppProfilesIter {
                    ...
                    #[doc = r" fields in `#items_type` will be the default fields populated by"]
                    #[doc = r" the server."]
                    pub fn iter_app_profiles_standard(
                        mut self,
                    ) -> ListAppProfilesIter<'a, A, crate::schemas::AppProfile>
                    {
                        self.fields = Some(concat!("nextPageToken,", "appProfiles").to_owned());
                        ListAppProfilesIter {
                            method: self,
                            last_page_reached: false,
                            items_iter: None,
                    ...
                    #[doc = r" all fields can be expensive both in bandwidth and server"]
                    #[doc = r" resources."]
                    pub fn iter_app_profiles_debug(
                        mut self,
                    ) -> ListAppProfilesIter<'a, A, crate::schemas::AppProfile>
                    {
                        self.fields =
                            Some(concat!("nextPageToken,", "appProfiles", "(*)").to_owned());
                        ListAppProfilesIter {
                            method: self,
                            last_page_reached: false,
                            items_iter: None,
                    ...
                    pub fn execute_standard(
                        self,
                    ) -> Result<crate::schemas::ListAppProfilesResponse, Box<dyn ::std::error::Error>>
                    {
                        self.execute_fields::<_, &str>(None)
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                pub struct ListAppProfilesIter<'a, A, T> {
                    method: ListRequestBuilder<'a, A>,
                    last_page_reached: bool,
                    items_iter: Option<::std::vec::IntoIter<T>>,
                }
                impl<'a, A, T> Iterator for ListAppProfilesIter<'a, A, T>
                where
                    A: ::yup_oauth2::GetToken,
                    T: ::serde::de::DeserializeOwned,
                {
            ...
            pub mod tables {
                ...
                impl<'a, A: yup_oauth2::GetToken> TablesActions<'a, A> {
                    ...
                    pub fn check_consistency(
                        ...
                        name: impl Into<String>,
                    ) -> CheckConsistencyRequestBuilder<A> {
                    ...
                    pub fn generate_consistency_token(
                        ...
                        name: impl Into<String>,
                    ) -> GenerateConsistencyTokenRequestBuilder<A> {
                    ...
                    pub fn modify_column_families(
                        ...
                        name: impl Into<String>,
                    ) -> ModifyColumnFamiliesRequestBuilder<A> {
                ...
                #[derive(Debug, Clone)]
                pub struct CheckConsistencyRequestBuilder<'a, A> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a ::std::sync::Mutex<A>,
                    request: crate::schemas::CheckConsistencyRequest,
                    name: String,
                ...
                impl<'a, A: yup_oauth2::GetToken> CheckConsistencyRequestBuilder<'a, A> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
                    ...
                    pub fn execute_standard(
                        ...
                        crate::schemas::CheckConsistencyResponse,
                ...
                #[derive(Debug, Clone)]
                pub struct DropRowRangeRequestBuilder<'a, A> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a ::std::sync::Mutex<A>,
                    request: crate::schemas::DropRowRangeRequest,
                    name: String,
                ...
                impl<'a, A: yup_oauth2::GetToken> DropRowRangeRequestBuilder<'a, A> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
                ...
                #[derive(Debug, Clone)]
                pub struct GenerateConsistencyTokenRequestBuilder<'a, A> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a ::std::sync::Mutex<A>,
                    request: crate::schemas::GenerateConsistencyTokenRequest,
                    name: String,
                ...
                impl<'a, A: yup_oauth2::GetToken> GenerateConsistencyTokenRequestBuilder<'a, A> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
                    ...
                    pub fn execute_standard(
                        ...
                        crate::schemas::GenerateConsistencyTokenResponse,
                        Box<dyn ::std::error::Error>,
                    > {
                        self.execute_fields::<_, &str>(None)
                    }
                ...
                impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                    ...
                    #[doc = r" populated fields in the yielded items will be determined by the"]
                    #[doc = r" `FieldSelector` implementation."]
                    pub fn iter_tables<T>(self) -> ListTablesIter<'a, A, T>
                    where
                        T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                    {
                        ListTablesIter {
                    ...
                    #[doc = r" fields in `#items_type` will be the default fields populated by"]
                    #[doc = r" the server."]
                    pub fn iter_tables_standard(
                        mut self,
                    ) -> ListTablesIter<'a, A, crate::schemas::Table> {
                        self.fields = Some(concat!("nextPageToken,", "tables").to_owned());
                        ListTablesIter {
                            method: self,
                            last_page_reached: false,
                            items_iter: None,
                    ...
                    pub fn execute_standard(
                        self,
                    ) -> Result<crate::schemas::ListTablesResponse, Box<dyn ::std::error::Error>>
                    {
                        self.execute_fields::<_, &str>(None)
                    }
                    #[doc = r" Execute the given operation. This will provide a `fields`"]
                ...
                pub struct ListTablesIter<'a, A, T> {
                    method: ListRequestBuilder<'a, A>,
                    last_page_reached: bool,
                    items_iter: Option<::std::vec::IntoIter<T>>,
                }
                impl<'a, A, T> Iterator for ListTablesIter<'a, A, T>
                where
                    A: ::yup_oauth2::GetToken,
                    T: ::serde::de::DeserializeOwned,
                {
                ...
                #[derive(Debug, Clone)]
                pub struct ModifyColumnFamiliesRequestBuilder<'a, A> {
                    pub(crate) reqwest: &'a ::reqwest::Client,
                    pub(crate) auth: &'a ::std::sync::Mutex<A>,
                    request: crate::schemas::ModifyColumnFamiliesRequest,
                    name: String,
                ...
                impl<'a, A: yup_oauth2::GetToken> ModifyColumnFamiliesRequestBuilder<'a, A> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
