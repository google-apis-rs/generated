...
pub mod resources {
    ...
    pub mod projects {
        ...
        pub mod instances {
            ...
            impl<'a, A: ::google_api_auth::GetAccessToken> PartialUpdateInstanceRequestBuilder<'a, A> {
                #[doc = "The subset of Instance fields which should be replaced.\nMust be explicitly set."]
            ...
            pub mod app_profiles {
                ...
                impl<'a, A: ::google_api_auth::GetAccessToken> AppProfilesActions<'a, A> {
            ...
            pub mod tables {
                ...
                impl<'a, A: ::google_api_auth::GetAccessToken> TablesActions<'a, A> {
                ...
                impl<'a, A: ::google_api_auth::GetAccessToken> CheckConsistencyRequestBuilder<'a, A> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
                ...
                impl<'a, A: ::google_api_auth::GetAccessToken> DropRowRangeRequestBuilder<'a, A> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
                ...
                impl<'a, A: ::google_api_auth::GetAccessToken> GenerateConsistencyTokenRequestBuilder<'a, A> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
                ...
                impl<'a, A: ::google_api_auth::GetAccessToken> ModifyColumnFamiliesRequestBuilder<'a, A> {
                    #[doc = "OAuth access token."]
                    pub fn access_token(mut self, value: impl Into<String>) -> Self {
                        self.access_token = Some(value.into());
                        self
