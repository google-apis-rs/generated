...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn children(&self) -> crate::children::ChildrenActions<A> {
        crate::children::ChildrenActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    ...
    pub fn parents(&self) -> crate::parents::ParentsActions<A> {
        crate::parents::ParentsActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    ...
    pub fn properties(&self) -> crate::properties::PropertiesActions<A> {
        crate::properties::PropertiesActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    #[doc = "Actions that can be performed on the realtime resource"]
    pub fn realtime(&self) -> crate::realtime::RealtimeActions<A> {
        crate::realtime::RealtimeActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
...
pub mod apps {
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(self) -> Result<crate::schemas::App, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
        ...
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            ...
            let mut auth = self.auth.lock().unwrap();
            let req = req.bearer_auth(
                auth.token::<_, &str>(&["https://www.googleapis.com/auth/drive.apps.readonly"])
                    .unwrap()
                    .access_token,
            );
            req
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn app_filter_extensions(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        pub fn app_filter_mime_types(&mut self, value: impl Into<String>) -> &mut Self {
...
pub mod changes {
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(self) -> Result<crate::schemas::Change, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
        ...
        fn _path(&self) -> String {
            ...
            output.push_str(&self.change_id);
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            let req = self.reqwest.request(::reqwest::Method::GET, path);
...
pub mod children {
    ...
    impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
        ...
        fn _path(&self) -> String {
            ...
            output.push_str(&self.folder_id);
            output.push_str("/children/");
            output.push_str(&self.child_id);
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
...
pub mod files {
    ...
    pub struct CopyRequestBuilder<'a, A> {
        ...
        visibility: Option<crate::files::params::CopyVisibility>,
        alt: Option<crate::params::Alt>,
        fields: Option<String>,
        key: Option<String>,
        oauth_token: Option<String>,
    ...
    impl<'a, A: yup_oauth2::GetToken> CopyRequestBuilder<'a, A> {
        ...
        pub fn convert(&mut self, value: bool) -> &mut Self {
            self.convert = Some(value);
            self
        }
        #[doc = "Whether to attempt OCR on .jpg, .png, .gif, or .pdf uploads."]
        pub fn ocr(&mut self, value: bool) -> &mut Self {
            self.ocr = Some(value);
            self
        }
        ...
        pub fn pinned(&mut self, value: bool) -> &mut Self {
        ...
        pub fn timed_text_language(&mut self, value: impl Into<String>) -> &mut Self {
            self.timed_text_language = Some(value.into());
            self
        }
        #[doc = "The timed text track name."]
        pub fn timed_text_track_name(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        pub fn visibility(&mut self, value: crate::files::params::CopyVisibility) -> &mut Self {
    ...
    pub struct GetRequestBuilder<'a, A> {
        ...
        projection: Option<crate::files::params::GetProjection>,
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        pub fn projection(&mut self, value: crate::files::params::GetProjection) -> &mut Self {
            self.projection = Some(value);
            self
        }
        #[doc = "Specifies the Revision ID that should be downloaded. Ignored unless alt=media is specified."]
        pub fn revision_id(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        pub fn update_viewed_date(&mut self, value: bool) -> &mut Self {
    ...
    pub struct InsertRequestBuilder<'a, A> {
        ...
        visibility: Option<crate::files::params::InsertVisibility>,
        alt: Option<crate::params::Alt>,
        fields: Option<String>,
        key: Option<String>,
        oauth_token: Option<String>,
    ...
    impl<'a, A: yup_oauth2::GetToken> InsertRequestBuilder<'a, A> {
        ...
        pub fn visibility(&mut self, value: crate::files::params::InsertVisibility) -> &mut Self {
            self.visibility = Some(value);
            self
        }
        #[doc = "Data format for the response."]
    ...
    pub struct ListRequestBuilder<'a, A> {
        ...
        order_by: Option<String>,
        page_token: Option<String>,
        projection: Option<crate::files::params::ListProjection>,
        q: Option<String>,
        spaces: Option<String>,
        supports_all_drives: Option<bool>,
        supports_team_drives: Option<bool>,
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        #[doc = "This parameter is deprecated and has no function."]
        pub fn projection(&mut self, value: crate::files::params::ListProjection) -> &mut Self {
            self.projection = Some(value);
            self
        }
    ...
    pub struct PatchRequestBuilder<'a, A> {
        ...
        convert: Option<bool>,
        modified_date_behavior: Option<crate::files::params::PatchModifiedDateBehavior>,
    ...
    impl<'a, A: yup_oauth2::GetToken> PatchRequestBuilder<'a, A> {
        ...
        pub fn modified_date_behavior(
            &mut self,
            value: crate::files::params::PatchModifiedDateBehavior,
        ) -> &mut Self {
        ...
        pub fn new_revision(&mut self, value: bool) -> &mut Self {
        ...
        pub fn set_modified_date(&mut self, value: bool) -> &mut Self {
    ...
    pub struct UpdateRequestBuilder<'a, A> {
        ...
        add_parents: Option<String>,
        convert: Option<bool>,
        modified_date_behavior: Option<crate::files::params::UpdateModifiedDateBehavior>,
        new_revision: Option<bool>,
        ocr: Option<bool>,
        ocr_language: Option<String>,
        pinned: Option<bool>,
    ...
    impl<'a, A: yup_oauth2::GetToken> UpdateRequestBuilder<'a, A> {
        ...
        pub fn modified_date_behavior(
            &mut self,
            value: crate::files::params::UpdateModifiedDateBehavior,
        ) -> &mut Self {
            self.modified_date_behavior = Some(value);
            self
        }
    ...
    pub struct WatchRequestBuilder<'a, A> {
        ...
        file_id: String,
        acknowledge_abuse: Option<bool>,
        projection: Option<crate::files::params::WatchProjection>,
        revision_id: Option<String>,
        supports_all_drives: Option<bool>,
        supports_team_drives: Option<bool>,
        update_viewed_date: Option<bool>,
    ...
    impl<'a, A: yup_oauth2::GetToken> WatchRequestBuilder<'a, A> {
        ...
        #[doc = "This parameter is deprecated and has no function."]
        pub fn projection(&mut self, value: crate::files::params::WatchProjection) -> &mut Self {
            self.projection = Some(value);
            self
        }
        #[doc = "Specifies the Revision ID that should be downloaded. Ignored unless alt=media is specified."]
...
pub mod parents {
    ...
    impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
        ...
        fn _path(&self) -> String {
            ...
            output.push_str(&self.parent_id);
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            let req = self.reqwest.request(::reqwest::Method::DELETE, path);
...
pub mod permissions {
    ...
    impl<'a, A: yup_oauth2::GetToken> PermissionsActions<'a, A> {
        ...
        pub fn get_id_for_email(&self, email: impl Into<String>) -> GetIdForEmailRequestBuilder<A> {
    ...
    impl<'a, A: yup_oauth2::GetToken> InsertRequestBuilder<'a, A> {
        ...
        pub fn send_notification_emails(&mut self, value: bool) -> &mut Self {
...
pub mod properties {
    ...
    impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
        ...
        pub fn visibility(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        fn _path(&self) -> String {
            ...
            output.push_str(&self.property_key);
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            let req = self.reqwest.request(::reqwest::Method::DELETE, path);
...
pub mod realtime {
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        pub fn revision(&mut self, value: i32) -> &mut Self {
    ...
    impl<'a, A: yup_oauth2::GetToken> UpdateRequestBuilder<'a, A> {
        ...
        pub fn base_revision(&mut self, value: impl Into<String>) -> &mut Self {
