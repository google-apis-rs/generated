pub mod schemas {
    ...
    pub struct BuildBazelRemoteExecutionV2BatchReadBlobsRequest {
        ...
        pub digests: Option<Vec<crate::schemas::BuildBazelRemoteExecutionV2Digest>>,
    }
    ...
    pub struct BuildBazelRemoteExecutionV2BatchReadBlobsResponse {
        ...
        pub responses:
            Option<Vec<crate::schemas::BuildBazelRemoteExecutionV2BatchReadBlobsResponseResponse>>,
    }
    ...
    pub struct BuildBazelRemoteExecutionV2BatchUpdateBlobsRequest {
        ...
        pub requests:
            Option<Vec<crate::schemas::BuildBazelRemoteExecutionV2BatchUpdateBlobsRequestRequest>>,
    }
    ...
    impl BuildBazelRemoteExecutionV2CacheCapabilitiesSymlinkAbsolutePathStrategy {
        pub fn as_str(self) -> &'static str {
            match self { BuildBazelRemoteExecutionV2CacheCapabilitiesSymlinkAbsolutePathStrategy :: Unknown => "UNKNOWN" , BuildBazelRemoteExecutionV2CacheCapabilitiesSymlinkAbsolutePathStrategy :: Disallowed => "DISALLOWED" , BuildBazelRemoteExecutionV2CacheCapabilitiesSymlinkAbsolutePathStrategy :: Allowed => "ALLOWED" , }
        }
    }
        ...
        for BuildBazelRemoteExecutionV2CacheCapabilitiesSymlinkAbsolutePathStrategy
    {
        ...
        {
            let value: &'de str = <&str>::deserialize(deserializer)?;
            Ok ( match value { "UNKNOWN" => BuildBazelRemoteExecutionV2CacheCapabilitiesSymlinkAbsolutePathStrategy :: Unknown , "DISALLOWED" => BuildBazelRemoteExecutionV2CacheCapabilitiesSymlinkAbsolutePathStrategy :: Disallowed , "ALLOWED" => BuildBazelRemoteExecutionV2CacheCapabilitiesSymlinkAbsolutePathStrategy :: Allowed , _ => return Err ( :: serde :: de :: Error :: custom ( format ! ( "invalid enum for #name: {}" , value ) ) ) , } )
        }
    }
    #[derive(
        Debug,
    ...
    pub struct BuildBazelRemoteExecutionV2CacheCapabilities {
        ...
        pub action_cache_update_capabilities:
            Option<crate::schemas::BuildBazelRemoteExecutionV2ActionCacheUpdateCapabilities>,
        ...
        pub symlink_absolute_path_strategy: Option<
    ...
    pub struct BuildBazelRemoteExecutionV2ExecuteRequest {
        ...
        pub execution_policy: Option<crate::schemas::BuildBazelRemoteExecutionV2ExecutionPolicy>,
        ...
        pub results_cache_policy:
            Option<crate::schemas::BuildBazelRemoteExecutionV2ResultsCachePolicy>,
    ...
    pub struct BuildBazelRemoteExecutionV2ExecutionCapabilities {
        ...
        #[serde(rename = "digestFunction", default)]
        pub digest_function:
            Option<crate::schemas::BuildBazelRemoteExecutionV2ExecutionCapabilitiesDigestFunction>,
    ...
    pub struct BuildBazelRemoteExecutionV2FindMissingBlobsRequest {
        ...
        pub blob_digests: Option<Vec<crate::schemas::BuildBazelRemoteExecutionV2Digest>>,
    }
    ...
    pub struct BuildBazelRemoteExecutionV2FindMissingBlobsResponse {
        ...
        pub missing_blob_digests: Option<Vec<crate::schemas::BuildBazelRemoteExecutionV2Digest>>,
    }
    ...
    pub struct BuildBazelRemoteExecutionV2GetTreeResponse {
        ...
        #[serde(rename = "directories", default)]
        pub directories: Option<Vec<crate::schemas::BuildBazelRemoteExecutionV2Directory>>,
...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn action_results(&self) -> crate::action_results::ActionResultsActions<A> {
        crate::action_results::ActionResultsActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    #[doc = "Actions that can be performed on the actions resource"]
    pub fn actions(&self) -> crate::actions::ActionsActions<A> {
        crate::actions::ActionsActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    #[doc = "Actions that can be performed on the blobs resource"]
    pub fn blobs(&self) -> crate::blobs::BlobsActions<A> {
        crate::blobs::BlobsActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
...
pub mod action_results {
    ...
    pub struct GetRequestBuilder<'a, A> {
        ...
        hash: String,
        size_bytes: i64,
        inline_output_files: Option<String>,
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        fn _path(&self) -> String {
            ...
            output.push_str("v2/");
            output.push_str(&self.instance_name);
            output.push_str("/actionResults/");
            output.push_str(&self.hash);
            output.push_str("/");
            {
                let str_value = self.size_bytes.to_string();
    ...
    impl<'a, A: yup_oauth2::GetToken> UpdateRequestBuilder<'a, A> {
        #[doc = "The priority (relative importance) of this content in the overall cache.\nGenerally, a lower value means a longer retention time or other advantage,\nbut the interpretation of a given value is server-dependent. A priority of\n0 means a *default* value, decided by the server.\n\nThe particular semantics of this field is up to the server. In particular,\nevery server will have their own supported range of priorities, and will\ndecide how these map into retention/eviction policy."]
        pub fn results_cache_policy_priority(&mut self, value: i32) -> &mut Self {
...
pub mod blobs {
    ...
    impl<'a, A: yup_oauth2::GetToken> crate::IterableMethod for GetTreeRequestBuilder<'a, A> {
