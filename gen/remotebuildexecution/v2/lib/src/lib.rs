...
pub mod schemas {
    ...
    pub struct BuildBazelRemoteExecutionV2CacheCapabilities { # [ doc = "Capabilities for updating the action cache." ] # [ serde ( rename = "actionCacheUpdateCapabilities" , default , skip_serializing_if = "std::option::Option::is_none" ) ] pub action_cache_update_capabilities : :: std :: option :: Option < crate :: schemas :: BuildBazelRemoteExecutionV2ActionCacheUpdateCapabilities > , # [ doc = "Supported cache priority range for both CAS and ActionCache." ] # [ serde ( rename = "cachePriorityCapabilities" , default , skip_serializing_if = "std::option::Option::is_none" ) ] pub cache_priority_capabilities : :: std :: option :: Option < crate :: schemas :: BuildBazelRemoteExecutionV2PriorityCapabilities > , # [ doc = "All the digest functions supported by the remote cache. Remote cache may support multiple digest functions simultaneously." ] # [ serde ( rename = "digestFunction" , default , skip_serializing_if = "std::option::Option::is_none" ) ] pub digest_function : :: std :: option :: Option < Vec < crate :: schemas :: BuildBazelRemoteExecutionV2CacheCapabilitiesDigestFunctionItems > > , # [ doc = "Maximum total size of blobs to be uploaded/downloaded using batch methods. A value of 0 means no limit is set, although in practice there will always be a message size limitation of the protocol in use, e.g. GRPC." ] # [ serde ( rename = "maxBatchTotalSizeBytes" , default , skip_serializing_if = "std::option::Option::is_none" ) ] # [ serde ( with = "crate::parsed_string" ) ] pub max_batch_total_size_bytes : :: std :: option :: Option < i64 > , # [ doc = "Compressors supported by the \"compressed-blobs\" bytestream resources. Servers MUST support identity/no-compression, even if it is not listed here. Note that this does not imply which if any compressors are supported by the server at the gRPC level." ] # [ serde ( rename = "supportedCompressor" , default , skip_serializing_if = "std::option::Option::is_none" ) ] pub supported_compressor : :: std :: option :: Option < Vec < crate :: schemas :: BuildBazelRemoteExecutionV2CacheCapabilitiesSupportedCompressorItems > > , # [ doc = "Whether absolute symlink targets are supported." ] # [ serde ( rename = "symlinkAbsolutePathStrategy" , default , skip_serializing_if = "std::option::Option::is_none" ) ] pub symlink_absolute_path_strategy : :: std :: option :: Option < crate :: schemas :: BuildBazelRemoteExecutionV2CacheCapabilitiesSymlinkAbsolutePathStrategy > , }
    ...
    pub enum BuildBazelRemoteExecutionV2CacheCapabilitiesDigestFunctionItems {
        ...
        Md5,
        #[doc = "Murmur3 128-bit digest function, x64 variant. Note that this is not a cryptographic hash function and its collision properties are not strongly guaranteed. See https://github.com/aappleby/smhasher/wiki/MurmurHash3 ."]
        Murmur3,
    ...
    impl BuildBazelRemoteExecutionV2CacheCapabilitiesDigestFunctionItems {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                BuildBazelRemoteExecutionV2CacheCapabilitiesDigestFunctionItems::Murmur3 => {
                    "MURMUR3"
                }
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum BuildBazelRemoteExecutionV2CacheCapabilitiesSupportedCompressorItems {
        #[doc = "No compression. Servers and clients MUST always support this, and do not need to advertise it."]
        Identity,
        #[doc = "Zstandard compression."]
        Zstd,
    }
    impl BuildBazelRemoteExecutionV2CacheCapabilitiesSupportedCompressorItems {
        pub fn as_str(self) -> &'static str {
            match self {
                BuildBazelRemoteExecutionV2CacheCapabilitiesSupportedCompressorItems::Identity => {
                    "IDENTITY"
                }
                BuildBazelRemoteExecutionV2CacheCapabilitiesSupportedCompressorItems::Zstd => {
                    "ZSTD"
                }
            }
        }
    ...
    impl ::std::convert::AsRef<str>
        for BuildBazelRemoteExecutionV2CacheCapabilitiesSupportedCompressorItems
    {
        fn as_ref(&self) -> &str {
            self.as_str()
        }
    }
    impl ::std::str::FromStr for BuildBazelRemoteExecutionV2CacheCapabilitiesSupportedCompressorItems {
        type Err = ();
        fn from_str(
            s: &str,
        ) -> ::std::result::Result<
            BuildBazelRemoteExecutionV2CacheCapabilitiesSupportedCompressorItems,
            (),
        > {
            Ok(match s {
                "IDENTITY" => {
    ...
    impl ::std::fmt::Display for BuildBazelRemoteExecutionV2CacheCapabilitiesSupportedCompressorItems {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            f.write_str(self.as_str())
        }
    }
    impl ::serde::Serialize for BuildBazelRemoteExecutionV2CacheCapabilitiesSupportedCompressorItems {
        fn serialize<S>(&self, serializer: S) -> ::std::result::Result<S::Ok, S::Error>
        where
            S: ::serde::ser::Serializer,
        {
    ...
    impl BuildBazelRemoteExecutionV2ExecutionCapabilitiesDigestFunction {
        pub fn as_str(self) -> &'static str {
            match self {
                ...
                BuildBazelRemoteExecutionV2ExecutionCapabilitiesDigestFunction::Murmur3 => {
                    "MURMUR3"
                }
    ...
    pub struct BuildBazelRemoteExecutionV2PriorityCapabilitiesPriorityRange {
        #[doc = "The maximum numeric value for this priority range, which represents the least urgent task or shortest retained item."]
        #[serde(
            rename = "maxPriority",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "The minimum numeric value for this priority range, which represents the most urgent task or longest retained item."]
        #[serde(
            rename = "minPriority",
            default,
            skip_serializing_if = "std::option::Option::is_none"
...
pub mod resources {
    pub mod action_results {
        ...
        impl<'a> ActionResultsActions<'a> {
            ...
            #[doc = "Retrieve a cached execution result. Implementations SHOULD ensure that any blobs referenced from the ContentAddressableStorage are available at the time of returning the ActionResult and will be for some period of time afterwards. The lifetimes of the referenced blobs SHOULD be increased if necessary and applicable. Errors: * `NOT_FOUND`: The requested `ActionResult` is not in the cache."]
            pub fn get(
                &self,
        ...
        impl<'a> GetRequestBuilder<'a> {
            #[doc = "A hint to the server to inline the contents of the listed output files. Each path needs to exactly match one file path in either `output_paths` or `output_files` (DEPRECATED since v2.1) in the Command message."]
            ...
            fn _request(
                ...
                for value in self.inline_output_files.iter().flatten() {
                    req = req.query(&[("inlineOutputFiles", value)]);
                }
                req = req.query(&[("inlineStderr", &self.inline_stderr)]);
                req = req.query(&[("inlineStdout", &self.inline_stdout)]);
