pub mod schemas {
    ...
    pub struct GoogleWatcherV1Change {
        ...
        pub resume_marker: Option<Vec<u8>>,
        #[doc = "The state of the `element`."]
        #[serde(rename = "state", default)]
        pub state: Option<crate::schemas::GoogleWatcherV1ChangeState>,
    }
    ...
    pub struct GoogleWatcherV1ChangeBatch {
        ...
        pub changes: Option<Vec<crate::schemas::GoogleWatcherV1Change>>,
    }
...
mod resources {
    ...
    pub mod v_1 {
        ...
        impl<'a, A: yup_oauth2::GetToken> WatchRequestBuilder<'a, A> {
            ...
            pub fn resume_marker(mut self, value: impl Into<Box<[u8]>>) -> Self {
                self.resume_marker = Some(value.into());
                self
            }
