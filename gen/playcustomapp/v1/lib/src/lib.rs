...
pub mod resources {
    pub mod accounts {
        ...
        impl<'a, A: ::google_api_auth::GetAccessToken> AccountsActions<'a, A> {
            ...
            pub fn custom_apps(
                &self,
            ) -> crate::resources::accounts::custom_apps::CustomAppsActions<A> {
        ...
        pub mod custom_apps {
            ...
            impl<'a, A: ::google_api_auth::GetAccessToken> CustomAppsActions<'a, A> {
            ...
            impl<'a, A: ::google_api_auth::GetAccessToken> CreateRequestBuilder<'a, A> {
                ...
                fn _path(&self) -> String {
                    let mut output =
                        "https://www.googleapis.com/playcustomapp/v1/accounts/".to_owned();
                    {
                        let var_as_string = self.account.to_string();
                        let var_as_str = &var_as_string;
                        output.extend(::percent_encoding::utf8_percent_encode(
