...
mod resources {
    pub mod activities {
        ...
        impl<'a, A: yup_oauth2::GetToken> SearchRequestBuilder<'a, A> {
            ...
            #[doc = r" populated fields in the yielded items will be determined by the"]
            #[doc = r" `FieldSelector` implementation."]
            pub fn iter_items<T>(self) -> SearchItemsIter<'a, A, T>
            where
                T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
            {
                SearchItemsIter {
            ...
            pub fn iter_items_standard(
                mut self,
            ) -> SearchItemsIter<'a, A, crate::schemas::Activity> {
                self.fields = Some(concat!("nextPageToken,", "items").to_owned());
                SearchItemsIter {
                    method: self,
                    last_page_reached: false,
            ...
            #[doc = r" all fields can be expensive both in bandwidth and server"]
            #[doc = r" resources."]
            pub fn iter_items_debug(mut self) -> SearchItemsIter<'a, A, crate::schemas::Activity> {
                self.fields = Some(concat!("nextPageToken,", "items", "(*)").to_owned());
                SearchItemsIter {
                    method: self,
                    last_page_reached: false,
        ...
        pub struct SearchItemsIter<'a, A, T> {
            method: SearchRequestBuilder<'a, A>,
            last_page_reached: bool,
            items_iter: Option<::std::vec::IntoIter<T>>,
        }
        impl<'a, A, T> Iterator for SearchItemsIter<'a, A, T>
        where
            A: ::yup_oauth2::GetToken,
            T: ::serde::de::DeserializeOwned,
        {
    ...
    pub mod people {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            #[doc = r" fields in `#items_type` will be the default fields populated by"]
            #[doc = r" the server."]
            pub fn iter_items_standard(mut self) -> ListItemsIter<'a, A, crate::schemas::Person> {
                self.fields = Some(concat!("nextPageToken,", "items").to_owned());
                ListItemsIter {
                    method: self,
                    last_page_reached: false,
            ...
            #[doc = r" all fields can be expensive both in bandwidth and server"]
            #[doc = r" resources."]
            pub fn iter_items_debug(mut self) -> ListItemsIter<'a, A, crate::schemas::Person> {
                self.fields = Some(concat!("nextPageToken,", "items", "(*)").to_owned());
                ListItemsIter {
                    method: self,
                    last_page_reached: false,
        ...
        impl<'a, A: yup_oauth2::GetToken> ListByActivityRequestBuilder<'a, A> {
            ...
            #[doc = r" populated fields in the yielded items will be determined by the"]
            #[doc = r" `FieldSelector` implementation."]
            pub fn iter_items<T>(self) -> ListByActivityItemsIter<'a, A, T>
            where
                T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
            {
                ListByActivityItemsIter {
                    method: self,
                    last_page_reached: false,
                    items_iter: None,
                }
            ...
            pub fn iter_items_standard(
                mut self,
            ) -> ListByActivityItemsIter<'a, A, crate::schemas::Person> {
                self.fields = Some(concat!("nextPageToken,", "items").to_owned());
                ListByActivityItemsIter {
                    method: self,
                    last_page_reached: false,
        ...
        pub struct ListByActivityItemsIter<'a, A, T> {
            method: ListByActivityRequestBuilder<'a, A>,
            last_page_reached: bool,
            items_iter: Option<::std::vec::IntoIter<T>>,
        }
        impl<'a, A, T> Iterator for ListByActivityItemsIter<'a, A, T>
        where
            A: ::yup_oauth2::GetToken,
            T: ::serde::de::DeserializeOwned,
        {
        ...
        impl<'a, A: yup_oauth2::GetToken> SearchRequestBuilder<'a, A> {
            ...
            #[doc = r" fields in `#items_type` will be the default fields populated by"]
            #[doc = r" the server."]
            pub fn iter_items_standard(mut self) -> SearchItemsIter<'a, A, crate::schemas::Person> {
                self.fields = Some(concat!("nextPageToken,", "items").to_owned());
                SearchItemsIter {
                    method: self,
                    last_page_reached: false,
            ...
            #[doc = r" all fields can be expensive both in bandwidth and server"]
            #[doc = r" resources."]
            pub fn iter_items_debug(mut self) -> SearchItemsIter<'a, A, crate::schemas::Person> {
                self.fields = Some(concat!("nextPageToken,", "items", "(*)").to_owned());
                SearchItemsIter {
                    method: self,
                    last_page_reached: false,
