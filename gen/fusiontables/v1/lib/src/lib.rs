...
pub mod resources {
    pub mod column {
        ...
        impl<'a, A: ::google_api_auth::GetAccessToken> DeleteRequestBuilder<'a, A> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://www.googleapis.com/fusiontables/v1/".to_owned();
        ...
        impl<'a, A: ::google_api_auth::GetAccessToken> ListRequestBuilder<'a, A> {
            #[doc = "Maximum number of columns to return. Optional. Default is 5."]
    ...
    pub mod query {
        ...
        impl<'a, A: ::google_api_auth::GetAccessToken> QueryActions<'a, A> {
            #[doc = "Executes an SQL SELECT/INSERT/UPDATE/DELETE/SHOW/DESCRIBE/CREATE statement."]
            ...
            #[doc = "Executes an SQL SELECT/SHOW/DESCRIBE statement."]
        ...
        impl<'a, A: ::google_api_auth::GetAccessToken> SqlRequestBuilder<'a, A> {
            #[doc = "Should column names be included (in the first row)?. Default is true."]
            pub fn hdrs(mut self, value: bool) -> Self {
                self.hdrs = Some(value);
                self
            }
            #[doc = "Should typed values be returned in the (JSON) response -- numbers for numeric values and parsed geometries for KML values? Default is true."]
            ...
            fn _download_path(&self) -> String {
                let mut output = "https://www.googleapis.com/fusiontables/v1/download/".to_owned();
    ...
    pub mod table {
        ...
        impl<'a, A: ::google_api_auth::GetAccessToken> TableActions<'a, A> {
            ...
            #[doc = "Import more rows into a table."]
        ...
        impl<'a, A: ::google_api_auth::GetAccessToken> ImportRowsRequestBuilder<'a, A> {
            ...
            #[doc = "The index of the last line from which to start importing, exclusive. Thus, the number of imported lines is endLine - startLine. If this parameter is not provided, the file will be imported until the last line of the file. If endLine is negative, then the imported content will exclude the last endLine lines. That is, if endline is negative, no line will be imported whose index is greater than N + endLine where N is the number of lines in the file, and the number of imported lines will be N + endLine - startLine."]
            pub fn end_line(mut self, value: i32) -> Self {
                self.end_line = Some(value);
                self
            }
            #[doc = "Whether the CSV must have the same number of values for each row. If false, rows with fewer values will be padded with empty values. Default is true."]
            ...
            fn _simple_upload_path(&self) -> String {
                ...
                output.push_str("upload/fusiontables/v1/tables/");
                {
                    let var_as_str = &self.table_id;
                    output.extend(::percent_encoding::utf8_percent_encode(
                        &var_as_str,
            ...
            fn _resumable_upload_path(&self) -> String {
                let mut output = "https://www.googleapis.com/".to_owned();
                output.push_str("resumable/upload/fusiontables/v1/tables/");
                {
                    let var_as_str = &self.table_id;
                    output.extend(::percent_encoding::utf8_percent_encode(
                        &var_as_str,
        ...
        impl<'a, A: ::google_api_auth::GetAccessToken> ImportTableRequestBuilder<'a, A> {
            ...
            fn _simple_upload_path(&self) -> String {
                let mut output = "https://www.googleapis.com/".to_owned();
                output.push_str("upload/fusiontables/v1/tables/import");
                output
            }
            pub fn upload<T, R>(
                mut self,
            ...
            fn _resumable_upload_path(&self) -> String {
                let mut output = "https://www.googleapis.com/".to_owned();
                output.push_str("resumable/upload/fusiontables/v1/tables/import");
                output
            }
            pub fn start_resumable_upload(
                self,
        ...
        impl<'a, A: ::google_api_auth::GetAccessToken> PatchRequestBuilder<'a, A> {
            #[doc = "Should the view definition also be updated? The specified view definition replaces the existing one. Only a view can be updated with a new definition."]
    ...
    pub mod task {
        ...
        impl<'a, A: ::google_api_auth::GetAccessToken> TaskActions<'a, A> {
            #[doc = "Deletes the task, unless already started."]
            pub fn delete(
                &self,
                table_id: impl Into<String>,
