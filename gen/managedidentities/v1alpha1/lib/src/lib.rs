...
pub mod schemas {
    ...
    pub struct Domain {
        ...
        #[doc = "Output only. The time the instance was created. Synthetic field is\npopulated automatically by CCFE. go/ccfe-synthetic-field-user-guide"]
        #[serde(
            rename = "createTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Output only. Fully-qualified domain name of the exposed domain used by\nclients to connect to the service. Similar to what would be chosen for an\nActive Directory that is set up on an internal network."]
        #[serde(
            rename = "fqdn",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Required. Locations where domain needs to be provisioned.\nregions\ne.g. us-west1 or us-east4\nService supports up to 4 locations at once. Each location will use a /26\nblock."]
        #[serde(
            rename = "locations",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Optional. Name of customer-visible admin used to perform Active Directory\noperations. If not specified `setupadmin` would be used."]
        #[serde(
        ...
        #[doc = "Output only. Unique name of the domain in this scope including projects and\nlocation using the form:\n`projects/{project_id}/locations/global/domains/{domain_name}`."]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Required. The CIDR range of internal addresses that are reserved for this\ndomain. Reserved networks must be /24 or larger. Ranges must be\nunique and non-overlapping with existing subnets in\n[Domain].[authorized_networks]."]
        #[serde(
        ...
        #[doc = "Output only. Last update time. Synthetic field is populated automatically\nby CCFE."]
        #[serde(
            rename = "updateTime",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub enum DomainState {
        ...
        Ready,
        #[doc = "ManagedIdentities domain is being repaired and may be unusable. Details\ncan be found in the `status_message` field."]
        Repairing,
        #[doc = "Not set."]
        StateUnspecified,
    ...
    pub struct Trust {
        ...
        pub create_time: ::std::option::Option<String>,
        #[doc = "Output only. The last heartbeat time when the trust was known to be\nconnected."]
        #[serde(
        ...
        #[doc = "The trust authentication type which decides whether the trusted side has\nforest/domain wide access or selective access to approved set of resources."]
        #[serde(
        ...
        #[doc = "Output only. Additional information about the current state of this\ntrust, if available."]
        #[serde(
        ...
        #[doc = "The target dns server ip addresses which can resolve the remote domain\ninvolved in trust."]
        #[serde(
        ...
        #[doc = "The fully qualified target domain name which will be in trust with current\ndomain."]
        #[serde(
        ...
        #[doc = "The trust direction decides the current domain is trusted, trusting or\nboth."]
        #[serde(
        ...
        #[doc = "Input only, and will not be stored. The trust secret used for handshake\nwith target domain."]
        #[serde(
            ...
            pub mod global {
                ...
                pub mod domains {
                    ...
                    impl<'a> DomainsActions<'a> {
                        ...
                        #[doc = "Adds AD trust in a given domain.\nOperation<response: google.protobuf.Empty>"]
                        pub fn attach_trust(
                            &self,
                        ...
                        #[doc = "Creates a Microsoft AD Domain in a given project.\nOperation<response: google.protobuf.Empty>"]
                        pub fn create(
                            &self,
                        ...
                        #[doc = "Updates the metadata and configuration of a specified domain.\nOperation<response: google.protobuf.Empty>"]
                        pub fn patch(
                            &self,
                            request: crate::schemas::Domain,
                            name: impl Into<String>,
                        ...
                        #[doc = "Resets managed identities admin password identified by\nmanaged_identities_admin_name"]
                    ...
                    impl<'a> CreateRequestBuilder<'a> {
                        ...
                        {
                            let req = self.reqwest.request(::reqwest::Method::POST, path);
                            let req = req.query(&[("domainName", &self.domain_name)]);
                            let req = req.query(&[("access_token", &self.access_token)]);
                            let req = req.query(&[("alt", &self.alt)]);
                            let req = req.query(&[("callback", &self.callback)]);
                            let req = req.query(&[("fields", &self.fields)]);
                    ...
                    impl<'a> ListRequestBuilder<'a> {
                        ...
                        #[doc = "If not specified, a default value of 1000 will be used by the service.\nRegardless of the page_size value, the response may include a partial list\nand a caller should only rely on response's\nnext_page_token\nto determine if there are more instances left to be queried."]
                        pub fn page_size(mut self, value: i32) -> Self {
                            self.page_size = Some(value);
                            self
                        }
