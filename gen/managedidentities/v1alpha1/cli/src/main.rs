...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        ...
        {
            let mcmd = SubCommand::with_name("attach_trust").about(
                "Adds AD trust in a given domain.\nOperation<response: google.protobuf.Empty>",
            );
            domains3 = domains3.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("create").about("Creates a Microsoft AD Domain in a given project.\nOperation<response: google.protobuf.Empty>");
            domains3 = domains3.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("delete")
                .about("Deletes identified domain.\nOperation<response: google.protobuf.Empty>");
            domains3 = domains3.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("detach_trust")
                .about("Removes identified trust.\nOperation<response: google.protobuf.Empty>");
            domains3 = domains3.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("patch").about("Updates the metadata and configuration of a specified domain.\nOperation<response: google.protobuf.Empty>");
            domains3 = domains3.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("reconfigure_trust").about("Updates the dns conditional forwarder.\nOperation<response: google.protobuf.Empty>");
            domains3 = domains3.subcommand(mcmd);
        }
        {
            let mcmd = SubCommand::with_name("reset_admin_password").about("Resets managed identities admin password identified by\nmanaged_identities_admin_name");
            domains3 = domains3.subcommand(mcmd);
        }
        {
        ...
        {
            let mcmd = SubCommand::with_name("validate_trust")
                .about("Validate the trust state\nOperation<response: google.protobuf.Empty>");
            domains3 = domains3.subcommand(mcmd);
        }
