...
pub mod schemas {
    ...
    pub struct GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule {
        #[doc = "This field will be deprecated, and will be always set to true since reschedule can happen multiple times now."]
        #[serde(
