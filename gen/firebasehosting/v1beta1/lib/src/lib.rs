pub mod schemas {
    ...
    pub enum DomainStatus {
        ...
        #[doc = "An operation is in progress on the domain association and no further\noperations can be performed until it is complete."]
        DomainChangePending,
...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn sites(&self) -> crate::resources::sites::SitesActions<A> {
...
mod resources {
    pub mod sites {
        pub mod params {}
        pub struct SitesActions<'a, A> {
            pub(crate) reqwest: &'a reqwest::Client,
            pub(crate) auth: &'a std::sync::Mutex<A>,
        }
        impl<'a, A: yup_oauth2::GetToken> SitesActions<'a, A> {
            ...
            pub fn domains(&self) -> crate::resources::sites::domains::DomainsActions<A> {
            ...
            pub fn releases(&self) -> crate::resources::sites::releases::ReleasesActions<A> {
            ...
            pub fn versions(&self) -> crate::resources::sites::versions::VersionsActions<A> {
        ...
        impl<'a, A: yup_oauth2::GetToken> GetConfigRequestBuilder<'a, A> {
            ...
            pub fn execute_standard(
                self,
            ) -> Result<crate::schemas::SiteConfig, Box<dyn ::std::error::Error>> {
        ...
        #[derive(Debug, Clone)]
        pub struct UpdateConfigRequestBuilder<'a, A> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a ::std::sync::Mutex<A>,
            request: crate::schemas::SiteConfig,
            name: String,
        ...
        impl<'a, A: yup_oauth2::GetToken> UpdateConfigRequestBuilder<'a, A> {
        ...
        pub mod domains {
            ...
            impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::Domain, Box<dyn ::std::error::Error>> {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                pub fn iter_domains_standard(
                    mut self,
                ) -> ListDomainsIter<'a, A, crate::schemas::Domain> {
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::ListDomainsResponse, Box<dyn ::std::error::Error>>
                {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
        ...
        pub mod releases {
            ...
            impl<'a, A: yup_oauth2::GetToken> ReleasesActions<'a, A> {
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_releases<T>(self) -> ListReleasesIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListReleasesIter {
                ...
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_releases_standard(
                    mut self,
                ) -> ListReleasesIter<'a, A, crate::schemas::Release> {
                    self.fields = Some(concat!("nextPageToken,", "releases").to_owned());
                    ListReleasesIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
            ...
            pub struct ListReleasesIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListReleasesIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
        ...
        pub mod versions {
            ...
            impl<'a, A: yup_oauth2::GetToken> VersionsActions<'a, A> {
                ...
                pub fn files(&self) -> crate::resources::sites::versions::files::FilesActions<A> {
            ...
            #[derive(Debug, Clone)]
            pub struct PopulateFilesRequestBuilder<'a, A> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a ::std::sync::Mutex<A>,
                request: crate::schemas::PopulateVersionFilesRequest,
                parent: String,
            ...
            impl<'a, A: yup_oauth2::GetToken> PopulateFilesRequestBuilder<'a, A> {
                #[doc = "OAuth access token."]
                pub fn access_token(mut self, value: impl Into<String>) -> Self {
                    self.access_token = Some(value.into());
                    self
                ...
                pub fn execute_standard(
                    ...
                    crate::schemas::PopulateVersionFilesResponse,
            ...
            pub mod files {
                ...
                impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                    ...
                    #[doc = r" fields in `#items_type` will be the default fields populated by"]
                    #[doc = r" the server."]
                    pub fn iter_files_standard(
                        mut self,
                    ) -> ListFilesIter<'a, A, crate::schemas::VersionFile> {
                    ...
                    pub fn execute_standard(
                        ...
                        crate::schemas::ListVersionFilesResponse,
                        Box<dyn ::std::error::Error>,
                    > {
                        self.execute_fields::<_, &str>(None)
                    }
