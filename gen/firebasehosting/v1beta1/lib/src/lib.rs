...
pub mod schemas {
    ...
    pub struct Channel {
        ...
        #[doc = "The fully-qualified identifier for the channel, in the format: sites/ SITE_NAME/channels/CHANNEL_ID"]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct CloneVersionRequest {
        ...
        #[doc = "Required. The unique identifier for the version to be cloned, in the format: sites/SITE_NAME/versions/VERSION_ID"]
        #[serde(
    ...
    pub struct ListSitesResponse {
        #[doc = "A token returned when the list of results is too large to fit in a single response. If the string is empty, the response is the last or only page of results. Use the token in a follow-up call to `ListSites` to find the next group of Sites. Page tokens are short-lived and should not be stored."]
        #[serde(
            rename = "nextPageToken",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub next_page_token: ::std::option::Option<String>,
        #[doc = "A list of Site objects from the parent Firebase Project."]
        #[serde(
            rename = "sites",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct Site {
        #[doc = "Optional. The ID of a Web App associated with the Site."]
        #[serde(
            rename = "appId",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        #[doc = "Output only. The default URL for this Hosting Site."]
        #[serde(
            rename = "defaultUrl",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub labels: ::std::option::Option<::std::collections::BTreeMap<String, String>>,
        #[doc = "Output only. The fully qualified resource name of the Hosting Site, e.g.: `projects/{project-number}/sites/{site-id}`."]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
        ...
        pub name: ::std::option::Option<String>,
        #[doc = "Output only. The Hosting site type. There will always be a single DEFAULT_SITE, which is created when Hosting is provisioned. All additional sites are USER_SITE."]
        #[serde(
            rename = "type",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    #[derive(Debug, Clone, PartialEq, Hash, PartialOrd, Ord, Eq, Copy)]
    pub enum SiteType {
        #[doc = "The default hosting site that is provisioned when a project is created."]
        DefaultSite,
    ...
    pub struct Version {
        ...
        pub labels: ::std::option::Option<::std::collections::BTreeMap<String, String>>,
        #[doc = "The fully-qualified identifier for the version, in the format: sites/ SITE_NAME/versions/VERSION_ID This name is provided in the response body when you call [`CreateVersion`](sites.versions/create)."]
        #[serde(
            rename = "name",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub mod projects {
        ...
        pub mod sites {
            ...
            impl<'a> SitesActions<'a> {
                ...
                #[doc = "Creates a new Site. Sites take several minutes to propagate through Firebase systems."]
                pub fn create(
                    &self,
                ...
                #[doc = "Deletes a Site from the specified parent Project."]
                ...
                #[doc = "Gets the Site identified by the specified resource name."]
                pub fn get(&self, name: impl Into<String>) -> GetRequestBuilder {
                    GetRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                ...
                #[doc = "Lists each Site associated with the specified parent Project. Sites are returned in a consistent, but undefined, order to facilitate pagination. Site data might be out of sync by a few seconds. If you require up-to-date data, use GetSite."]
                ...
                #[doc = "Updates attributes of the Site identified by the specified resource name."]
                pub fn patch(
                    &self,
                    request: crate::schemas::Site,
            ...
            impl<'a> CreateRequestBuilder<'a> {
                #[doc = "Required. Immutable. A globally unique ID to identify the Site. The ID must also be a valid domain name label."]
            ...
            impl<'a> ListRequestBuilder<'a> {
                #[doc = "Optional. The maximum number of sites to return in the response. The server may return fewer Sites at its discretion. If you don't specify a value or specify one that's too large, the server can select its own value."]
            ...
            impl<'a> PatchRequestBuilder<'a> {
                #[doc = "A mask that specifies which Site fields to update."]
