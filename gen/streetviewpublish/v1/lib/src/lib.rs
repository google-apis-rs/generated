...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn photo(&self) -> crate::resources::photo::PhotoActions<A> {
    ...
    pub fn photos(&self) -> crate::resources::photos::PhotosActions<A> {
...
mod resources {
    pub mod photo {
        ...
        impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
            ...
            pub fn execute_standard(
                self,
            ) -> Result<crate::schemas::Photo, Box<dyn ::std::error::Error>> {
            ...
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                ...
                let fut = auth.token(vec!["https://www.googleapis.com/auth/streetviewpublish"]);
    ...
    pub mod photos {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn iter_photos<T>(self) -> ListPhotosIter<'a, A, T>
            where
                T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
            {
                ListPhotosIter {
            ...
            #[doc = r" the server."]
            pub fn iter_photos_standard(mut self) -> ListPhotosIter<'a, A, crate::schemas::Photo> {
                self.fields = Some(concat!("nextPageToken,", "photos").to_owned());
                ListPhotosIter {
                    method: self,
                    last_page_reached: false,
                    items_iter: None,
            ...
            #[doc = r" resources."]
            pub fn iter_photos_debug(mut self) -> ListPhotosIter<'a, A, crate::schemas::Photo> {
                self.fields = Some(concat!("nextPageToken,", "photos", "(*)").to_owned());
                ListPhotosIter {
                    method: self,
                    last_page_reached: false,
        ...
        pub struct ListPhotosIter<'a, A, T> {
            method: ListRequestBuilder<'a, A>,
            last_page_reached: bool,
            items_iter: Option<::std::vec::IntoIter<T>>,
        }
        impl<'a, A, T> Iterator for ListPhotosIter<'a, A, T>
        where
