...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        let mut app = App::new("storage1_beta1")
            ...
            .about("methods: delete, get, insert, list, patch and update");
        {
            let mcmd = SubCommand::with_name("delete")
                .about("Deletes the ACL entry for the specified entity on the specified bucket.");
        ...
        let mut buckets0 = SubCommand::with_name("buckets")
            ...
            .about("methods: delete, get, insert, list, patch and update");
        {
            let mcmd = SubCommand::with_name("delete").about("Deletes an empty bucket.");
        ...
        {
            let mcmd = SubCommand::with_name("delete")
                .about("Deletes the ACL entry for the specified entity on the specified object.");
        ...
        {
            let mcmd = SubCommand::with_name("delete")
                .about("Deletes data blobs and associated metadata.");
...
use google_storage1_beta1 as api;
