...
pub mod schemas {
    ...
    impl ::google_field_selector::FieldSelector for ObjectMedia {
        fn fields() -> Vec<::google_field_selector::Field> {
            Vec::new()
        }
    }
    impl ::google_field_selector::ToFieldType for ObjectMedia {
        fn field_type() -> ::google_field_selector::FieldType {
            ::google_field_selector::FieldType::Leaf
        }
    }
...
pub mod resources {
    pub mod bucket_access_controls {
        ...
        impl<'a> DeleteRequestBuilder<'a> {
            ...
            fn _path(&self) -> String {
                let mut output = "https://storage.googleapis.com/storage/v1beta1/".to_owned();
                output.push_str("b/");
                {
    ...
    pub mod buckets {
        ...
        impl<'a> BucketsActions<'a> {
            ...
            pub fn insert(&self, request: crate::schemas::Bucket) -> InsertRequestBuilder {
                InsertRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                    request,
            ...
            pub fn list(&self, project_id: u64) -> ListRequestBuilder {
                ListRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                    alt: None,
    ...
    pub mod objects {
        ...
        impl<'a> GetRequestBuilder<'a> {
            ...
            fn _download_path(&self) -> String {
                let mut output =
                    "https://storage.googleapis.com/storage/v1beta1/download/".to_owned();
                output.push_str("b/");
                {
                    let var_as_str = &self.bucket;
                    output.extend(::percent_encoding::utf8_percent_encode(
