pub mod schemas {
    ...
    pub struct Asset {
        ...
        pub iam_policy: Option<crate::schemas::IamPolicy>,
        ...
        pub resource_properties: Option<::std::collections::BTreeMap<String, ::serde_json::Value>>,
        #[doc = "Cloud SCC managed properties. These properties are managed by\nCloud SCC and cannot be modified by the user."]
        #[serde(rename = "securityCenterProperties", default)]
        pub security_center_properties: Option<crate::schemas::SecurityCenterProperties>,
        ...
        pub security_marks: Option<crate::schemas::SecurityMarks>,
    ...
    pub struct AssetDiscoveryConfig {
        ...
        pub inclusion_mode: Option<crate::schemas::AssetDiscoveryConfigInclusionMode>,
    ...
    pub struct Finding {
        ...
        pub source_properties: Option<::std::collections::BTreeMap<String, ::serde_json::Value>>,
        #[doc = "The state of the finding."]
        #[serde(rename = "state", default)]
        pub state: Option<crate::schemas::FindingState>,
    }
    ...
    impl GoogleCloudSecuritycenterV1Beta1RunAssetDiscoveryResponseState {
        pub fn as_str(self) -> &'static str {
            match self { GoogleCloudSecuritycenterV1Beta1RunAssetDiscoveryResponseState :: StateUnspecified => "STATE_UNSPECIFIED" , GoogleCloudSecuritycenterV1Beta1RunAssetDiscoveryResponseState :: Completed => "COMPLETED" , GoogleCloudSecuritycenterV1Beta1RunAssetDiscoveryResponseState :: Superseded => "SUPERSEDED" , GoogleCloudSecuritycenterV1Beta1RunAssetDiscoveryResponseState :: Terminated => "TERMINATED" , }
        }
    }
    ...
    pub struct GoogleCloudSecuritycenterV1Beta1RunAssetDiscoveryResponse {
        ...
        #[serde(rename = "state", default)]
        pub state:
            Option<crate::schemas::GoogleCloudSecuritycenterV1Beta1RunAssetDiscoveryResponseState>,
    }
    ...
    pub struct GoogleCloudSecuritycenterV1RunAssetDiscoveryResponse {
        ...
        #[serde(rename = "state", default)]
        pub state:
            Option<crate::schemas::GoogleCloudSecuritycenterV1RunAssetDiscoveryResponseState>,
    }
    ...
    pub struct GroupAssetsResponse {
        ...
        pub group_by_results: Option<Vec<crate::schemas::GroupResult>>,
    ...
    pub struct ListAssetsResponse {
        ...
        pub list_assets_results: Option<Vec<crate::schemas::ListAssetsResult>>,
        #[doc = "Token to retrieve the next page of results, or empty if there are no more\nresults."]
        #[serde(rename = "nextPageToken", default)]
        pub next_page_token: Option<String>,
    ...
    pub struct ListAssetsResult {
        ...
        pub state_change: Option<crate::schemas::ListAssetsResultStateChange>,
    }
    ...
    pub struct ListFindingsResponse {
        ...
        pub list_findings_results: Option<Vec<crate::schemas::ListFindingsResult>>,
        #[doc = "Token to retrieve the next page of results, or empty if there are no more\nresults."]
        #[serde(rename = "nextPageToken", default)]
        pub next_page_token: Option<String>,
        #[doc = "Time used for executing the list request."]
    ...
    pub struct ListFindingsResult {
        ...
        pub finding: Option<crate::schemas::Finding>,
        #[doc = "State change of the finding between the points in time."]
        #[serde(rename = "stateChange", default)]
        pub state_change: Option<crate::schemas::ListFindingsResultStateChange>,
    }
    ...
    pub struct OrganizationSettings {
        ...
        pub asset_discovery_config: Option<crate::schemas::AssetDiscoveryConfig>,
    ...
    pub struct SecurityMarks {
        ...
        pub marks: Option<::std::collections::BTreeMap<String, String>>,
    ...
    pub struct SetFindingStateRequest {
        ...
        #[serde(rename = "state", default)]
        pub state: Option<crate::schemas::SetFindingStateRequestState>,
    }
    ...
    pub mod organizations {
        ...
        pub mod assets {
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                pub fn iter_list_assets_results<T>(self) -> ListListAssetsResultsIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListListAssetsResultsIter {
                        method: self,
                ...
                pub fn iter_list_assets_results_standard(
                    mut self,
                ) -> ListListAssetsResultsIter<'a, A, crate::schemas::ListAssetsResult>
                {
            ...
            pub struct ListListAssetsResultsIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListListAssetsResultsIter<'a, A, T>
            where
        ...
        pub mod sources {
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_sources<T>(self) -> ListSourcesIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListSourcesIter {
                ...
                pub fn iter_sources_standard(
                    mut self,
                ) -> ListSourcesIter<'a, A, crate::schemas::Source> {
            ...
            pub struct ListSourcesIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListSourcesIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
            ...
            pub mod findings {
                ...
                impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                    ...
                    pub fn iter_list_findings_results<T>(
                        self,
                    ) -> ListListFindingsResultsIter<'a, A, T>
                    where
                        T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                    {
                        ListListFindingsResultsIter {
                            method: self,
                            last_page_reached: false,
                            items_iter: None,
                        }
                    ...
                    pub fn iter_list_findings_results_standard(
                        mut self,
                    ) -> ListListFindingsResultsIter<'a, A, crate::schemas::ListFindingsResult>
                    {
                        self.fields =
                ...
                pub struct ListListFindingsResultsIter<'a, A, T> {
                    method: ListRequestBuilder<'a, A>,
                    last_page_reached: bool,
                    items_iter: Option<::std::vec::IntoIter<T>>,
                }
                impl<'a, A, T> Iterator for ListListFindingsResultsIter<'a, A, T>
                where
                    A: ::yup_oauth2::GetToken,
                    T: ::serde::de::DeserializeOwned,
                {
