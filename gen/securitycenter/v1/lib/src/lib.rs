...
pub mod schemas {
    ...
    pub struct AssetDiscoveryConfig {
        ...
        pub folder_ids: ::std::option::Option<Vec<String>>,
...
pub mod resources {
    pub mod folders {
        ...
        impl<'a> FoldersActions<'a> {
            ...
            pub fn assets(&self) -> crate::resources::folders::assets::AssetsActions {
                crate::resources::folders::assets::AssetsActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
            #[doc = "Actions that can be performed on the sources resource"]
            pub fn sources(&self) -> crate::resources::folders::sources::SourcesActions {
                crate::resources::folders::sources::SourcesActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
        ...
        pub mod sources {
            ...
            impl<'a> SourcesActions<'a> {
                ...
                pub fn findings(
                    &self,
                ) -> crate::resources::folders::sources::findings::FindingsActions {
                    crate::resources::folders::sources::findings::FindingsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
                    }
            ...
            pub mod findings {
                ...
                impl<'a> FindingsActions<'a> {
                    ...
                    #[doc = "Filters an organization or source's findings and groups them by their specified properties. To group across all sources provide a `-` as the source id. Example: /v1/organizations/{organization_id}/sources/-/findings, /v1/folders/{folder_id}/sources/-/findings, /v1/projects/{project_id}/sources/-/findings"]
                    pub fn group(
                        &self,
                    ...
                    #[doc = "Lists an organization or source's findings. To list across all sources provide a `-` as the source id. Example: /v1/organizations/{organization_id}/sources/-/findings"]
                    pub fn list(&self, parent: impl Into<String>) -> ListRequestBuilder {
                        ListRequestBuilder {
                            reqwest: &self.reqwest,
                            auth: self.auth_ref(),
    ...
    pub mod organizations {
        ...
        pub mod notification_configs {
            ...
            impl<'a> NotificationConfigsActions<'a> {
                ...
                #[doc = "Updates a notification config. The following update fields are allowed: description, pubsub_topic, streaming_config.filter"]
                pub fn patch(
                    &self,
                    request: crate::schemas::NotificationConfig,
                    name: impl Into<String>,
    ...
    pub mod projects {
        ...
        impl<'a> ProjectsActions<'a> {
            ...
            #[doc = "Actions that can be performed on the assets resource"]
            pub fn assets(&self) -> crate::resources::projects::assets::AssetsActions {
                crate::resources::projects::assets::AssetsActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
            #[doc = "Actions that can be performed on the sources resource"]
            pub fn sources(&self) -> crate::resources::projects::sources::SourcesActions {
                crate::resources::projects::sources::SourcesActions {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
                }
            }
        ...
        pub mod sources {
            ...
            impl<'a> SourcesActions<'a> {
                ...
                pub fn findings(
                    &self,
                ) -> crate::resources::projects::sources::findings::FindingsActions
                {
                    crate::resources::projects::sources::findings::FindingsActions {
                        reqwest: &self.reqwest,
                        auth: self.auth_ref(),
