pub mod schemas {
    ...
    pub struct Breakpoint {
        ...
        pub action: Option<crate::schemas::BreakpointAction>,
        ...
        pub evaluated_expressions: Option<Vec<crate::schemas::Variable>>,
        ...
        pub location: Option<crate::schemas::SourceLocation>,
        #[doc = "Indicates the severity of the log. Only relevant when action is `LOG`."]
        #[serde(rename = "logLevel", default)]
        pub log_level: Option<crate::schemas::BreakpointLogLevel>,
        ...
        pub variable_table: Option<Vec<crate::schemas::Variable>>,
    }
    ...
    impl ::field_selector::FieldSelector for CloudWorkspaceId {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct CloudWorkspaceSourceContext {
        ...
        pub workspace_id: Option<crate::schemas::CloudWorkspaceId>,
    }
    impl ::field_selector::FieldSelector for CloudWorkspaceSourceContext {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct Debuggee {
        ...
        pub ext_source_contexts: Option<Vec<crate::schemas::ExtendedSourceContext>>,
        ...
        pub source_contexts: Option<Vec<crate::schemas::SourceContext>>,
    ...
    impl ::field_selector::FieldSelector for Debuggee {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for ExtendedSourceContext {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for FormatMessage {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GetBreakpointResponse {
        ...
        pub breakpoint: Option<crate::schemas::Breakpoint>,
    }
    impl ::field_selector::FieldSelector for GetBreakpointResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListActiveBreakpointsResponse {
        ...
        pub breakpoints: Option<Vec<crate::schemas::Breakpoint>>,
    ...
    impl ::field_selector::FieldSelector for ListActiveBreakpointsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for ListBreakpointsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListDebuggeesResponse {
        ...
        pub debuggees: Option<Vec<crate::schemas::Debuggee>>,
    }
    impl ::field_selector::FieldSelector for ListDebuggeesResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct RegisterDebuggeeRequest {
        ...
        pub debuggee: Option<crate::schemas::Debuggee>,
    }
    impl ::field_selector::FieldSelector for RegisterDebuggeeRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for RegisterDebuggeeResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for SetBreakpointResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct SourceContext {
        ...
        pub cloud_workspace: Option<crate::schemas::CloudWorkspaceSourceContext>,
    ...
    pub struct StackFrame {
        ...
        pub arguments: Option<Vec<crate::schemas::Variable>>,
        ...
        pub locals: Option<Vec<crate::schemas::Variable>>,
    ...
    pub struct StatusMessage {
        ...
        #[serde(rename = "description", default)]
        pub description: Option<crate::schemas::FormatMessage>,
        ...
        pub refers_to: Option<crate::schemas::StatusMessageRefersTo>,
    }
    ...
    impl ::field_selector::FieldSelector for UpdateActiveBreakpointRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for UpdateActiveBreakpointResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {}
    }
    #[derive(
        Debug,
    ...
    pub struct Variable {
        ...
        pub members: Option<Vec<crate::schemas::Variable>>,
...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn controller(&self) -> crate::controller::ControllerActions<A> {
        crate::controller::ControllerActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    #[doc = "Actions that can be performed on the debugger resource"]
    pub fn debugger(&self) -> crate::debugger::DebuggerActions<A> {
        crate::debugger::DebuggerActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
...
pub mod controller {
    pub mod params {}
    pub struct ControllerActions<'a, A> {
        pub(super) reqwest: &'a reqwest::Client,
        pub(super) auth: &'a std::sync::Mutex<A>,
    }
    impl<'a, A: yup_oauth2::GetToken> ControllerActions<'a, A> {
        #[doc = "Actions that can be performed on the debuggees resource"]
        pub fn debuggees(&self) -> debuggees::DebuggeesActions<A> {
            debuggees::DebuggeesActions
        }
    }
    pub mod debuggees {
        pub mod params {}
        pub struct DebuggeesActions<'a, A> {
            pub(super) reqwest: &'a reqwest::Client,
            pub(super) auth: &'a std::sync::Mutex<A>,
        }
        impl<'a, A: yup_oauth2::GetToken> DebuggeesActions<'a, A> {
            ...
            pub fn breakpoints(&self) -> breakpoints::BreakpointsActions<A> {
                breakpoints::BreakpointsActions
            }
        }
        #[derive(Debug, Clone)]
        ...
        impl<'a, A: yup_oauth2::GetToken> RegisterRequestBuilder<'a, A> {
            ...
            pub fn execute_debug(
                self,
            ) -> Result<crate::schemas::RegisterDebuggeeResponse, Box<dyn ::std::error::Error>>
            {
                self.execute()
            }
        ...
        pub mod breakpoints {
            pub mod params {}
            pub struct BreakpointsActions<'a, A> {
                pub(super) reqwest: &'a reqwest::Client,
                pub(super) auth: &'a std::sync::Mutex<A>,
            }
            impl<'a, A: yup_oauth2::GetToken> BreakpointsActions<'a, A> {
                ...
                pub fn list(&self, debuggee_id: impl Into<String>) -> ListRequestBuilder<A> {
                    ListRequestBuilder {
                        reqwest: &self.reqwest,
                        auth: &self.auth,
                        access_token: None,
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                pub fn success_on_timeout(&mut self, value: bool) -> &mut Self {
                ...
                pub fn wait_token(&mut self, value: impl Into<String>) -> &mut Self {
                ...
                pub fn execute_debug(
                    ...
                    crate::schemas::ListActiveBreakpointsResponse,
                ...
                fn _path(&self) -> String {
                    ...
                    output.push_str(&self.debuggee_id);
            ...
            impl<'a, A: yup_oauth2::GetToken> UpdateRequestBuilder<'a, A> {
                ...
                pub fn execute_debug(
                    ...
                    crate::schemas::UpdateActiveBreakpointResponse,
                    Box<dyn ::std::error::Error>,
                > {
                    self.execute()
                }
...
pub mod debugger {
    pub mod params {}
    pub struct DebuggerActions<'a, A> {
        pub(super) reqwest: &'a reqwest::Client,
        pub(super) auth: &'a std::sync::Mutex<A>,
    }
    impl<'a, A: yup_oauth2::GetToken> DebuggerActions<'a, A> {
        #[doc = "Actions that can be performed on the debuggees resource"]
        pub fn debuggees(&self) -> debuggees::DebuggeesActions<A> {
            debuggees::DebuggeesActions
        }
    ...
    pub mod debuggees {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn client_version(&mut self, value: impl Into<String>) -> &mut Self {
            ...
            pub fn project(&mut self, value: impl Into<String>) -> &mut Self {
            ...
            pub fn execute_debug(
                self,
            ) -> Result<crate::schemas::ListDebuggeesResponse, Box<dyn ::std::error::Error>>
            {
                self.execute()
            }
            fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        ...
        pub mod breakpoints {
            ...
            impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
                ...
                fn _path(&self) -> String {
                    ...
                    output.push_str(&self.debuggee_id);
                    output.push_str("/breakpoints/");
                    output.push_str(&self.breakpoint_id);
                    output
                }
                fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            ...
            impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
                ...
                pub fn execute_debug(
                    self,
                ) -> Result<crate::schemas::GetBreakpointResponse, Box<dyn ::std::error::Error>>
                {
                    self.execute()
                }
                fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
            ...
            pub struct ListRequestBuilder<'a, A> {
                ...
                pub(crate) auth: &'a ::std::sync::Mutex<A>,
                debuggee_id: String,
                action_value: Option<crate::breakpoints::params::ListActionValue>,
                client_version: Option<String>,
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                pub fn action_value(
                    &mut self,
                    value: crate::breakpoints::params::ListActionValue,
                ) -> &mut Self {
                ...
                pub fn include_all_users(&mut self, value: bool) -> &mut Self {
                ...
                pub fn strip_results(&mut self, value: bool) -> &mut Self {
                ...
                pub fn execute_debug(
                    self,
                ) -> Result<crate::schemas::ListBreakpointsResponse, Box<dyn ::std::error::Error>>
                {
                    self.execute()
                }
                fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
            ...
            #[derive(Debug, Clone)]
            pub struct SetRequestBuilder<'a, A> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a ::std::sync::Mutex<A>,
                request: crate::schemas::Breakpoint,
                debuggee_id: String,
            ...
            impl<'a, A: yup_oauth2::GetToken> SetRequestBuilder<'a, A> {
                #[doc = "The client version making the call.\nSchema: `domain/type/version` (e.g., `google.com/intellij/v1`)."]
                pub fn client_version(&mut self, value: impl Into<String>) -> &mut Self {
                    self.client_version = Some(value.into());
                    self
                ...
                pub fn execute_debug(
                    self,
                ) -> Result<crate::schemas::SetBreakpointResponse, Box<dyn ::std::error::Error>>
                {
                    self.execute()
                }
                fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
