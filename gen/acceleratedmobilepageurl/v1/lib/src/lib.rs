    ...
    A: ::google_api_auth::GetAccessToken,
{
    ...
    pub fn amp_urls(&self) -> crate::resources::amp_urls::AmpUrlsActions<A> {
...
pub mod resources {
    pub mod amp_urls {
        pub mod params {}
        pub struct AmpUrlsActions<'a, A> {
            pub(crate) reqwest: &'a reqwest::Client,
            pub(crate) auth: &'a A,
        }
        impl<'a, A: ::google_api_auth::GetAccessToken> AmpUrlsActions<'a, A> {
        ...
        impl<'a, A: ::google_api_auth::GetAccessToken> BatchGetRequestBuilder<'a, A> {
            ...
            pub fn execute_with_default_fields(
                self,
            ) -> Result<crate::schemas::BatchGetAmpUrlsResponse, Box<dyn ::std::error::Error>>
            {
