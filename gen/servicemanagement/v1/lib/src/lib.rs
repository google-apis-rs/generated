...
pub mod resources {
    ...
    pub mod services {
        ...
        impl<'a> ServicesActions<'a> {
            ...
            #[doc = "Enables a service for a project, so it can be used for the project. See [Cloud Auth Guide](https://cloud.google.com/docs/authentication) for more information. Operation"]
            pub fn enable(
                &self,
