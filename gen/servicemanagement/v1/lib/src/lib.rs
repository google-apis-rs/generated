pub mod schemas {
    ...
    impl ::field_selector::FieldSelector for Advice {
    ...
    pub struct ChangeReport {
        ...
        #[serde(rename = "configChanges", default)]
        pub config_changes: Option<Vec<crate::schemas::ConfigChange>>,
    }
    impl ::field_selector::FieldSelector for ChangeReport {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ConfigChange {
        ...
        pub advices: Option<Vec<crate::schemas::Advice>>,
        #[doc = "The type for this change, either ADDED, REMOVED, or MODIFIED."]
        #[serde(rename = "changeType", default)]
        pub change_type: Option<crate::schemas::ConfigChangeChangeType>,
    ...
    pub struct ConfigFile {
        ...
        pub file_type: Option<crate::schemas::ConfigFileFileType>,
    }
    ...
    impl ::field_selector::FieldSelector for ConfigRef {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ConfigSource {
        ...
        pub files: Option<Vec<crate::schemas::ConfigFile>>,
        #[doc = "A unique ID for a specific instance of this message, typically assigned\nby the client for tracking purpose. If empty, the server may choose to\ngenerate one instead."]
        #[serde(rename = "id", default)]
        pub id: Option<String>,
    }
    impl ::field_selector::FieldSelector for ConfigSource {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct Diagnostic {
        ...
        #[serde(rename = "kind", default)]
        pub kind: Option<crate::schemas::DiagnosticKind>,
    ...
    pub struct FlowErrorDetails {
        ...
        #[serde(rename = "exceptionType", default)]
        pub exception_type: Option<String>,
        #[doc = "The step that failed."]
        #[serde(rename = "flowStepId", default)]
        pub flow_step_id: Option<String>,
    }
    impl ::field_selector::FieldSelector for FlowErrorDetails {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GenerateConfigReportRequest {
        ...
        #[serde(rename = "newConfig", default)]
        pub new_config: Option<::std::collections::BTreeMap<String, ::serde_json::Value>>,
        #[doc = "Service configuration against which the comparison will be done.\nFor this version of API, the supported types are\ngoogle.api.servicemanagement.v1.ConfigRef,\ngoogle.api.servicemanagement.v1.ConfigSource,\nand google.api.Service"]
        #[serde(rename = "oldConfig", default)]
        pub old_config: Option<::std::collections::BTreeMap<String, ::serde_json::Value>>,
    }
    impl ::field_selector::FieldSelector for GenerateConfigReportRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GenerateConfigReportResponse {
        ...
        #[serde(rename = "changeReports", default)]
        pub change_reports: Option<Vec<crate::schemas::ChangeReport>>,
    ...
    impl ::field_selector::FieldSelector for GenerateConfigReportResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListServiceConfigsResponse {
        ...
        #[serde(rename = "serviceConfigs", default)]
        pub service_configs: Option<Vec<crate::schemas::Service>>,
    }
    impl ::field_selector::FieldSelector for ListServiceConfigsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListServiceRolloutsResponse {
        ...
        #[serde(rename = "rollouts", default)]
        pub rollouts: Option<Vec<crate::schemas::Rollout>>,
    }
    impl ::field_selector::FieldSelector for ListServiceRolloutsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListServicesResponse {
        ...
        pub services: Option<Vec<crate::schemas::ManagedService>>,
    }
    ...
    impl ::field_selector::FieldSelector for ManagedService {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct OperationMetadata {
        ...
        #[serde(rename = "progressPercentage", default)]
    ...
    pub struct Rollout {
        ...
        pub delete_service_strategy: Option<crate::schemas::DeleteServiceStrategy>,
        ...
        pub status: Option<crate::schemas::RolloutStatus>,
        #[doc = "Google Service Control selects service configurations based on\ntraffic percentage."]
        #[serde(rename = "trafficPercentStrategy", default)]
        pub traffic_percent_strategy: Option<crate::schemas::TrafficPercentStrategy>,
    }
    ...
    pub struct Step {
        ...
        #[doc = "The status code."]
        #[serde(rename = "status", default)]
        pub status: Option<crate::schemas::StepStatus>,
    }
    ...
    pub struct SubmitConfigSourceRequest {
        ...
        pub config_source: Option<crate::schemas::ConfigSource>,
    ...
    impl ::field_selector::FieldSelector for SubmitConfigSourceRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct SubmitConfigSourceResponse {
        ...
        #[serde(rename = "serviceConfig", default)]
        pub service_config: Option<crate::schemas::Service>,
    }
    impl ::field_selector::FieldSelector for SubmitConfigSourceResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct TrafficPercentStrategy {
        ...
        #[serde(rename = "percentages", default)]
        pub percentages: Option<::std::collections::BTreeMap<String, f64>>,
    }
    impl ::field_selector::FieldSelector for TrafficPercentStrategy {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct UndeleteServiceResponse {
        ...
        #[serde(rename = "service", default)]
        pub service: Option<crate::schemas::ManagedService>,
    }
    impl ::field_selector::FieldSelector for UndeleteServiceResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
...
pub mod services {
    ...
    impl<'a, A: yup_oauth2::GetToken> ServicesActions<'a, A> {
        ...
        pub fn create(&self, request: crate::schemas::ManagedService) -> CreateRequestBuilder<A> {
        ...
        pub fn delete(&self, service_name: impl Into<String>) -> DeleteRequestBuilder<A> {
        ...
        ) -> GenerateConfigReportRequestBuilder<A> {
        ...
        pub fn get(&self, service_name: impl Into<String>) -> GetRequestBuilder<A> {
            GetRequestBuilder {
                reqwest: &self.reqwest,
                auth: &self.auth,
                access_token: None,
        ...
        pub fn get_config(&self, service_name: impl Into<String>) -> GetConfigRequestBuilder<A> {
        ...
        pub fn undelete(&self, service_name: impl Into<String>) -> UndeleteRequestBuilder<A> {
        ...
        pub fn configs(&self) -> configs::ConfigsActions<A> {
            configs::ConfigsActions
        }
        #[doc = "Actions that can be performed on the consumers resource"]
        pub fn consumers(&self) -> consumers::ConsumersActions<A> {
            consumers::ConsumersActions
        }
        #[doc = "Actions that can be performed on the rollouts resource"]
        pub fn rollouts(&self) -> rollouts::RolloutsActions<A> {
            rollouts::RolloutsActions
        }
    }
    #[derive(Debug, Clone)]
    ...
    impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
        ...
        fn _path(&self) -> String {
            let mut output = "https://servicemanagement.googleapis.com/".to_owned();
            output.push_str("v1/services/");
            output.push_str(&self.service_name);
            output
        }
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
    ...
    #[derive(Debug, Clone)]
    pub struct GenerateConfigReportRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        request: crate::schemas::GenerateConfigReportRequest,
        access_token: Option<String>,
    ...
    impl<'a, A: yup_oauth2::GetToken> GenerateConfigReportRequestBuilder<'a, A> {
        #[doc = "OAuth access token."]
        pub fn access_token(&mut self, value: impl Into<String>) -> &mut Self {
            self.access_token = Some(value.into());
            self
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::GenerateConfigReportResponse, Box<dyn ::std::error::Error>>
        {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::ManagedService, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    pub struct GetConfigRequestBuilder<'a, A> {
        ...
        view: Option<crate::services::params::GetConfigView>,
        access_token: Option<String>,
        alt: Option<crate::params::Alt>,
        callback: Option<String>,
        fields: Option<String>,
    ...
    impl<'a, A: yup_oauth2::GetToken> GetConfigRequestBuilder<'a, A> {
        ...
        pub fn config_id(&mut self, value: impl Into<String>) -> &mut Self {
            self.config_id = Some(value.into());
            self
        }
        #[doc = "Specifies which parts of the Service Config should be returned in the\nresponse."]
        pub fn view(&mut self, value: crate::services::params::GetConfigView) -> &mut Self {
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn consumer_id(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        pub fn producer_project_id(&mut self, value: impl Into<String>) -> &mut Self {
    ...
    pub mod configs {
        ...
        pub struct ConfigsActions<'a, A> {
            pub(super) reqwest: &'a reqwest::Client,
            pub(super) auth: &'a std::sync::Mutex<A>,
        }
        impl<'a, A: yup_oauth2::GetToken> ConfigsActions<'a, A> {
            ...
            pub fn list(&self, service_name: impl Into<String>) -> ListRequestBuilder<A> {
                ListRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: &self.auth,
                    access_token: None,
        ...
        pub struct GetRequestBuilder<'a, A> {
            ...
            service_name: String,
            config_id: String,
            view: Option<crate::configs::params::GetView>,
            access_token: Option<String>,
            alt: Option<crate::params::Alt>,
            callback: Option<String>,
            fields: Option<String>,
        ...
        impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
            #[doc = "Specifies which parts of the Service Config should be returned in the\nresponse."]
            pub fn view(&mut self, value: crate::configs::params::GetView) -> &mut Self {
                self.view = Some(value);
                self
            }
            #[doc = "OAuth access token."]
            ...
            fn _path(&self) -> String {
                ...
                output.push_str(&self.service_name);
                output.push_str("/configs/");
                output.push_str(&self.config_id);
                output
            }
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                let req = self.reqwest.request(::reqwest::Method::GET, path);
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn execute_debug(
                self,
            ) -> Result<crate::schemas::ListServiceConfigsResponse, Box<dyn ::std::error::Error>>
            {
                self.execute()
            }
            fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
    ...
    pub mod consumers {
        pub mod params {}
        pub struct ConsumersActions<'a, A> {
            pub(super) reqwest: &'a reqwest::Client,
            pub(super) auth: &'a std::sync::Mutex<A>,
        }
        impl<'a, A: yup_oauth2::GetToken> ConsumersActions<'a, A> {
            #[doc = "Gets the access control policy for a resource.\nReturns an empty policy if the resource exists and does not have a policy\nset."]
            pub fn get_iam_policy(
                &self,
                request: crate::schemas::GetIamPolicyRequest,
    ...
    pub mod rollouts {
        pub mod params {}
        pub struct RolloutsActions<'a, A> {
            pub(super) reqwest: &'a reqwest::Client,
            pub(super) auth: &'a std::sync::Mutex<A>,
        }
        impl<'a, A: yup_oauth2::GetToken> RolloutsActions<'a, A> {
        ...
        impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
            ...
            pub fn base_rollout_id(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
            ...
            pub fn execute_debug(
                self,
            ) -> Result<crate::schemas::Rollout, Box<dyn ::std::error::Error>> {
                self.execute()
            }
            fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
            where
            ...
            fn _path(&self) -> String {
                ...
                output.push_str(&self.service_name);
                output.push_str("/rollouts/");
                output.push_str(&self.rollout_id);
                output
            }
            fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
                let req = self.reqwest.request(::reqwest::Method::GET, path);
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            pub fn execute_debug(
                self,
            ) -> Result<crate::schemas::ListServiceRolloutsResponse, Box<dyn ::std::error::Error>>
            {
                self.execute()
            }
            fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
