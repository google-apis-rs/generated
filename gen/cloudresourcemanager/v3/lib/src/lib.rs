...
pub mod schemas {
    ...
    pub struct Folder {
        ...
        pub parent: ::std::option::Option<String>,
        #[doc = "Output only. The lifecycle state of the folder. Updates to the state must be performed via DeleteFolder and UndeleteFolder."]
        #[serde(
            rename = "state",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct ListTagBindingsResponse {
        #[doc = "A pagination token returned from a previous call to `ListTagBindings` that indicates from where listing should continue."]
        #[serde(
            rename = "nextPageToken",
            default,
            skip_serializing_if = "std::option::Option::is_none"
    ...
    pub struct Organization {
        ...
        #[doc = "Output only. A human-readable string that refers to the Organization in the GCP Console UI. This string is set by the server and cannot be changed. The string will be set to the primary domain (for example, \"google.com\") of the G Suite customer that owns the organization."]
        #[serde(
            rename = "displayName",
            default,
            skip_serializing_if = "std::option::Option::is_none"
...
pub mod resources {
    pub mod folders {
        ...
        impl<'a> FoldersActions<'a> {
            ...
            #[doc = "Updates a Folder, changing its display_name. Changes to the folder display_name will be rejected if they violate either the display_name formatting rules or naming constraints described in the CreateFolder documentation. The Folder's display_name must start and end with a letter or digit, may contain letters, digits, spaces, hyphens and underscores and can be between 3 and 30 characters. This is captured by the regular expression: `\\p{L}\\p{N}{1,28}[\\p{L}\\p{N}]`. The caller must have `resourcemanager.folders.update` permission on the identified folder. If the update fails due to the unique name constraint then a PreconditionFailure explaining this violation will be returned in the Status.details field."]
            pub fn patch(
                &self,
        ...
        impl<'a> ListRequestBuilder<'a> {
            #[doc = "Optional. The maximum number of Folders to return in the response. If unspecified, server picks an appropriate default."]
    ...
    pub mod organizations {
        ...
        impl<'a> SearchRequestBuilder<'a> {
            #[doc = "Optional. The maximum number of Organizations to return in the response. If unspecified, server picks an appropriate default."]
            pub fn page_size(mut self, value: i32) -> Self {
                self.page_size = Some(value);
                self
            }
    ...
    pub mod projects {
        ...
        impl<'a> ProjectsActions<'a> {
            ...
            #[doc = "Retrieves the Project identified by the specified `name` (for example, `projects/415104041262`). The caller must have read permissions for this Project."]
            pub fn get(&self, name: impl Into<String>) -> GetRequestBuilder {
                GetRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
            ...
            #[doc = "Returns the IAM access control policy for the specified Project. Permission is denied if the policy or the resource does not exist."]
            pub fn get_iam_policy(
                &self,
                request: crate::schemas::GetIamPolicyRequest,
                resource: impl Into<String>,
            ...
            #[doc = "Updates the attributes of the Project identified by the specified `name` (for example, `projects/415104041262`). At present this is only useful for updating the display_name and labels. Deleting all labels requires an update mask for labels field. The caller must have modify permissions for this Project."]
            pub fn patch(
                &self,
            ...
            #[doc = "Search for Projects that the caller has the `resourcemanager.projects.get` permission on and satisfy the specified query. This method returns Projects in an unspecified order. This method is eventually consistent with project mutations; this means that a newly created project may not appear in the results or recent updates to an existing project may not be reflected in the results. To retrieve the latest state of a project, use the GetProject method."]
            pub fn search(&self) -> SearchRequestBuilder {
                SearchRequestBuilder {
                    reqwest: &self.reqwest,
                    auth: self.auth_ref(),
            ...
            #[doc = "Restores the Project identified by the specified `name` (for example, `projects/415104041262`). You can only use this method for a Project that has a lifecycle state of DELETE_REQUESTED. After deletion starts, the Project cannot be restored. The caller must have undelete permissions for this Project."]
            pub fn undelete(
                &self,
