pub mod schemas {
    ...
    pub struct Ancestor {
        ...
        pub resource_id: Option<crate::schemas::ResourceId>,
    }
    ...
    impl ::field_selector::FieldSelector for BooleanConstraint {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {}
    }
    #[derive(
        Debug,
    ...
    impl ::field_selector::FieldSelector for BooleanPolicy {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for ClearOrgPolicyRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct Constraint {
        ...
        pub boolean_constraint: Option<crate::schemas::BooleanConstraint>,
        #[doc = "The evaluation behavior of this constraint in the absense of 'Policy'."]
        #[serde(rename = "constraintDefault", default)]
        pub constraint_default: Option<crate::schemas::ConstraintConstraintDefault>,
        ...
        pub list_constraint: Option<crate::schemas::ListConstraint>,
    ...
    pub struct FolderOperation {
        ...
        pub operation_type: Option<crate::schemas::FolderOperationOperationType>,
    ...
    pub struct FolderOperationError {
        ...
        pub error_message_id: Option<crate::schemas::FolderOperationErrorErrorMessageId>,
    }
    ...
    pub struct GetAncestryResponse {
        ...
        pub ancestor: Option<Vec<crate::schemas::Ancestor>>,
    }
    ...
    impl ::field_selector::FieldSelector for GetEffectiveOrgPolicyRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GetOrgPolicyRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for Lien {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for ListAvailableOrgPolicyConstraintsRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListAvailableOrgPolicyConstraintsResponse {
        ...
        pub constraints: Option<Vec<crate::schemas::Constraint>>,
        #[doc = "Page token used to retrieve the next page. This is currently not used."]
        #[serde(rename = "nextPageToken", default)]
        pub next_page_token: Option<String>,
    }
    impl ::field_selector::FieldSelector for ListAvailableOrgPolicyConstraintsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListConstraint {
        ...
        #[serde(rename = "supportsUnder", default)]
        pub supports_under: Option<bool>,
    }
    impl ::field_selector::FieldSelector for ListConstraint {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListLiensResponse {
        #[doc = "A list of Liens."]
        #[serde(rename = "liens", default)]
        pub liens: Option<Vec<crate::schemas::Lien>>,
        #[doc = "Token to retrieve the next page of results, or empty if there are no more\nresults in the list."]
        #[serde(rename = "nextPageToken", default)]
        pub next_page_token: Option<String>,
    }
    impl ::field_selector::FieldSelector for ListLiensResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for ListOrgPoliciesRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListOrgPoliciesResponse {
        ...
        pub policies: Option<Vec<crate::schemas::OrgPolicy>>,
    }
    impl ::field_selector::FieldSelector for ListOrgPoliciesResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListPolicy {
        ...
        pub all_values: Option<crate::schemas::ListPolicyAllValues>,
    ...
    pub struct OrgPolicy {
        ...
        pub boolean_policy: Option<crate::schemas::BooleanPolicy>,
        ...
        pub list_policy: Option<crate::schemas::ListPolicy>,
        #[doc = "Restores the default behavior of the constraint; independent of\n`Constraint` type."]
        #[serde(rename = "restoreDefault", default)]
        pub restore_default: Option<crate::schemas::RestoreDefault>,
    ...
    impl ::field_selector::FieldSelector for OrgPolicy {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct Organization {
        ...
        pub lifecycle_state: Option<crate::schemas::OrganizationLifecycleState>,
        ...
        pub owner: Option<crate::schemas::OrganizationOwner>,
    }
    ...
    pub struct Project {
        ...
        #[serde(rename = "lifecycleState", default)]
        pub lifecycle_state: Option<crate::schemas::ProjectLifecycleState>,
        ...
        #[serde(rename = "parent", default)]
        pub parent: Option<crate::schemas::ResourceId>,
    ...
    impl ::field_selector::FieldSelector for RestoreDefault {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {}
    }
    #[derive(
        Debug,
    ...
    impl ::field_selector::FieldSelector for SearchOrganizationsRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for SearchOrganizationsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct SetOrgPolicyRequest {
        ...
        #[serde(rename = "policy", default)]
        pub policy: Option<crate::schemas::OrgPolicy>,
    }
    impl ::field_selector::FieldSelector for SetOrgPolicyRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn liens(&self) -> crate::resources::liens::LiensActions<A> {
...
mod resources {
    pub mod folders {
        ...
        impl<'a, A: yup_oauth2::GetToken> FoldersActions<'a, A> {
            ...
            ) -> ClearOrgPolicyRequestBuilder<A> {
            ...
            pub fn get_effective_org_policy(
                ...
                resource: impl Into<String>,
            ) -> GetEffectiveOrgPolicyRequestBuilder<A> {
            ...
            pub fn list_available_org_policy_constraints(
                ...
                resource: impl Into<String>,
            ) -> ListAvailableOrgPolicyConstraintsRequestBuilder<A> {
            ...
            pub fn list_org_policies(
                ...
                resource: impl Into<String>,
            ) -> ListOrgPoliciesRequestBuilder<A> {
        ...
        #[derive(Debug, Clone)]
        pub struct ClearOrgPolicyRequestBuilder<'a, A> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a ::std::sync::Mutex<A>,
            request: crate::schemas::ClearOrgPolicyRequest,
            resource: String,
        ...
        impl<'a, A: yup_oauth2::GetToken> ClearOrgPolicyRequestBuilder<'a, A> {
        ...
        #[derive(Debug, Clone)]
        pub struct GetEffectiveOrgPolicyRequestBuilder<'a, A> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a ::std::sync::Mutex<A>,
            request: crate::schemas::GetEffectiveOrgPolicyRequest,
            resource: String,
        ...
        impl<'a, A: yup_oauth2::GetToken> GetEffectiveOrgPolicyRequestBuilder<'a, A> {
            #[doc = "OAuth access token."]
            pub fn access_token(mut self, value: impl Into<String>) -> Self {
                self.access_token = Some(value.into());
                self
            ...
            pub fn execute_standard(
                self,
            ) -> Result<crate::schemas::OrgPolicy, Box<dyn ::std::error::Error>> {
                self.execute_fields::<_, &str>(None)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
        ...
        #[derive(Debug, Clone)]
        pub struct GetOrgPolicyRequestBuilder<'a, A> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a ::std::sync::Mutex<A>,
            request: crate::schemas::GetOrgPolicyRequest,
            resource: String,
        ...
        impl<'a, A: yup_oauth2::GetToken> GetOrgPolicyRequestBuilder<'a, A> {
            #[doc = "OAuth access token."]
            pub fn access_token(mut self, value: impl Into<String>) -> Self {
                self.access_token = Some(value.into());
                self
        ...
        #[derive(Debug, Clone)]
        pub struct ListAvailableOrgPolicyConstraintsRequestBuilder<'a, A> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a ::std::sync::Mutex<A>,
            request: crate::schemas::ListAvailableOrgPolicyConstraintsRequest,
            resource: String,
        ...
        impl<'a, A: yup_oauth2::GetToken> ListAvailableOrgPolicyConstraintsRequestBuilder<'a, A> {
            #[doc = "OAuth access token."]
            pub fn access_token(mut self, value: impl Into<String>) -> Self {
                self.access_token = Some(value.into());
                self
            ...
            pub fn execute_standard(
                ...
                crate::schemas::ListAvailableOrgPolicyConstraintsResponse,
        ...
        #[derive(Debug, Clone)]
        pub struct ListOrgPoliciesRequestBuilder<'a, A> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a ::std::sync::Mutex<A>,
            request: crate::schemas::ListOrgPoliciesRequest,
            resource: String,
        ...
        impl<'a, A: yup_oauth2::GetToken> ListOrgPoliciesRequestBuilder<'a, A> {
            #[doc = "OAuth access token."]
            pub fn access_token(mut self, value: impl Into<String>) -> Self {
                self.access_token = Some(value.into());
                self
            ...
            pub fn execute_standard(
                self,
            ) -> Result<crate::schemas::ListOrgPoliciesResponse, Box<dyn ::std::error::Error>>
            {
                self.execute_fields::<_, &str>(None)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
        ...
        #[derive(Debug, Clone)]
        pub struct SetOrgPolicyRequestBuilder<'a, A> {
            pub(crate) reqwest: &'a ::reqwest::Client,
            pub(crate) auth: &'a ::std::sync::Mutex<A>,
            request: crate::schemas::SetOrgPolicyRequest,
            resource: String,
        ...
        impl<'a, A: yup_oauth2::GetToken> SetOrgPolicyRequestBuilder<'a, A> {
            #[doc = "OAuth access token."]
            pub fn access_token(mut self, value: impl Into<String>) -> Self {
                self.access_token = Some(value.into());
                self
    ...
    pub mod liens {
        pub mod params {}
        pub struct LiensActions<'a, A> {
            pub(crate) reqwest: &'a reqwest::Client,
            pub(crate) auth: &'a std::sync::Mutex<A>,
        }
        impl<'a, A: yup_oauth2::GetToken> LiensActions<'a, A> {
            ...
            pub fn create(&self, request: crate::schemas::Lien) -> CreateRequestBuilder<A> {
        ...
        impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
            ...
            pub fn execute_standard(
                self,
            ) -> Result<crate::schemas::Lien, Box<dyn ::std::error::Error>> {
                self.execute_fields::<_, &str>(None)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            #[doc = "The name of the resource to list all attached Liens.\nFor example, `projects/1234`."]
            ...
            pub fn iter_liens<T>(self) -> ListLiensIter<'a, A, T>
            where
                T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
            {
                ListLiensIter {
            ...
            #[doc = r" the server."]
            pub fn iter_liens_standard(mut self) -> ListLiensIter<'a, A, crate::schemas::Lien> {
                self.fields = Some(concat!("nextPageToken,", "liens").to_owned());
                ListLiensIter {
                    method: self,
                    last_page_reached: false,
                    items_iter: None,
            ...
            #[doc = r" resources."]
            pub fn iter_liens_debug(mut self) -> ListLiensIter<'a, A, crate::schemas::Lien> {
                self.fields = Some(concat!("nextPageToken,", "liens", "(*)").to_owned());
                ListLiensIter {
                    method: self,
                    last_page_reached: false,
            ...
            pub fn execute_standard(
                self,
            ) -> Result<crate::schemas::ListLiensResponse, Box<dyn ::std::error::Error>>
            {
                self.execute_fields::<_, &str>(None)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
        ...
        pub struct ListLiensIter<'a, A, T> {
            method: ListRequestBuilder<'a, A>,
            last_page_reached: bool,
            items_iter: Option<::std::vec::IntoIter<T>>,
        }
        impl<'a, A, T> Iterator for ListLiensIter<'a, A, T>
        where
    ...
    pub mod organizations {
        ...
        impl<'a, A: yup_oauth2::GetToken> SearchRequestBuilder<'a, A> {
            ...
            pub fn execute_standard(
                self,
            ) -> Result<crate::schemas::SearchOrganizationsResponse, Box<dyn ::std::error::Error>>
            {
                self.execute_fields::<_, &str>(None)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
    ...
    pub mod projects {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            #[doc = r" populated fields in the yielded items will be determined by the"]
            #[doc = r" `FieldSelector` implementation."]
            pub fn iter_projects<T>(self) -> ListProjectsIter<'a, A, T>
            where
                T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
            {
                ListProjectsIter {
            ...
            pub fn iter_projects_standard(
                mut self,
            ) -> ListProjectsIter<'a, A, crate::schemas::Project> {
        ...
        pub struct ListProjectsIter<'a, A, T> {
            method: ListRequestBuilder<'a, A>,
            last_page_reached: bool,
            items_iter: Option<::std::vec::IntoIter<T>>,
        }
        impl<'a, A, T> Iterator for ListProjectsIter<'a, A, T>
        where
            A: ::yup_oauth2::GetToken,
            T: ::serde::de::DeserializeOwned,
        {
