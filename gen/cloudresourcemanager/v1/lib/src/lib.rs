...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn folders(&self) -> crate::folders::FoldersActions<A> {
        crate::folders::FoldersActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    #[doc = "Actions that can be performed on the liens resource"]
    pub fn liens(&self) -> crate::liens::LiensActions<A> {
        crate::liens::LiensActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
    ...
    pub fn organizations(&self) -> crate::organizations::OrganizationsActions<A> {
        crate::organizations::OrganizationsActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
...
pub mod liens {
    ...
    impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(self) -> Result<crate::schemas::Lien, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
