...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        ...
        let mut dicom_stores3 = SubCommand::with_name("dicom_stores")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: create, delete, export, get, get_iam_policy, import, list, patch, search_for_instances, search_for_series, search_for_studies, set_iam_policy, store_instances and test_iam_permissions");
        {
        ...
        let mut fhir4 = SubCommand::with_name("fhir")
                        .setting(AppSettings::ColoredHelp)
                        .about("methods: observation_lastn, patient_everything, resource_purge, capabilities, conditional_delete, conditional_patch, conditional_update, create, delete, execute_bundle, history, patch, read, search, update and vread");
        {
