            ...
            pub mod service_instances {
                ...
                impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                        ...
                        T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                    {
                        ...
                        crate::iter::PageIter::new(self)
                    }pub fn iter_standard ( self ) -> crate :: iter :: PageIter < Self , crate :: schemas :: GoogleCloudServicebrokerV1Alpha1ListServiceInstancesResponse >{
                        crate::iter::PageIter::new(self)
                    }pub fn iter_debug ( mut self ) -> crate :: iter :: PageIter < Self , crate :: schemas :: GoogleCloudServicebrokerV1Alpha1ListServiceInstancesResponse >{
                        self.fields = Some("*".to_owned());
                        crate::iter::PageIter::new(self)
                    }
                    #[doc = r" Execute the given operation. The fields requested are"]
