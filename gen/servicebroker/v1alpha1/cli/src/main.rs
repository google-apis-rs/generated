...
impl<'a, 'b> Default for HeapApp<'a, 'b> {
    fn default() -> Self {
        let mut app = App::new("servicebroker1_alpha1")
        ...
        let mut v_1alpha_10 = SubCommand::with_name("v_1alpha_1")
            .setting(AppSettings::ColoredHelp)
            .about("methods: get_iam_policy, set_iam_policy and test_iam_permissions");
        {
            ...
            v_1alpha_10 = v_1alpha_10.subcommand(mcmd);
        }
        {
        ...
        let mut brokers1 = SubCommand::with_name("brokers")
            .setting(AppSettings::ColoredHelp)
            .about("sub-resources: instances, service_instances and v_2");
        ...
        let mut service_bindings3 = SubCommand::with_name("service_bindings")
            .setting(AppSettings::ColoredHelp)
            .about("methods: list");
        {
            let mcmd =
                SubCommand::with_name("list").about("Lists all the bindings in the instance");
            service_bindings3 = service_bindings3.subcommand(mcmd);
        }
        ...
        instances2 = instances2.subcommand(service_bindings3);
        brokers1 = brokers1.subcommand(v_22);
        brokers1 = brokers1.subcommand(service_instances2);
        brokers1 = brokers1.subcommand(instances2);
        projects0 = projects0.subcommand(brokers1);
        app = app.subcommand(v_1alpha_10);
        app = app.subcommand(projects0);

        Self { app }
    }
}
use google_servicebroker1_alpha1 as api;
