pub mod schemas {
    ...
    pub struct BuildTrigger {
        ...
        pub github: Option<crate::schemas::GitHubEventsConfig>,
        ...
        #[serde(rename = "includedFiles", default)]
        ...
        #[serde(rename = "triggerTemplate", default)]
        pub trigger_template: Option<crate::schemas::RepoSource>,
    }
    impl ::field_selector::FieldSelector for BuildTrigger {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for CancelBuildRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {}
    }
    #[derive(
        Debug,
    ...
    pub struct GitHubEventsConfig {
        ...
        pub pull_request: Option<crate::schemas::PullRequestFilter>,
        #[doc = "filter to match changes in refs like branches, tags."]
        #[serde(rename = "push", default)]
        pub push: Option<crate::schemas::PushFilter>,
    }
    impl ::field_selector::FieldSelector for GitHubEventsConfig {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListBuildTriggersResponse {
        ...
        pub triggers: Option<Vec<crate::schemas::BuildTrigger>>,
    }
    impl ::field_selector::FieldSelector for ListBuildTriggersResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListBuildsResponse {
        ...
        pub builds: Option<Vec<crate::schemas::Build>>,
        #[doc = "Token to receive the next page of results."]
        #[serde(rename = "nextPageToken", default)]
        pub next_page_token: Option<String>,
    }
    impl ::field_selector::FieldSelector for ListBuildsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct PullRequestFilter {
        ...
        #[serde(rename = "commentControl", default)]
        pub comment_control: Option<crate::schemas::PullRequestFilterCommentControl>,
    }
    impl ::field_selector::FieldSelector for PullRequestFilter {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct PushFilter {
        #[doc = "Regexes of branches to match.\n\nThe syntax of the regular expressions accepted is the syntax accepted by\nRE2 and described at https://github.com/google/re2/wiki/Syntax"]
        #[serde(rename = "branch", default)]
        pub branch: Option<String>,
        #[doc = "Regexes of tags to match.\n\nThe syntax of the regular expressions accepted is the syntax accepted by\nRE2 and described at https://github.com/google/re2/wiki/Syntax"]
        #[serde(rename = "tag", default)]
        pub tag: Option<String>,
    }
    impl ::field_selector::FieldSelector for PushFilter {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for RetryBuildRequest {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {}
    }
    #[derive(
        Debug,
...
mod resources {
    ...
    pub mod projects {
        ...
        impl<'a, A: yup_oauth2::GetToken> ProjectsActions<'a, A> {
            ...
            pub fn builds(&self) -> crate::resources::projects::builds::BuildsActions<A> {
            ...
            pub fn triggers(&self) -> crate::resources::projects::triggers::TriggersActions<A> {
        ...
        pub mod builds {
            pub mod params {}
            pub struct BuildsActions<'a, A> {
                pub(crate) reqwest: &'a reqwest::Client,
                pub(crate) auth: &'a std::sync::Mutex<A>,
            }
            impl<'a, A: yup_oauth2::GetToken> BuildsActions<'a, A> {
            ...
            impl<'a, A: yup_oauth2::GetToken> CancelRequestBuilder<'a, A> {
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::Build, Box<dyn ::std::error::Error>> {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
                #[doc = r" selector of `*`. This will include every attribute of the"]
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_builds<T>(self) -> ListBuildsIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListBuildsIter {
                ...
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_builds_standard(
                    mut self,
                ) -> ListBuildsIter<'a, A, crate::schemas::Build> {
                    self.fields = Some(concat!("nextPageToken,", "builds").to_owned());
                    ListBuildsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                #[doc = r" all fields can be expensive both in bandwidth and server"]
                #[doc = r" resources."]
                pub fn iter_builds_debug(mut self) -> ListBuildsIter<'a, A, crate::schemas::Build> {
                    self.fields = Some(concat!("nextPageToken,", "builds", "(*)").to_owned());
                    ListBuildsIter {
                        method: self,
                        last_page_reached: false,
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::ListBuildsResponse, Box<dyn ::std::error::Error>>
                {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            pub struct ListBuildsIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListBuildsIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
            ...
            #[derive(Debug, Clone)]
            pub struct RetryRequestBuilder<'a, A> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a ::std::sync::Mutex<A>,
                request: crate::schemas::RetryBuildRequest,
                project_id: String,
            ...
            impl<'a, A: yup_oauth2::GetToken> RetryRequestBuilder<'a, A> {
                #[doc = "OAuth access token."]
                pub fn access_token(mut self, value: impl Into<String>) -> Self {
                    self.access_token = Some(value.into());
                    self
        ...
        pub mod triggers {
            ...
            impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::BuildTrigger, Box<dyn ::std::error::Error>>
                {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_triggers<T>(self) -> ListTriggersIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    ListTriggersIter {
                ...
                #[doc = r" fields in `#items_type` will be the default fields populated by"]
                #[doc = r" the server."]
                pub fn iter_triggers_standard(
                    mut self,
                ) -> ListTriggersIter<'a, A, crate::schemas::BuildTrigger> {
                    self.fields = Some(concat!("nextPageToken,", "triggers").to_owned());
                    ListTriggersIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
                ...
                pub fn execute_standard(
                    self,
                ) -> Result<crate::schemas::ListBuildTriggersResponse, Box<dyn ::std::error::Error>>
                {
                    self.execute_fields::<_, &str>(None)
                }
                #[doc = r" Execute the given operation. This will provide a `fields`"]
            ...
            pub struct ListTriggersIter<'a, A, T> {
                method: ListRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for ListTriggersIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
