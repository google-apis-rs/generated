...
mod resources {
    pub mod folders {
        ...
        pub mod catalogs {
            ...
            impl<'a, A: yup_oauth2::GetToken> CatalogsActions<'a, A> {
            ...
            impl<'a, A: yup_oauth2::GetToken> SearchRequestBuilder<'a, A> {
                ...
                pub fn iter_catalogs<T>(self) -> SearchCatalogsIter<'a, A, T>
                where
                ...
                > {
                    self.fields = Some(concat!("nextPageToken,", "catalogs").to_owned());
                    SearchCatalogsIter {
                        method: self,
                        last_page_reached: false,
                        items_iter: None,
            ...
            pub struct SearchCatalogsIter<'a, A, T> {
                method: SearchRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for SearchCatalogsIter<'a, A, T>
            where
        ...
        pub mod products {
            ...
            impl<'a, A: yup_oauth2::GetToken> SearchRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_products<T>(self) -> SearchProductsIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    SearchProductsIter {
            ...
            pub struct SearchProductsIter<'a, A, T> {
                method: SearchRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for SearchProductsIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
        ...
        pub mod versions {
            ...
            impl<'a, A: yup_oauth2::GetToken> SearchRequestBuilder<'a, A> {
                ...
                #[doc = r" populated fields in the yielded items will be determined by the"]
                #[doc = r" `FieldSelector` implementation."]
                pub fn iter_versions<T>(self) -> SearchVersionsIter<'a, A, T>
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
                {
                    SearchVersionsIter {
            ...
            pub struct SearchVersionsIter<'a, A, T> {
                method: SearchRequestBuilder<'a, A>,
                last_page_reached: bool,
                items_iter: Option<::std::vec::IntoIter<T>>,
            }
            impl<'a, A, T> Iterator for SearchVersionsIter<'a, A, T>
            where
                A: ::yup_oauth2::GetToken,
                T: ::serde::de::DeserializeOwned,
            {
