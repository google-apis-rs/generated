...
pub mod resources {
    ...
    pub mod users {
        ...
        impl<'a> UsersActions<'a> {
            ...
            #[doc = "Actions that can be performed on the blogs resource"]
            pub fn blogs(&self) -> crate::resources::users::blogs::BlogsActions {
