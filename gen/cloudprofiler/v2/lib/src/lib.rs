...
pub mod resources {
    pub mod projects {
        ...
        impl<'a, A: yup_oauth2::GetToken> ProjectsActions<'a, A> {
            ...
            pub fn profiles(&self) -> crate::resources::projects::profiles::ProfilesActions<A> {
        ...
        pub mod profiles {
            ...
            #[derive(Debug, Clone)]
            pub struct CreateOfflineRequestBuilder<'a, A> {
                pub(crate) reqwest: &'a ::reqwest::Client,
                pub(crate) auth: &'a ::std::sync::Mutex<A>,
                request: crate::schemas::Profile,
                parent: String,
            ...
            impl<'a, A: yup_oauth2::GetToken> CreateOfflineRequestBuilder<'a, A> {
                #[doc = "OAuth access token."]
                pub fn access_token(mut self, value: impl Into<String>) -> Self {
                    self.access_token = Some(value.into());
                    self
