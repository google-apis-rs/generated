...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn claims(&self) -> crate::resources::claims::ClaimsActions<A> {
...
pub mod resources {
    pub mod claims {
        pub mod params {}
        pub struct ClaimsActions<'a, A> {
            pub(crate) reqwest: &'a reqwest::Client,
            pub(crate) auth: &'a std::sync::Mutex<A>,
        }
        impl<'a, A: yup_oauth2::GetToken> ClaimsActions<'a, A> {
        ...
        impl<'a, A: yup_oauth2::GetToken> SearchRequestBuilder<'a, A> {
            ...
            pub fn iter_claims<T>(mut self) -> crate::iter::PageItemIter<Self, T>
            where
                T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
            {
                let mut fields = concat!("nextPageToken,", "claims").to_owned();
            ...
            }pub fn iter_standard ( self ) -> crate :: iter :: PageIter < Self , crate :: schemas :: GoogleFactcheckingFactchecktoolsV1Alpha1FactCheckedClaimSearchResponse >{
                crate::iter::PageIter::new(self)
            }pub fn iter_debug ( mut self ) -> crate :: iter :: PageIter < Self , crate :: schemas :: GoogleFactcheckingFactchecktoolsV1Alpha1FactCheckedClaimSearchResponse >{
            ...
            #[doc = r" the response resource."]pub fn execute_standard ( self ) -> Result < crate :: schemas :: GoogleFactcheckingFactchecktoolsV1Alpha1FactCheckedClaimSearchResponse , Box < dyn :: std :: error :: Error >>{
                self.execute_fields::<_, &str>(None)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
            #[doc = r" response resource and should be limited to use during"]
            #[doc = r" development or debugging."]pub fn execute_debug ( self ) -> Result < crate :: schemas :: GoogleFactcheckingFactchecktoolsV1Alpha1FactCheckedClaimSearchResponse , Box < dyn :: std :: error :: Error >>{
    ...
    pub mod pages {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            ...
            #[doc = r" populated fields in the yielded items will be determined by the"]
            #[doc = r" `FieldSelector` implementation."]
            pub fn iter_claim_review_markup_pages<T>(mut self) -> crate::iter::PageItemIter<Self, T>
            where
                T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
            {
                let mut fields = concat!("nextPageToken,", "claimReviewMarkupPages").to_owned();
                let items_fields = T::field_selector();
                if !items_fields.is_empty() {
                    fields.push_str("(");
                    fields.push_str(&items_fields);
            ...
            #[doc = r" fields in `#items_type` will be the default fields populated by"]
            #[doc = r" the server."]
            pub fn iter_claim_review_markup_pages_standard(
                mut self,
            ) -> crate::iter::PageItemIter<
                Self,
                crate::schemas::GoogleFactcheckingFactchecktoolsV1Alpha1ClaimReviewMarkupPage,
            > {
                self.fields = Some(concat!("nextPageToken,", "claimReviewMarkupPages").to_owned());
                crate::iter::PageItemIter::new(self, "claimReviewMarkupPages")
            }
            #[doc = r" Return an iterator that iterates over all `#prop_ident`. The"]
            #[doc = r" items yielded by the iterator are `#items_type`. The populated"]
            ...
            #[doc = r" all fields can be expensive both in bandwidth and server"]
            #[doc = r" resources."]
            pub fn iter_claim_review_markup_pages_debug(
                mut self,
            ) -> crate::iter::PageItemIter<
                Self,
                crate::schemas::GoogleFactcheckingFactchecktoolsV1Alpha1ClaimReviewMarkupPage,
            > {
                self.fields =
                    Some(concat!("nextPageToken,", "claimReviewMarkupPages", "(*)").to_owned());
                crate::iter::PageItemIter::new(self, "claimReviewMarkupPages")
            }
            pub fn iter<T>(mut self) -> crate::iter::PageIter<Self, T>
            where
                T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector,
            {
                ...
                crate::iter::PageIter::new(self)
            }pub fn iter_standard ( self ) -> crate :: iter :: PageIter < Self , crate :: schemas :: GoogleFactcheckingFactchecktoolsV1Alpha1ListClaimReviewMarkupPagesResponse >{
                crate::iter::PageIter::new(self)
            }pub fn iter_debug ( mut self ) -> crate :: iter :: PageIter < Self , crate :: schemas :: GoogleFactcheckingFactchecktoolsV1Alpha1ListClaimReviewMarkupPagesResponse >{
                self.fields = Some("*".to_owned());
                crate::iter::PageIter::new(self)
            }
            #[doc = r" Execute the given operation. The fields requested are"]
            ...
            #[doc = r" the fields returned. This typically includes the most common"]
            #[doc = r" fields, but it will not include every possible attribute of"]
            #[doc = r" the response resource."]pub fn execute_standard ( self ) -> Result < crate :: schemas :: GoogleFactcheckingFactchecktoolsV1Alpha1ListClaimReviewMarkupPagesResponse , Box < dyn :: std :: error :: Error >>{
                self.execute_fields::<_, &str>(None)
            }
            #[doc = r" Execute the given operation. This will provide a `fields`"]
            #[doc = r" selector of `*`. This will include every attribute of the"]
            #[doc = r" response resource and should be limited to use during"]
            #[doc = r" development or debugging."]pub fn execute_debug ( self ) -> Result < crate :: schemas :: GoogleFactcheckingFactchecktoolsV1Alpha1ListClaimReviewMarkupPagesResponse , Box < dyn :: std :: error :: Error >>{
                self.execute_fields(Some("*"))
            }
            #[doc = r" Execute the given operation. This will use the `fields`"]
            #[doc = r" selector provided and will deserialize the response into"]
