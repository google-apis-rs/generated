...
pub mod resources {
    pub mod iam_policies {
        ...
        impl<'a> SearchAllRequestBuilder<'a> {
            ...
            #[doc = "Optional. The query statement. Examples:\n\n* \"policy:myuser@mydomain.com\"\n* \"policy:(myuser@mydomain.com viewer)\""]
