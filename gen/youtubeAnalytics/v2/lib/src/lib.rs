pub mod schemas {
    ...
    impl ::field_selector::FieldSelector for EmptyResponse {
    ...
    pub struct ErrorProto {
        ...
        pub location_type: Option<crate::schemas::ErrorProtoLocationType>,
    }
    ...
    pub struct Errors {
        ...
        #[serde(rename = "code", default)]
        pub code: Option<crate::schemas::ErrorsCode>,
        #[doc = "Specific error description and codes"]
        #[serde(rename = "error", default)]
        pub error: Option<Vec<crate::schemas::ErrorProto>>,
    ...
    pub struct Group {
        ...
        pub content_details: Option<crate::schemas::GroupContentDetails>,
        #[doc = "Apiary error details"]
        #[serde(rename = "errors", default)]
        pub errors: Option<crate::schemas::Errors>,
        ...
        pub snippet: Option<crate::schemas::GroupSnippet>,
    }
    ...
    impl ::field_selector::FieldSelector for GroupContentDetails {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct GroupItem {
        ...
        pub resource: Option<crate::schemas::GroupItemResource>,
    }
    impl ::field_selector::FieldSelector for GroupItem {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GroupItemResource {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GroupSnippet {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListGroupItemsResponse {
        ...
        pub items: Option<Vec<crate::schemas::GroupItem>>,
        #[doc = "Identifies the API resource's type. The value will be\n`youtube#groupItemListResponse`."]
        #[serde(rename = "kind", default)]
        pub kind: Option<String>,
    }
    impl ::field_selector::FieldSelector for ListGroupItemsResponse {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    pub struct ListGroupsResponse {
        ...
        #[serde(rename = "items", default)]
        pub items: Option<Vec<crate::schemas::Group>>,
    ...
    pub struct QueryResponse {
        ...
        pub column_headers: Option<Vec<crate::schemas::ResultTableColumnHeader>>,
    ...
    impl ::field_selector::FieldSelector for ResultTableColumnHeader {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn group_items(&self) -> crate::group_items::GroupItemsActions<A> {
        crate::group_items::GroupItemsActions {
...
pub mod group_items {
    pub mod params {}
    pub struct GroupItemsActions<'a, A> {
        pub(super) reqwest: &'a reqwest::Client,
        pub(super) auth: &'a std::sync::Mutex<A>,
    }
    impl<'a, A: yup_oauth2::GetToken> GroupItemsActions<'a, A> {
        ...
        pub fn insert(&self, request: crate::schemas::GroupItem) -> InsertRequestBuilder<A> {
    ...
    impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::EmptyResponse, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        ...
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            ...
            let req = req.bearer_auth(
                auth.token::<_, &str>(&["https://www.googleapis.com/auth/youtube"])
                    .unwrap()
                    .access_token,
            );
            req
    ...
    impl<'a, A: yup_oauth2::GetToken> InsertRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::GroupItem, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn execute_debug(
            self,
        ) -> Result<crate::schemas::ListGroupItemsResponse, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
        ...
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            ...
            let mut auth = self.auth.lock().unwrap();
            let req = req.bearer_auth(
                auth.token::<_, &str>(&["https://www.googleapis.com/auth/youtube.readonly"])
                    .unwrap()
                    .access_token,
            );
            req
...
pub mod groups {
    ...
    impl<'a, A: yup_oauth2::GetToken> GroupsActions<'a, A> {
        ...
        pub fn update(&self, request: crate::schemas::Group) -> UpdateRequestBuilder<A> {
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn mine(&mut self, value: bool) -> &mut Self {
...
pub mod reports {
    ...
    impl<'a, A: yup_oauth2::GetToken> ReportsActions<'a, A> {
        ...
        pub fn query(&self) -> QueryRequestBuilder<A> {
            QueryRequestBuilder {
                reqwest: &self.reqwest,
                auth: &self.auth,
                access_token: None,
    ...
    impl<'a, A: yup_oauth2::GetToken> QueryRequestBuilder<'a, A> {
        ...
        pub fn currency(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        pub fn end_date(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        pub fn include_historical_channel_data(&mut self, value: bool) -> &mut Self {
        ...
        pub fn metrics(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        pub fn start_date(&mut self, value: impl Into<String>) -> &mut Self {
