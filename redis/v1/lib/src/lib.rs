pub mod schemas {
    ...
    pub struct FailoverInstanceRequest {
        ...
        pub data_protection_mode: Option<crate::schemas::FailoverInstanceRequestDataProtectionMode>,
    }
    ...
    pub struct GoogleCloudRedisV1LocationMetadata {
        ...
        pub available_zones: Option<
            ::std::collections::BTreeMap<String, crate::schemas::GoogleCloudRedisV1ZoneMetadata>,
        >,
    }
    impl ::field_selector::FieldSelector for GoogleCloudRedisV1LocationMetadata {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleCloudRedisV1OperationMetadata {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {
            match selector.chars().rev().nth(0) {
                Some(',') | None => {}
                _ => selector.push_str(","),
    ...
    impl ::field_selector::FieldSelector for GoogleCloudRedisV1ZoneMetadata {
        fn field_selector_with_ident(ident: &str, selector: &mut String) {}
    }
    #[derive(
        Debug,
    ...
    pub struct Instance {
        ...
        pub redis_configs: Option<::std::collections::BTreeMap<String, String>>,
