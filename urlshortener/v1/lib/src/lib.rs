...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn url(&self) -> crate::url::UrlActions<A> {
        crate::url::UrlActions {
...
pub mod url {
    ...
    pub struct UrlActions<'a, A> {
        pub(super) reqwest: &'a reqwest::Client,
        pub(super) auth: &'a std::sync::Mutex<A>,
    }
    impl<'a, A: yup_oauth2::GetToken> UrlActions<'a, A> {
        #[doc = "Expands a short URL or gets creation time and analytics."]
        pub fn get(&self, short_url: impl Into<String>) -> GetRequestBuilder<A> {
            GetRequestBuilder {
                reqwest: &self.reqwest,
                auth: &self.auth,
                alt: None,
        ...
        pub fn insert(&self, request: crate::schemas::Url) -> InsertRequestBuilder<A> {
    ...
    pub struct GetRequestBuilder<'a, A> {
        ...
        short_url: String,
        projection: Option<crate::url::params::GetProjection>,
    ...
    impl<'a, A: yup_oauth2::GetToken> GetRequestBuilder<'a, A> {
        ...
        pub fn projection(&mut self, value: crate::url::params::GetProjection) -> &mut Self {
        ...
        pub fn execute_debug(self) -> Result<crate::schemas::Url, Box<dyn ::std::error::Error>> {
            self.execute()
        }
        ...
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            ...
            let req = req.bearer_auth(
                auth.token::<_, &str>(&["https://www.googleapis.com/auth/urlshortener"])
                    .unwrap()
                    .access_token,
            );
            req
    ...
    pub struct ListRequestBuilder<'a, A> {
        pub(crate) reqwest: &'a ::reqwest::Client,
        pub(crate) auth: &'a ::std::sync::Mutex<A>,
        projection: Option<crate::url::params::ListProjection>,
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        #[doc = "Additional information to return."]
        pub fn projection(&mut self, value: crate::url::params::ListProjection) -> &mut Self {
            self.projection = Some(value);
            self
        }
        #[doc = "Token for requesting successive pages of results."]
        pub fn start_token(&mut self, value: impl Into<String>) -> &mut Self {
