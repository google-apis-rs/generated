...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn direct_deals(&self) -> crate::direct_deals::DirectDealsActions<A> {
        crate::direct_deals::DirectDealsActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
...
pub mod creatives {
    ...
    pub struct ListRequestBuilder<'a, A> {
        ...
        status_filter: Option<crate::creatives::params::ListStatusFilter>,
        alt: Option<crate::params::Alt>,
        fields: Option<String>,
        key: Option<String>,
        oauth_token: Option<String>,
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn status_filter(
            &mut self,
            value: crate::creatives::params::ListStatusFilter,
        ) -> &mut Self {
