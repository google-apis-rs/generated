...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn url_testing_tools(&self) -> crate::url_testing_tools::UrlTestingToolsActions<A> {
        crate::url_testing_tools::UrlTestingToolsActions {
...
pub mod url_testing_tools {
    ...
    impl<'a, A: yup_oauth2::GetToken> UrlTestingToolsActions<'a, A> {
        ...
        pub fn mobile_friendly_test(&self) -> mobile_friendly_test::MobileFriendlyTestActions<A> {
            mobile_friendly_test::MobileFriendlyTestActions
        }
    }
    pub mod mobile_friendly_test {
        ...
        impl<'a, A: yup_oauth2::GetToken> RunRequestBuilder<'a, A> {
            ...
            pub fn execute_debug(
                self,
            ) -> Result<crate::schemas::RunMobileFriendlyTestResponse, Box<dyn ::std::error::Error>>
            {
                self.execute()
            }
