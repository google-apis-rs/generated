...
pub mod projects {
    ...
    pub mod locations {
        ...
        impl<'a, A: yup_oauth2::GetToken> LocationsActions<'a, A> {
            ...
            pub fn accelerator_types(&self) -> accelerator_types::AcceleratorTypesActions<A> {
                accelerator_types::AcceleratorTypesActions
            }
            #[doc = "Actions that can be performed on the nodes resource"]
            pub fn nodes(&self) -> nodes::NodesActions<A> {
                nodes::NodesActions
            }
            ...
            #[doc = "Actions that can be performed on the tensorflow_versions resource"]
            pub fn tensorflow_versions(&self) -> tensorflow_versions::TensorflowVersionsActions<A> {
                tensorflow_versions::TensorflowVersionsActions
            }
        }
        #[derive(Debug, Clone)]
        ...
        pub mod accelerator_types {
            ...
            impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
                ...
                pub fn iter_accelerator_types<T>(
                    &'a mut self,
                ) -> impl Iterator<Item = Result<T, Box<dyn ::std::error::Error>>> + 'a
                where
                    T: ::serde::de::DeserializeOwned + ::field_selector::FieldSelector + 'a,
