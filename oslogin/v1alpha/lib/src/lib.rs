...
pub mod users {
    ...
    impl<'a, A: yup_oauth2::GetToken> UsersActions<'a, A> {
        ...
        pub fn ssh_public_keys(&self) -> ssh_public_keys::SshPublicKeysActions<A> {
            ssh_public_keys::SshPublicKeysActions
        }
    }
    #[derive(Debug, Clone)]
    pub struct GetLoginProfileRequestBuilder<'a, A> {
        ...
        name: String,
        operating_system_type: Option<crate::users::params::GetLoginProfileOperatingSystemType>,
    ...
    impl<'a, A: yup_oauth2::GetToken> GetLoginProfileRequestBuilder<'a, A> {
        ...
        pub fn operating_system_type(
            &mut self,
            value: crate::users::params::GetLoginProfileOperatingSystemType,
        ) -> &mut Self {
        ...
        pub fn system_id(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            ...
            let req = req.query(&[("operatingSystemType", &self.operating_system_type)]);
    ...
    pub mod projects {
        ...
        pub struct DeleteRequestBuilder<'a, A> {
            ...
            pub(crate) auth: &'a ::std::sync::Mutex<A>,
            name: String,
            operating_system_type: Option<crate::projects::params::DeleteOperatingSystemType>,
            access_token: Option<String>,
            alt: Option<crate::params::Alt>,
            callback: Option<String>,
            fields: Option<String>,
        ...
        impl<'a, A: yup_oauth2::GetToken> DeleteRequestBuilder<'a, A> {
            ...
            pub fn operating_system_type(
                &mut self,
                value: crate::projects::params::DeleteOperatingSystemType,
            ) -> &mut Self {
                self.operating_system_type = Some(value);
                self
            }
