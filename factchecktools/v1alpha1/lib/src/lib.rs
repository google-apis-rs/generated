...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn claims(&self) -> crate::claims::ClaimsActions<A> {
        crate::claims::ClaimsActions {
...
pub mod claims {
    ...
    impl<'a, A: yup_oauth2::GetToken> SearchRequestBuilder<'a, A> {
        ...
        pub fn max_age_days(&mut self, value: i32) -> &mut Self {
        ...
        pub fn review_publisher_site_filter(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        pub fn execute_debug(
            ...
            crate::schemas::GoogleFactcheckingFactchecktoolsV1Alpha1FactCheckedClaimSearchResponse,
...
pub mod pages {
    ...
    impl<'a, A: yup_oauth2::GetToken> CreateRequestBuilder<'a, A> {
        ...
        fn _request(&self, path: &str) -> ::reqwest::RequestBuilder {
            ...
            let req = req.bearer_auth(
                auth.token::<_, &str>(&["https://www.googleapis.com/auth/userinfo.email"])
                    .unwrap()
                    .access_token,
            );
            req
    ...
    impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
        ...
        pub fn organization(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        pub fn url(&mut self, value: impl Into<String>) -> &mut Self {
        ...
        pub fn execute_text(self) -> Result<String, Box<dyn ::std::error::Error>> {
            let req = self._request(&self._path());
            Ok(req.send()?.error_for_status()?.text()?)
        }pub fn execute_debug ( self ) -> Result < crate :: schemas :: GoogleFactcheckingFactchecktoolsV1Alpha1ListClaimReviewMarkupPagesResponse , Box < dyn :: std :: error :: Error >>{
            self.execute()
        }
        fn _execute<T>(&mut self) -> Result<T, Box<dyn ::std::error::Error>>
        where
