pub mod schemas {
    ...
    pub struct VoidedPurchase {
        ...
        #[serde(with = "crate::parsed_string")]
        pub purchase_time_millis: Option<i64>,
        #[doc = "The token that was generated when a purchase was made. This uniquely identifies a purchase."]
...
impl<A: yup_oauth2::GetToken> Client<A> {
    ...
    pub fn internalappsharingartifacts(
        &self,
    ) -> crate::internalappsharingartifacts::InternalappsharingartifactsActions<A> {
        crate::internalappsharingartifacts::InternalappsharingartifactsActions {
            reqwest: &self.reqwest,
            auth: &self.auth,
        }
    }
...
pub mod internalappsharingartifacts {
    ...
    impl<'a, A: yup_oauth2::GetToken> InternalappsharingartifactsActions<'a, A> {
    ...
    impl<'a, A: yup_oauth2::GetToken> UploadapkRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
        ...
        fn _resumable_upload_path(&self) -> String {
            let mut output = "https://www.googleapis.com/".to_owned();
            output
                .push_str("resumable/upload/androidpublisher/v3/applications/internalappsharing/");
            output.push_str(&self.package_name);
            output.push_str("/artifacts/apk");
            output
        }
    ...
    impl<'a, A: yup_oauth2::GetToken> UploadbundleRequestBuilder<'a, A> {
        #[doc = "Data format for the response."]
        pub fn alt(&mut self, value: crate::params::Alt) -> &mut Self {
            self.alt = Some(value);
            self
...
pub mod purchases {
    ...
    pub mod voidedpurchases {
        ...
        impl<'a, A: yup_oauth2::GetToken> ListRequestBuilder<'a, A> {
            #[doc = "The time, in milliseconds since the Epoch, of the newest voided in-app product purchase that you want to see in the response. The value of this parameter cannot be greater than the current time and is ignored if a pagination token is set. Default value is current time. Note: This filter is applied on the time at which the record is seen as voided by our systems and not the actual voided time returned in the response."]
